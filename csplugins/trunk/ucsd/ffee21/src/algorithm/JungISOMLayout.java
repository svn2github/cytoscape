...
*/
	...
	protected void initialize_local() {
		...
		dialog = JOptionPane.showInputDialog("maxEpoch(default:2000):");
		maxEpoch = Integer.parseInt(dialog);
		dialog = JOptionPane.showInputDialog("Epoch(default:1):");
		epoch = Integer.parseInt(dialog);
		dialog = JOptionPane.showInputDialog("radiusConstantTime(default:100):");
		radiusConstantTime = Integer.parseInt(dialog);
		dialog = JOptionPane.showInputDialog("radius(default:2):");
		radius = Integer.parseInt(dialog);
		dialog = JOptionPane.showInputDialog("minRadius(default:1):");
		minRadius = Integer.parseInt(dialog);
		dialog = JOptionPane.showInputDialog("initialAdaption(default:9.0D/10.0D):");
		initialAdaption = Integer.parseInt(dialog);
		dialog = JOptionPane.showInputDialog("minAdaption(default:0):");
		minAdaption = Integer.parseInt(dialog);
		dialog = JOptionPane.showInputDialog("coolingFactor(default:20):");
		coolingFactor = Integer.parseInt(dialog);
	...
	*/
	...
	private synchronized void adjust() {
		...
		globalX = 30 + 2.5 * Math.random() * getCurrentSize().getWidth();
		globalY = 30 + 2.5 * Math.random() * getCurrentSize().getHeight();
