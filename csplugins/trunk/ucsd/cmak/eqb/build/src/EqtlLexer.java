// $ANTLR 2.7.4: "eqtl.g" -> "EqtlLexer.java"$
...
public class EqtlLexer extends antlr.CharScanner implements EqtlParserTokenTypes, TokenStream
 {
public EqtlLexer(InputStream in) {
	this(new ByteBuffer(in));
}
public EqtlLexer(Reader in) {
	this(new CharBuffer(in));
}
public EqtlLexer(InputBuffer ib) {
	this(new LexerSharedInputState(ib));
}
public EqtlLexer(LexerSharedInputState state) {
	super(state);
