...
// TODO add your handling code here:
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {
    	...
    	if(jCheckBox1.isSelected() == true)
    	{
	        ...
	        attempt = new Intact(columnSearch(), node, jProgressBar1, 1, jScrollPane1);

	        System.out.println("Launching thread... button 1");
	        attempt.start();
    	...
    	if(jCheckBox2.isSelected() == true)
    	{
	        ...
	        attempt2 = new NCBI(columnSearch(), node, jProgressBar2, 1, jScrollPane1);
...
//	        }
	        ...
	        System.out.println("Creating an intact class");
	        attempt = new Intact(columnSearch(), node, jProgressBar1, 2, jScrollPane1);
