...
public class PSI25VisualStyleBuilder {
	...
	private static VisualStyle defaultVisualStyleBuilder() {
		...
		final Calculator lineStyleCalc = new BasicCalculator(DEF_VS_NAME + "-"
				+ "EdgeLineStyleMapping", lineStyle,
				VisualPropertyType.EDGE_LINE_STYLE);

		final Calculator lineWidthCalc = new BasicCalculator(DEF_VS_NAME + "-"
				+ "EdgeLineWidthMapping", lineWidth,
				VisualPropertyType.EDGE_LINE_WIDTH);

		final Calculator edgeColorCalc = new BasicCalculator(DEF_VS_NAME + "-"
