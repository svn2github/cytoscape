...
public class OLSUtil {
	...
	public static Map<String, String> getAllChildren(String term) throws IOException {
		return ols.getTermChildren(term, PSIMI, -1, null);
		
//		
//		System.out.println("========================================");
//		Map<String, String> rootTerms = ols.getTermChildren(ITR_TYPE, PSIMI, 1, null);
//		for(String key: rootTerms.keySet()) {
//			System.out.println("(key, root val) = " + key + ", " + rootTerms.get(key));
//		}
		
	}
	
	public static String toCanonicalName() throws IOException {
		Map<String, String> dbTerms = ols.getTermChildren(DB_ROOT, PSIMI, -1, null);
