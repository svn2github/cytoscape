...
public class BinomialDistribution {
	 ...
	 * 
	 * @param x
	 *            number of genes with GO category B in cluster A.
	 * @param bigX
	 *            number of genes in cluster A.
	 * @param n
	 *            number of genes with GO category B in the whole genome.
	 * @param bigN
	 *            number of genes in whole genome.
	 */
