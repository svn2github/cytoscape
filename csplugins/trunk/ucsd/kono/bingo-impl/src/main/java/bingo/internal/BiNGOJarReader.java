...
public class BiNGOJarReader {
	...
	public BiNGOJarReader(String URI) throws IOException {
		...
		// we've created a new class loader that is used to load plugins and
		// also
		// should bootstrap to the class loader that loads the Cytoscape core
		// classes
		// However, we can't use it until it's been instantiated, so if we get a
		// null
