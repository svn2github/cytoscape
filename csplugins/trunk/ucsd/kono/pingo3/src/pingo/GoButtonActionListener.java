...
/**
 * *****************************************************************
 * HelpMenuBar.java     Steven Maere & Karel Heymans (c) 2005-2010
 * ----------------
 * <p/>
 * Class that produces a help menubar.
 * ******************************************************************
 */
...
public class GoButtonActionListener implements ActionListener {
    ...
    public GoButtonActionListener(SettingsPanel settingsPanel) {
    ...
    public void actionPerformed(ActionEvent e) {
        try {
            Browser.init();
            Browser.displayURL("http://amigo.geneontology.org/cgi-bin/amigo/search.cgi");
        }
