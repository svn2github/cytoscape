...
public class ActivePathFinderParameters {
	...
	public void setParams(ActivePathFinderParameters oldAPFP) {
		...
		//this.enableSpokePenalty = oldAPFP.getEnableSpokePenalty();
	} // copy ctor

	// ---------------------------------------------------------------------------------------
	//public boolean getEnableSpokePenalty(){
	//	return enableSpokePenalty;
	//}
	
	//public void setEnableSpokePenalty(boolean value){
	//	this.enableSpokePenalty = value;
	//}
