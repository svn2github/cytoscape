	  ...
	  new Thread(new Runnable(){
		...
		if(!randomDialog.isCancelled()){
		  try{
		     ...
		     */
		    EdgeRandomizationOptions options = new EdgeRandomizationOptions();
		    options.currentNetwork = ((NetworkContainer)list.getSelectedValue()).getNetwork();
		    randomDialog = new EdgeRandomizationDialog(options);
