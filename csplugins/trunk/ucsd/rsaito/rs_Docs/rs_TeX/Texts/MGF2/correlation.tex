...
\noindent
{\bf 定理\thechapter-\thetheorem}:~相関係数\(r\)について、
...
\refstepcounter{exer}
\noindent
{\bf 問題\thechapter-\theexer}:~ 数列\(5,4,6,2,8\)とこれに先頭から順に対応する数列\(-4,-4,-4,-4,6\)との間の相関係数を求めよ。

\refstepcounter{exer}
\noindent
{\bf 問題\thechapter-\theexer}:~ 相関係数\(r\)は
...
\refstepcounter{exer}
\noindent
{\bf 問題\thechapter-\theexer}:~ \(z_{1i}\)と\(z_{2i}\)との間に\(z_{2i}=az_{1i}+b\)\ (\(a,b\)は定数、\(a \neq 0\))の関係があるとき、\(r\)は1または-1になることを示せ。
