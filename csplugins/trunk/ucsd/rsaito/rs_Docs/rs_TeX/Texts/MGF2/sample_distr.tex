...
\label{exerx2}
\noindent
{\bf 問題\thechapter-\theexer}:~式\ref{eqn329}の導出過程を参考に、\(E(\bar{X}^{2})\)を\(n,\mu,\sigma\)を用いて表せ。

\refstepcounter{exer}
\label{exerx3}
\noindent
{\bf 問題\thechapter-\theexer}:~問題\ref{chap_prob_distr}-\ref{exerx2}の結
...
問題\thechapter-\ref{exerx3}、\thechapter-\ref{exer_sampled4}の結果より、標本内の分散から
