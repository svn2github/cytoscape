...
\noindent
{\bf 定理\thechapter-\thetheorem}:~ \(X_{1},X_{2},\cdots,X_{n}\)を密度関数
...
\noindent
{\bf 証明\thechapter-\thetheorem}:~ \(Z_{*}\)の積率母関数は\(M_{Z_{*}}(t) = E(e^{tZ_{*}})\)だが、
...
\noindent
{\bf 問題\thechapter-\theexer}:~式\ref{eq496}が成り立つことを示せ。
