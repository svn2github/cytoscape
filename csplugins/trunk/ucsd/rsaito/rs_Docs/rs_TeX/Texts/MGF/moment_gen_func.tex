...
確率密度関数が畳み込み積分(小節\ref{convol12}参照)\index{たたみこみせきぶん@畳み込み積分}で表されるとき、
...
\noindent
{\bf 定理\thesection-\thetheorem}:\(a,b\)および\(p\)を一定とするとき、確率
...
\noindent
{\bf 証明\thesection-\thetheorem}: 標準化された\(z=(x-np)/\sqrt{npq}\)の積率母関数は、
