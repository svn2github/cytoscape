...
from IVV_Packages.IVV_Homology.RefSeq_based_map4 import RefSeq_based_map
...
class Motif_Sprot_Pfam_info_Bait:
    ...
    def motif_info_descr(self, seqid):
        ...
        if self._ivv_info.ID_Type(seqid) == "Bait":
            ...
            bait_start = self.bait_to_swiss.subject_start(seqid, swissid)
            bait_end   = self.bait_to_swiss.subject_end(seqid, swissid)
...
if __name__ == "__main__":
    ...
    ivv_to_refseq_file   = rsc.HomolIVVRefSeq_Ssearch # "../../IVV/ivv_human7.3_refseq_match"
    bait_to_swiss_file   = rsc.HomolIVVBait_Sprot     # "../../Homology/homol_ivv_human7.3_Bait_Sprot_simp_res_1st"
    refseq_to_sprot_file = rsc.HomolIVVRefSeq_Sprot   # "../../Homology/homol_ivv_human7.3_refseq_uniprot_sprot_simp_res95"
    ...
    bait_to_swiss = HomologyDescr(bait_to_swiss_file)
    ...
    """
    motif_sprot_pfam_hit_info = Motif_Sprot_Pfam_hit_info(
        "2353_all", "Bait"
        )
    motif_sprot_pfam_hit_info.reg_motif_pos("Motif#1", 100, 300, 200)
    motif_sprot_pfam_hit_info.reg_motif_pos("Motif#2", 300, 600, 300)
    print motif_sprot_pfam_hit_info.get_motif()
    """
