...
import Seq_Packages.Motif.MMI_Pred2 as MMI_Pred
import IVV_Packages.IVV_Motif.IVV_Conv_Motif as IVV_Conv_Motif
import Seq_Packages.Motif.InterDom as InterDom
...
mmi = MMI_Pred.MMI_Pred()
mmi.set_PPI(ppi)
mmi.set_motif_info(rsc.GeneID2Pfam)
mmi.pred_mmi_from_ppi()

interdom = InterDom.InterDom(rsc.InterDom, rsc.Pfam_fs)
