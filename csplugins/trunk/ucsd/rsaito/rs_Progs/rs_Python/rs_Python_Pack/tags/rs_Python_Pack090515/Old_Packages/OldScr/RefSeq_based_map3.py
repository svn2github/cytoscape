...
from IVV_Info.IVV_RefSeq_match2 import IVV_RefSeq_match
from Seq_Packages.Homology.Homology_descr4 import HomologyDescr
from Seq_Packages.Homology.Homol_measure import HM
from General_Packages.Usefuls.NonRedSet1 import NonRedSetDict
...
if __name__ == "__main__":
    ...
    import string
    import IVV_Info.IVV_filter1
    from Seq_Packages.Motif.SwissPfam import Motif_swiss_set

    from General_Packages.Usefuls.rsConfig import RSC
    rsc = RSC("../../../rs_Python_Config/rsIVV_Config")

    filter = IVV_Info.IVV_filter1.IVV_filter()
    filter.set_Prey_filter_file(rsc.PreyFilter)
    ivv_info = IVV_Info.IVV_info1.IVV_info(rsc.IVVInfo, filter)
