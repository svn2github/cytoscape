...
import string
from Usefuls.Usefuls_I import array_string

class SymAtlas_annotation:
    def __init__(self, gpl96_file, gnf1b_anntable_file):
        self.gpl96 = GEO_probe1.Probe_Info(gpl96_file)

        self.gnf1b_anntable = Data_Struct.Hash.Hash_headf("A")
        self.gnf1b_anntable.read_file(filename = gnf1b_anntable_file,
