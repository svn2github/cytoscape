...
from Calc_Packages.Math.Stats_OrderI import median, get_centre_closer_to_median
...
for afs_id in cancer11k_dt.get_exp_sheet().conv_afas_onc.keys():
    ...
    patient_dt = get_centre_closer_to_median((diff_dt_sense, diff_dt_antis))[0]
    ...
    patient_rd = get_centre_closer_to_median((diff_rd_sense, diff_rd_antis))[0]
