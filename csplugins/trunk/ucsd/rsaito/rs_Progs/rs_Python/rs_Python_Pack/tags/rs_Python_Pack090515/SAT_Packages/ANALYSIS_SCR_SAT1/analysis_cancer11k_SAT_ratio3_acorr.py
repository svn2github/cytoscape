...
if opt.get_misc4() == "green":
    emode = "green"
elif opt.get_misc4() == "red":
    emode = "red"
else:
    emode = "green"
...
output = Cluster_Eisen_frmt(normal_keys + cancer_keys,
