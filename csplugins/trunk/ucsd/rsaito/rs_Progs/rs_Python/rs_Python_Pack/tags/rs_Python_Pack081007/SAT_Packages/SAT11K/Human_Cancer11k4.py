...
class Okay_Sheet(Data_Struct.Data_Sheet3.Data_Sheet):
    ...
    def __init__(self, filename, afas_id_conv_file, sep = "\t"):

        self.conv_onc_afas = Hash.Hash("A")
        self.conv_onc_afas.read_file_hd(afas_id_conv_file,
                                        Key_cols_hd = [ "Gene ID (ONC)" ],
                                        Val_cols_hd = [ "Gene ID (AFAS)" ])
        self.conv_afas_onc = Hash.Hash("S")
        self.conv_afas_onc.read_file_hd(afas_id_conv_file,
...
class Human_Cancer11k:
    ...
    def set_related_files(self, okay_exp_file, okay_gIsPosAndSignif_file, okay_gIsWellAboveBG_file,
                          afas_id_conv_file):
        self.okay_exp = Okay_Sheet(okay_exp_file,             afas_id_conv_file)
        self.okay_pas = Okay_Sheet(okay_gIsPosAndSignif_file, afas_id_conv_file)
        self.okay_wab = Okay_Sheet(okay_gIsWellAboveBG_file,  afas_id_conv_file)
...
if __name__ == "__main__":
    ...
    Colon_dT = Okay_Sheet(rsc.Human11k_Cancer_Colon_dT, rsc.Human11k_Cancer_AFAS_ID_Conv)
    ...
    human_cancer11k_dt_sf.shuffle_norm_cancer()
    human_cancer11k_rd_sf.shuffle_norm_cancer()
