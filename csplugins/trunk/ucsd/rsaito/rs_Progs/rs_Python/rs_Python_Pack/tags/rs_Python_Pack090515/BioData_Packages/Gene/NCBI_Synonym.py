...
from Usefuls.Synonyms2 import Synonyms
        ...
        for line in fh:
            ...
            for each_symb in [ main_symb ] + symbs:
                ...
                if case_mode:
                    ...
                    syno_term = each_symb.lower()
                self._syn_table[ syno_term ] = main_symb
...
if __name__ == "__main__":
    ...
    syno = NCBI_Gene_Synonyms(rsc.GeneInfo_hs, case_mode = False)
