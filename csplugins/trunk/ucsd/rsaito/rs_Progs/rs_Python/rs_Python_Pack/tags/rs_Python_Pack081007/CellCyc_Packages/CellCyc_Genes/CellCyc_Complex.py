...
from CellCyc_Packages.CellCyc_Expr.Botstain1 import Botstain_Sheet
...
class CellCyc_Complex_Exp:
    def __init__(self, expr_file, geneinfo_file, convfile):
        ...
        bot_expr = Botstain_Sheet(expr_file,
                                  synonyms)
    ...
    def calc_exp_node(self, node_name, cond):
        ...
        for each_node in self.get_elems(node_name):
            each_exp = self.expr.get_datum(each_node, cond)
    ...
    def calc_exp_complex(self, complex_name, cond, sep = "_"):
        ...
        expl = []
        for node in nodes:
            each_exp = self.calc_exp_node(node, cond)
...
if __name__ == "__main__":
    ...
    cellcyc_cmplx_exp = CellCyc_Complex_Exp(rsc.Botstain_expr,
                                            ...
                                            rsc.Cell_cyc_Syno)
    print cellcyc_cmplx_exp.calc_exp_node("CyclinB", "A#2")
    ...
    print cellcyc_cmplx_exp.get_datum("p21", "C#0")