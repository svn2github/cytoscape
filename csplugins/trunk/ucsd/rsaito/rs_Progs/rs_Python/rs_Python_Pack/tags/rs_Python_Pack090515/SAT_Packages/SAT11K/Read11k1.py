...
if __name__ == "__main__":
    ...
    # for probe in expr_pat_set.probes():
    #    print probe.get_probeid(), probe.get_transcript().get_transcriptID()
    ...
    print Transcript_Factory().has_key("ONC-U47414")
    print "Probes:", map(lambda x: x.get_probeid(), Transcript_Factory()["ONC-U47414"].get_probes())
    print "Exp:", expr_pat_set.expression_pat(Transcript_Factory()["ONC-U47414"].get_probes()[0])
