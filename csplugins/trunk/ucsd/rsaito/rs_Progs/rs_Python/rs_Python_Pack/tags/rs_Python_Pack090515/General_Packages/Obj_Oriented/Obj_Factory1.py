...
class Obj_Factory(Singleton.Singleton3):
    ...
    def has_key(self, iname):
        return self.name2obj.has_key(iname)
    
    def __getitem__(self, iname):
        return self.name2obj[ iname ]
    
    def __iter__(self):
        return self.name2obj.__iter__()
...
if __name__ == "__main__":
    ...
    print factory1.has_key("Galant")
    print factory1.has_key("FTO")
    print factory1[ "Galant" ], factory1[ "Galant" ].get_name()
