...
import IVV_Packages.PPI_Pred.Display_Pred_Source1
...
for p1 in spoke:
    for p2 in spoke[p1]:
        ...
        tb.append("Annotation 1", gene_info.val_force(p1))
        tb.append("Annotation 2", gene_info.val_force(p2))
        ...
        IVV_Packages.PPI_Pred.Display_Pred_Source1.Save_Pred_Source(p1, p2)
