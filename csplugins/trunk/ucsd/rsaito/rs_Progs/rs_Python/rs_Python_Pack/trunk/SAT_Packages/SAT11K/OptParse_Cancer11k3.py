...
class Option_Cancer11kI:
    def __init__(self, parser = None):
        options, args = self.__parsing(parser)
...
if __name__ == "__main__":
    ...
    opt_c11k = Option_Cancer11kI(parser)
    
    print "*** Option #1 ***"
    print "Exp. file:", opt_c11k.get_exp_file()
    print "PAS. file:", opt_c11k.get_pas_file()
    print "WAB. file:", opt_c11k.get_wab_file()
    print "Nrm. keys:", opt_c11k.get_normal_keys()
    print "Can. keys:", opt_c11k.get_cancer_keys()
    print "Min thres:", opt_c11k.get_min_thres()
    print "Flt level:", opt_c11k.get_filtering_level()
    print "Test optn:", opt_c11k.options.x
    print opt_c11k.get_options().x
    print
    ...
    opt_c11k2 = Option_Cancer11kII(parser)    
    
    print "*** Option #2 ***"
    print "Exp. file (dT):", opt_c11k2.get_exp_file_dt()
    print "Exp. file (Rd):", opt_c11k2.get_exp_file_rd()
    print "PAS. file (dT):", opt_c11k2.get_pas_file_dt()
    print "PAS. file (Rd):", opt_c11k2.get_pas_file_rd()
    print "WAB. file (dT):", opt_c11k2.get_wab_file_dt()
    print "WAB. file (Rd):", opt_c11k2.get_wab_file_rd()
    print "Nrm. keys:", opt_c11k2.get_normal_keys()
    print "Can. keys:", opt_c11k2.get_cancer_keys()
    print "Min thres:", opt_c11k2.get_min_thres()
    print "Flt level:", opt_c11k2.get_filtering_level()
    print "Test optn:", opt_c11k2.options.x
    options, args = parser.parse_args()
    print options.x
    print opt_c11k2.get_options().x
