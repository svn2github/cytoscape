...
def OptParse_celltype_prim():
    ...
    return expr_file, normal_keys, cancer_keys, args
...
def OptParse_celltype_prim_misc():
    ...
    return expr_file, normal_keys, cancer_keys, \
        (options.misc1, 
         options.misc2, 
         options.misc3, 
         options.misc4, 
...
def OptParse_celltype_prim_II():
    ...
    if options.CancerType == "colon":
        cancer_keys = colon_cancer_keys
        normal_keys = colon_normal_keys
        expr_file_dt = rsc.Human11k_Cancer_Colon_dT
        expr_file_rd = rsc.Human11k_Cancer_Colon_random

    elif options.CancerType == "hepatic":
        cancer_keys = hepatic_cancer_keys
        normal_keys = hepatic_normal_keys
        expr_file_dt = rsc.Human11k_Cancer_Hepatic_dT
        expr_file_rd = rsc.Human11k_Cancer_Hepatic_random

    return (expr_file_dt, expr_file_rd,
