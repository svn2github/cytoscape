...
output = Cluster_Eisen_frmt_II_simple(normal_keys + cancer_keys,
                                      [ 1.0 ] * len(normal_keys + cancer_keys))
...
for line in fh:
    ...
    gid, afs_id = line.rstrip().split("\t")[:2] 
    ...
    output.set_expression(gid, afs_id,
