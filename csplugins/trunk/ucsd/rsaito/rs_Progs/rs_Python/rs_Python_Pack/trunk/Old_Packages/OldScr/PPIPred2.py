...
class PPIPred2(IVV_info.IVV_Conv.IVV_Conv):
    ...
    def bait2convid(self, bait_ID):
        ...
        refseq_hits = self.ivv_to_refseq.subject_ID(bait_ID)
    ...
    def prey2convid(self, prey_ID):
        ...
        refseq_hits = self.ivv_to_refseq.subject_ID(prey_ID)
        ret_geneids = Usefuls.NonRedSet.NonRedSet()
    ...
    def convid2baits(self, convid):
        ...
        for refseq in refseqs:
            ...
            for ivv_hit in bait_and_preyid_hits:
                if self.ivv_info.ID_Type(ivv_hit) == "Bait":
                    ret_baitids[ ivv_hit ] = ""
    ...
    def convid2preys(self, convid):
        ...
        for refseq in refseqs:
            ...
            for ivv_hit in bait_and_preyid_hits:
                if self.ivv_info.ID_Type(ivv_hit) == "Prey":
                    ret_preyids[ ivv_hit ] = ""
    ...
    def set_mapping(self,
        ...
        if not isinstance(ivv_to_refseq_homol,
                          Homology.HomologyDescr2.HomologyDescr2):
...
def test():
    ...
    refseq_to_geneid_file = "/Users/rsaito/UNIX/work/Gene_info/gene2refseq_hs"
    ...
    homology = Homology.HomologyDescr2.HomologyDescr2(
