...
def output_macro(
    ...
    macro_tmplt = open(rsc.VBAFile_analysis_cancer11k_AFAS5, "r").read()
    return macro_tmplt % (
        
        # Normal_Sense_Antis_dT
        ...
        ECN.col_num_to_alphabet(dt_an_end),
        
        identifier, annotation,
        identifier,

        # Normal_Sense_Antis_Rd
        ...
        ECN.col_num_to_alphabet(rd_an_end),
        
        identifier, annotation,
        identifier,

        # Cancer_Sense_Antis_dT
        ...
        ECN.col_num_to_alphabet(dt_sc_start),
        ECN.col_num_to_alphabet(dt_ac_end),
        
        identifier, annotation,
        identifier,

        # Cancer_Sense_Antis_Rd
        ...
        ECN.col_num_to_alphabet(rd_sc_start),
        ...
        # Normal_Cancer_Sense_Antis_random
        ...
        # Normal_Cancer_Sense_Antis_dT_random
