 ...
 *  \param   time_limit     Available time in milliseconds (will be updated by this function).  If it exceeds 20s we throw an exception!
 ...
 */
bool TimedGetHostByName(const std::string &hostname, const TimeLimit &time_limit, in_addr_t * const ip_address, std::string * const error_message);
