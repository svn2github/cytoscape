...
public:
	 ...
	 */
	explicit Logger(const std::string &log_filename, const VerbosityLevel default_verbosity = VL_NORMAL, const OpenMode open_mode = DO_NOT_CLEAR);
	 ...
	 *  \param  open_mode          Whether to clear the log file upon opening it or not.
	 */
	explicit Logger(const char * const log_filename, const VerbosityLevel default_verbosity = VL_NORMAL, const OpenMode open_mode = DO_NOT_CLEAR);
	 ...
	 *  \param  open_mode          Whether to clear the log file upon opening it or not.
	 */
	explicit Logger(File * const log_file, const VerbosityLevel default_verbosity = VL_NORMAL, const OpenMode open_mode = DO_NOT_CLEAR);
