package org.idekerlab.ModFindPlugin.data.matrixMath;

import org.idekerlab.ModFindPlugin.data.DoubleMatrix;
...
public class CholeskyDecomposition {
	...
	private void decompose(DoubleMatrix a) {
		...
		for (int i = 1; i < a.numRows(); i++) {
			...
			if (a.get(i, i) < sum) {
				System.err
						.println("Error CholeskyDecomposition.decompose(DoubleMatrix): Sqrt(-#) encountered. Entry matrix is poorly conditioned.");
			} else
