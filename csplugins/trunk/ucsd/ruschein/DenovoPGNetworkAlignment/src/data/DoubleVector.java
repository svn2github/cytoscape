...
public class DoubleVector extends DataVector {
	...
	public static final double pearsonCorrelation(DoubleVector v1, DoubleVector v2)
	{
		...
		return (v1.size()*sum_xy)/(  Math.sqrt(  v1.size()*sumx2  )*Math.sqrt(  v1.size()*sumy2  )  );
	}
	...
	public void plothist(int numbins, double low, double high)
	{
		Plotter pl = new Plotter(new Histogram(this,numbins,low,high));
		if (this.hasListName()) pl.setTitle("Histogram of "+this.listname);
		pl.show();
	}
	...
	{
		com.google.common.collect.Multiset<Double> ms = new com.google.common.collect.HashMultiset<Double>(this.asDoubleList());
