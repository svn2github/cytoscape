...
public class SearchPropertyPanel extends JPanel implements MultiHashMapDefinitionListener {
    ...
    private void initComponents() {
        ...
        visualizationPanel.add(edgeScoreLabel, new java.awt.GridBagConstraints());

        edgeScoreTextField.setPreferredSize(new java.awt.Dimension(50, 20));
        visualizationPanel.add(edgeScoreTextField, new java.awt.GridBagConstraints());

        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        gridBagConstraints.weightx = 1.0;
        visualizationPanel.add(lbPlaceHolder2, gridBagConstraints);
