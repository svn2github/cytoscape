...
//import org.eclipse.equinox.internal.provisional.p2.ui.dialogs.InstallNewSoftwarePanel.MyMouseListener;
//import org.eclipse.equinox.internal.provisional.p2.ui.dialogs.InstallNewSoftwarePanel.RepositorySetting;
...
public class AvailableSoftwarePage extends WizardPage implements ActionListener, ItemListener, MouseListener {
	...
	public AvailableSoftwarePage(Policy policy, String profileId, QueryableMetadataRepositoryManager manager) {
	...
	public void mouseClicked(MouseEvent e) {
		if (e.getSource() instanceof JLabel){
			...
			if (lb == lbAvailableSoftwareSites){
				...
				InstallationInformationDialog instDlg = new InstallationInformationDialog(true, profileId);
				instDlg.setSize(600, 500);
				instDlg.setLocationRelativeTo(AvailableSoftwarePage.this);
