...
public class ProvSDKUIActivator extends Plugin {
	...
	public void start(BundleContext bundleContext) throws Exception {
		...
		// For test only
		//System.out.println("\n\nProvSDKUIActivator.start()....\n\n");
		
		//InstallNewSoftwareHandler handler = new InstallNewSoftwareHandler();
		//handler.execute();
	}

	public static void getInstallNewSoftwareHandler(CySwingApplication desktop, CyNetworkManager netmgr){
		System.out.println("\n\nProvSDKUIActivator.getInstallNewSoftwareHandler()...\n");
		//ProvSDKUIActivator.this.getBundle();
		InstallNewSoftwareHandler handler = new InstallNewSoftwareHandler(desktop,netmgr);
		handler.execute();
