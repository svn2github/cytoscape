...
import org.eclipse.equinox.internal.provisional.p2.ui2.IProvHelpContextIds;
import org.eclipse.equinox.internal.provisional.p2.ui2.IUPropertyUtils;
import org.eclipse.equinox.internal.provisional.p2.ui2.actions.*;
import org.eclipse.equinox.internal.provisional.p2.ui2.policy.Policy;
import org.eclipse.equinox.internal.provisional.p2.ui2.viewers.IUColumnConfig;
...
public class InstalledSoftwarePage extends InstallationPage {
	...
	public void createControl(Composite parent) {
		...
		installedIUGroup = new InstalledIUGroup(Policy.getDefault(), composite, JFaceResources.getDialogFont(), Policy.getDefault().getProfileChooser().getProfileId(), getColumnConfig());
	...
	private void contributeButtonActions() {
		...
		final String profileId = Policy.getDefault().getProfileChooser().getProfileId();
