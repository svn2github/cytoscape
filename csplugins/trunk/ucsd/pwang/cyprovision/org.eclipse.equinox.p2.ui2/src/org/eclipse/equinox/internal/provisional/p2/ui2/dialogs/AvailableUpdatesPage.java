...
public class AvailableUpdatesPage extends WizardPage {

	String profileId;
	Vector<InstalledIUElement> ius;
	
	public AvailableUpdatesPage(String profileId, Vector<InstalledIUElement> ius){
    ...
    private void initComponents() {
        ...
        taDetails = new javax.swing.JTextField();

        setLayout(new java.awt.GridBagLayout());

        jLabel1.setText("Check the updates that you wish to install.");
    ...
    private javax.swing.JTextField taDetails;
