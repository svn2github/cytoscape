...
public class UpdateDetailsPage extends WizardPage {

	String profileId;
	Vector<InstalledIUElement> ius;
	
	public UpdateDetailsPage(String profileId, Vector<InstalledIUElement> ius){
...
*/
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Review and confirm the updates");
