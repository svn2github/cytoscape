...
public class AutomaticUpdatesPopup extends JDialog {
    ...
    public static void main(String args[]) {
       /*
    	java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
            	AutomaticUpdatesPopup dlg = new AutomaticUpdatesPopup(null, false, null);
            	dlg.setVisible(true);
            }
        });
        */
	...
	public AutomaticUpdatesPopup(javax.swing.JFrame parentShell, boolean alreadyDownloaded) {
