...
public class UpdateDialog extends JDialog implements ActionListener, MouseListener {
	...
	public UpdateDialog(IInstallableUnit[] ius){
		this.iusWithUpdates = ius;
		this.setTitle("Available Updates");
		
		// get most recent versions of IUs
		ius_latest = getMostRecentVersions();
		
		// for test only
		ius_latest = iusWithUpdates;
	...
	private void buildJTree(IInstallableUnit[] ius_latest){

	}
	
	private IInstallableUnit[] getMostRecentVersions(){
		return null;
	}
