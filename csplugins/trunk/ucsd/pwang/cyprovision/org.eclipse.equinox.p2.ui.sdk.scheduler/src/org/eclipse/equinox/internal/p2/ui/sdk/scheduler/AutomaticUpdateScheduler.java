...
public class AutomaticUpdateScheduler { //implements IStartup {
	...
	private class IUProfilePropertyByIdQuery extends IUPropertyQuery {
		...
		private IProfile getProfile() {
			...
			//System.out.println("AutomaticUpdateScheduler.IUProfilePropertyByIdQuery:cachedProfile.getProfileId() =" + cachedProfile.getProfileId());
	...
	*/
	...
	public void scheduleUpdate() {
		//System.out.println("\tAutomaticUpdateScheduler.scheduleUpdate()... profileId = "+ profileId);
		...
		//Properties pref = AutomaticUpdatePlugin.getDefault().getPreferences();
		...
		//System.out.println("\tAutomaticUpdateScheduler.scheduleUpdate(): Apple A");

		
		listener = new IUpdateListener() {
			public void updatesAvailable(UpdateEvent event) {
				//System.out.println("\tAutomaticUpdateScheduler.scheduleUpdate():get UpdateEvent ... updatesAvailable()");
		...
		checker.addUpdateCheck(profileId, getProfileQuery(), 0, 0, listener);
