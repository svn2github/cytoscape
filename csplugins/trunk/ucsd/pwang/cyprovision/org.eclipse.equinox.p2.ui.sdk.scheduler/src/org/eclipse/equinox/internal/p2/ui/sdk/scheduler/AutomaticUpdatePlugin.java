...
//public class AutomaticUpdatePlugin extends AbstractUIPlugin {
	...
	public Properties getPreferences(){
		...
		System.out.println("AutomaticUpdatePlugin: CyP2Adapter.PROVISION_SERVICE_NAME="+CyP2Adapter.PROVISION_SERVICE_NAME);
		System.out.println("AutomaticUpdatePlugin: setting="+adapter.getCyProperties().keys().toString());
