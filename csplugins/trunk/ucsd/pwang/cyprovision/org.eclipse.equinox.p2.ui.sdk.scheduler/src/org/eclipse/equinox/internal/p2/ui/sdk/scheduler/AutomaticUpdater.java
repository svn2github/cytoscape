...
public class AutomaticUpdater implements IUpdateListener {
	...
	public void updatesAvailable(final UpdateEvent event) {
		...
		System.out.println("\tEntering updatesAvailable()...");
		...
		//try {
			if (download) {
				...
				System.out.println("\t...before createUpdateAction()");

				createUpdateAction();

				System.out.println("\t...After createUpdateAction()");
...
*/
	void createUpdatePopup() {
		...
		System.out.println("AutomaticUpdater.createUpdatePopup()...");
			
		//popup = new AutomaticUpdatesPopup(getWorkbenchWindowShell(), alreadyDownloaded, getPreferenceStore());
		popup = new AutomaticUpdatesPopup(new javax.swing.JFrame("Test frame"), alreadyDownloaded); //, getPreference());
		//popup.open();
	...
	void createUpdateAction() {
		...
		updateAction = new AutomaticUpdateAction(this, getSelectionListener(), profileId);
...
//	}
	...
	Properties getPreference() {
		Properties prop = AutomaticUpdatePlugin.getDefault().getPreferences();
		System.out.println("AutomaticUpdater.getPreference(): prop.keys() = "+prop.keys().toString());
