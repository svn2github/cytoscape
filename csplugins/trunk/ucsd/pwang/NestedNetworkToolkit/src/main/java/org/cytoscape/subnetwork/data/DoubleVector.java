package org.cytoscape.subnetwork.data; 
...
public class DoubleVector extends DataVector {
	...
	{
		if (v1.length!=v2.length) throw(new java.lang.IllegalArgumentException("Vectors must be the same size. "+v1.length+"!="+v2.length));
	...
	{
		if (bv.size()!=this.size()) throw new java.lang.IllegalArgumentException("The two vectors must be the same size. "+bv.size()+"!="+this.size);
