...
public interface View extends Identifiable {
	...
	/**
	 * Maybe we can figure out how to have a custom graphic visual property? This just
	 * recapitulates the old scheme for setting custom graphics which isn't fantastic.
	 *
	 * @param s  DOCUMENT ME!
	 * @param p  DOCUMENT ME!
	 *
