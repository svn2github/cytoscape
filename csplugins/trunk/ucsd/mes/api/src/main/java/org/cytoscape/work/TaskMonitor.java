...
public interface TaskMonitor {
    ...
    /**
     * The idea is that a TaskMonitor could pass fractions of itself to a
     * {@link Monitorable} subtask.
     * <p>
     * This implies that the parent TaskMonitor will need to track all
     * child TaskMonitors.
     * <p>
     * Would this be called sequentially within a for loop?  Or should we this
     * method instead return a List of TaskMonitors that could then be used.
     * <p>
     * What if a child TaskMonitor never completed?  What if a child monitor simply
     * wasn't used?
     * <p>
     * Presumably the sum of the percents from all calls to the child monitor
     * would sum to less than 1. What if they don't?
     * <p>
     * @param percent The percent of the parent monitor that the returned child
     * monitor represents.  Must be strictly greater than (&gt;) 0 and
