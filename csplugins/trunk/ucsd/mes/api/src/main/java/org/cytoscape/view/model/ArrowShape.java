...
public interface ArrowShape extends Saveable {
	/**
	 * This is where we'd need define the constraints on the shape and how exactly we'd
	 * transform the  shape specified into an arrow that lines up with the edge stroke and node
	 * shapes.
	 *
	 * @return  DOCUMENT ME!
	 */
