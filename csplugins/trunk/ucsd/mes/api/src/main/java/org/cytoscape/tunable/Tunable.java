 ...
 * annotation is the name of the {@link Field} being annotated.
 */
...
public @interface Tunable {
	...
	/**
	 * A brief (approximately one sentence) description of this {@link Field}.  
	 ...
	 * to {@link Properties} files so should not use spaces or the '.' character.
	 */
