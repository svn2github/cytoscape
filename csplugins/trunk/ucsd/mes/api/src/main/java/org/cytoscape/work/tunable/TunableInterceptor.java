...
public interface TunableInterceptor { 
	 ...
	 * for {@link org.cytoscape.work.Tunable} annotated {@link java.lang.reflect.Field}s in the object
	 * and process the {@link org.cytoscape.work.Tunable}s using the {@link Handler}s
