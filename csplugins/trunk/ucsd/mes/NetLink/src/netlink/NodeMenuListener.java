 ...
 */
class NodeMenuListener implements NodeContextMenuListener {
	...
	public void addNodeContextMenuItems(NodeView nodeView, JPopupMenu menu) {
		...
		String attrName =  "netlink." + curr.getTitle() + ".child";
		System.out.println("attrName: " + attrName);
		String childId = attrs.getStringAttribute(nodeId, attrName); 
