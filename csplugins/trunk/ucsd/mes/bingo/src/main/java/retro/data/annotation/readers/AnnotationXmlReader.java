...
package retro.data.annotation.readers;
...
public class AnnotationXmlReader {
	...
	private void read() throws Exception {
		...
		if (!ontologyXmlFileAbsolutePath.canRead()) {
			System.out.println("annotation xml file must name its associated ontology xml file");
			System.out.println("by giving its path relative to the actual location of the");
			System.out.println("annotation xml file.\n");
			System.out.println("could not find:");
			System.out.println("  " + ontologyXmlFileAbsolutePath);
