...
public interface ResultAndStartPanel {
    ...
    public retro.data.annotation.Ontology getOntology();
    public retro.data.annotation.Annotation getAnnotation();
    public retro.data.annotation.Ontology getOntology(String term);
    public retro.data.annotation.Annotation getAnnotation(String term);
    ...
    public org.cytoscape.view.GraphView getNetworkView();
