...
public class GoBin extends javax.swing.JFrame{
    ...
    public GoBin(BiNGO.SettingsPanel settingsPanel, GraphView networkView){
...
/*class GoBin implements PropertyChangeListener {
    ...
    public void propertyChange(PropertyChangeEvent event) {
                ...
                //GraphPerspective network = Cytoscape.getNetwork(net_id);
