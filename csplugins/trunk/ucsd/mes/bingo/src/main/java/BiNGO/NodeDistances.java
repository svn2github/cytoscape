...
/**
 * Calculates the all-pairs-shortest-paths (APSP) of a set of <code>org.cytoscape.Node</code>
 * objects that reside in a <code>org.cytoscape.GraphPerspective</code>.
...
public class NodeDistances implements Task {
     ...
     *
     * @param nodes_list  a <code>List</code> of <code>org.cytoscape.Node</code> objects for
     *                    which distances will be calculated
     * @param distances   the 2 dimensional array that will hold the calculated distances
     *                    (possibly null)
     * @param perspective the <code>org.cytoscape.GraphPerspective</code> in which the nodes
     *                    reside
     ...
     * @param perspective               The <code>org.cytoscape.GraphPerspective</code> in which the nodes reside
