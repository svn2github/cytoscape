...
import retro.data.annotation.*;
import retro.data.annotation.readers.*;
 ...
 *  can be deduced.
 *
 *  @see retro.data.annotation.Annotation
 *  @see retro.data.annotation.Ontology
 */
public class loadAnnotationFromFlatFiles {
	...
	public static void main(String[] args) throws Exception {
		if (args.length != 3) {
			System.out.println("usage:  loadAnnotationFromFaltFile <server name> <annotation.txt> <ontology.txt>");
			System.exit(1);
		}
		...
		if (!annotationFile.canRead()) {
			System.out.println("--- retro.data.servers.loadAnnotationFromFlatfiles error:  cannot read");
		...
		if (!annotation.getCurator().equals(ontology.getCurator())) {
			System.out.println("annotation is curated by " + annotation.getCurator());
			System.out.println("ontology is curated by " + ontology.getCurator());
			System.out.println(" --> these disagree.  Exiting....");
			System.exit(1);
		}
