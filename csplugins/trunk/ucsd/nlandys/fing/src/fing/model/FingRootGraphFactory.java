...
public final class FingRootGraphFactory
{
   ...
   * is they are complements of each other.  Complement is '~' in Java.<p>
   ...
   * indices (which are identical to RootGraph indeices) and FixedGraph
   * indices is they are complements of each other.
   */
