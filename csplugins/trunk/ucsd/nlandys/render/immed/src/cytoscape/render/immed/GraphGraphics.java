...
public final class GraphGraphics
{
   ...
   *   returned by getFontRenderContext()) is subjected to the same
   *   transformation as are nodes and edges (the transformation is defined
   *   by the clear() method); thereforek, it is the point size of the
                             ...
                             final Color color)
  {
    ...
    final GlyphVector glyphV;
    {
      ...
      glyphV = font.layoutGlyphVector
        (getFontRenderContext(), m_chars, 0, text.length(),
