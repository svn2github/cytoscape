...
public final class TestCustomNodes extends Frame implements Runnable
{
  ...
  private final byte m_customNode1;
  private final byte m_customNode2;
  ...
  private final void generateImage(double rotationTheta, double m_scale)
  {
    ...
    float border = 6.0f;
    m_grafx.drawNodeFull(m_customNode1,
    ...
    m_grafx.drawNodeFull(m_customNode2,
