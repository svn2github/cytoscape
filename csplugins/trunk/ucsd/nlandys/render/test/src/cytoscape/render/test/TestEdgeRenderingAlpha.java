...
public final class TestEdgeRenderingAlpha
  extends Frame implements MouseListener, MouseMotionListener
{
  ...
  public final static void main(String[] args) throws Exception
  {
    ...
    EventQueue.invokeAndWait(new Runnable() {
        public void run() {
          Frame f = new TestEdgeRenderingAlpha
            (tree, extents, shape, edgeThickness);
          f.show();
  ...
  private final Color m_edgeColor = new Color(255, 0, 0, 128);
  private final Color m_arrowColor = new Color(0, 0, 0, 128);
  ...
  public TestEdgeRenderingAlpha(RTree tree, float[] extents, byte shape,
                                float edgeThickness)
  {
    super();
    m_tree = tree;
