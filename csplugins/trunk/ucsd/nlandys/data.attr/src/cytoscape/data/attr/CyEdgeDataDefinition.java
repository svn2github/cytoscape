...
/**
 * This interface contains the API specification for creating edge
 * attribute definitions.
 */
public interface CyEdgeDataDefinition
{
  ...
  /**
   * Creates a edge attribute definition.  An attribute definition must be
   * created before binding an attribute value to a edge.<p>
   ...
   * edge as having a color, I would create an attribute definition which
   ...
   * all edges over a set of experiments ("Ideker experiment",
   ...
   *   this value must be unique from all existing edge attribute definitions;
   ...
   *   values are bound to edges in this attribute definition.
