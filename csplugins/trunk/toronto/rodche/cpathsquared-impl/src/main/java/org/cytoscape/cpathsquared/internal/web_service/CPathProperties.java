...
public class CPathProperties {
	 ...
	 */
	public static final String CPATH_URL = new String("cpathsquared.server_url");

    /**
     * Property:  CPath2 Server Name.
     */
    public static final String CPATH_INSTANCE_BNAME = new String("cpathsquared.server_name");

    /**
     * Property:  CPath2 Server Blurb
     */
    public static final String CPATH_INSTANCE_BLURB = new String ("cpathsquared.server_blurb");

    /**
     * Property:  Icon Tool Tip
     */
    public static final String ICON_TOOL_TIP = new String ("cpathsquared.icon_tool_tip");

    /**
     * Property:  Icon File
     */
    public static final String ICON_FILE_NAME = new String ("cpathsquared.icon_file_name");

    /**
     * Property:  Organism.
     */
    public static final String ORGANISM_PREFIX = new String ("cpathsquared.organism");
