...
public class DynamicSupport {
	...
	public TaskIterator createTaskIterator(LinkoutTaskContext context) {
		...
		return new TaskIterator(new LinkoutTask(url, browser, context.getNetwork(), context.getTableEntries() ));
	}
}
