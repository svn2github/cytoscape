...
public class GridNodeLayoutContext extends LayoutContextImpl implements TunableValidator {
	...
	public GridNodeLayoutContext(boolean supportsSelectedOnly, Set<Class<?>> nodeAttrTypes, Set<Class<?>> edgeAttrTypes) {
		super(supportsSelectedOnly, nodeAttrTypes, edgeAttrTypes);
	}
