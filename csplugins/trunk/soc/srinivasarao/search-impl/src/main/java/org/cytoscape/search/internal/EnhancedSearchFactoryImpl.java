 ...
 */
public class EnhancedSearchFactoryImpl implements EnhancedSearchFactory {
	 ...
	 */
	public EnhancedSearch getGlobalEnhancedSearchInstance() {
		
		if (enhancedSearch == null) {
			enhancedSearch = new EnhancedSearchImpl(); // modified by Srinivas.
		}
