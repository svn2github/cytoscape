...
import org.cytoscape.search.internal.EnhancedSearchImpl;
...
public class EnhancedSearchFactory {
	 ...
	 */
	public static EnhancedSearch getGlobalEnhancedSearchInstance(CyNetworkManager netmgr) {
		
		if (enhancedSearch == null) {
			enhancedSearch = new EnhancedSearchImpl(netmgr.getCurrentNetwork()); // modified by Srinivas.
		}
