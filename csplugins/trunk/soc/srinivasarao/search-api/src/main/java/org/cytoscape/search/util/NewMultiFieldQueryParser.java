 ...
 */
public class NewMultiFieldQueryParser extends QueryParser
{
   ...
   */
  public NewMultiFieldQueryParser(String[] fields, Analyzer analyzer, Map boosts) {
   ...
   * what fields they appear.</p>
   */
  public NewMultiFieldQueryParser(String[] fields, Analyzer analyzer) {
    super(null, analyzer);
    this.fields = fields;
  }
