...
public class TestNumericAttributePanel {

	private JFrame jf = new JFrame();

	private NumericAttributePanel np;

	private CyNetwork net;

	private CyNetworkManager netmgr;

	public TestNumericAttributePanel() {
		setup();
		netmgr = new NetworkManager(new DummyCyEventHelper());
		netmgr.addNetwork(net);
		netmgr.setCurrentNetwork(net.getSUID());

		np = new NumericAttributePanel(netmgr, "canonicalName", "NODE",
				"java.lang.Integer");
