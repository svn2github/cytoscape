...
public class ExportToCytoscapeWeb extends CytoscapePlugin {
    ...
    public static String urlofxgmml;    //export location
    public static String urloflogo;    //logo
    ...
    public class MyPluginAction extends CytoscapeAction {
        ...
        public MyPluginAction(ExportToCytoscapeWeb myPlugin) {
            ...
            public TextForm() {
                ...
                exportButton.addActionListener(new ActionListener() {
                    ...
                    public void actionPerformed(ActionEvent ev) {
                        ...
                        ExportToCytoscapeWeb p = new ExportToCytoscapeWeb();
    ...
    public static void main(String[] args) {
       ...
       ExportToCytoscapeWeb pebble = new ExportToCytoscapeWeb();
