...
// call onCancel() on ESCAPE
        ...
        convName1.setText(BioPAXUtil.getNameSmart(convScore.getConversion1()));
        ...
        for (physicalEntityParticipant pep : convScore.getMatchedPEPs()) {
            String node1 = BioPAXUtil.getPEPStateNode(pep).getIdentifier(),
                    node2 = BioPAXUtil.getPEPStateNode(convScore.getMatch(pep)).getIdentifier();
