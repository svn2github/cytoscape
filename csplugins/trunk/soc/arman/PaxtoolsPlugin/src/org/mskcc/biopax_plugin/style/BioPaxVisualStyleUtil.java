...
public class BioPaxVisualStyleUtil {
	 ...
	 */
	public static final String VERSION_POST_FIX = " v " + "-fixme";/* TODO: + BioPaxPlugIn.VERSION_MAJOR_NUM + "_"
	...
	private static void createTargetArrows(EdgeAppearanceCalculator eac) {
		DiscreteMapping discreteMapping = new DiscreteMapping(ArrowShape.NONE,
		                                                      BioPAXUtil.BIOPAX_EDGE_TYPE,
		                                                      ObjectMapping.EDGE_MAPPING);

		discreteMapping.putMapValue(BioPAXUtil.RIGHT, ArrowShape.DELTA);
		discreteMapping.putMapValue(BioPAXUtil.CONTROLLED, ArrowShape.DELTA);
		discreteMapping.putMapValue(BioPAXUtil.COFACTOR, ArrowShape.DELTA);
		discreteMapping.putMapValue(BioPAXUtil.CONTAINS, ArrowShape.CIRCLE);
