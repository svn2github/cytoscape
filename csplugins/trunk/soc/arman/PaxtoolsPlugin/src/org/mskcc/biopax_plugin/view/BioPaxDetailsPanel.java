...
public class BioPaxDetailsPanel extends JPanel {
	...
	public void showDetails(String nodeID) {
        ...
        // name, shortname
        stringRef = nodeAttributes.getStringAttribute(nodeID, BioPAXUtil.BIOPAX_NAME);
        ...
        // organism
        stringRef = nodeAttributes.getStringAttribute(nodeID, BioPAXUtil.BIOPAX_ORGANISM_NAME);
        if (stringRef != null) {
        ...
        // synonyms
        addAttributeList(nodeID, BioPAXUtil.BIOPAX_SYNONYMS, "Synonyms:", buf);
        
		// cellular location
		addAttributeList(nodeID, BioPAXUtil.BIOPAX_CELLULAR_LOCATIONS,
		                 "Cellular Location(s):", buf);

		// chemical modification
		addAttributeList(nodeID, BioPAXUtil.BIOPAX_CHEMICAL_MODIFICATIONS_LIST,
    ...
    private void addType(String nodeID, StringBuffer buf) {
        String type = nodeAttributes.getStringAttribute(nodeID, BioPAXUtil.BIOPAX_ENTITY_TYPE);
    ...
    private void addLinks(String nodeID, StringBuffer buf) {
		String xrefs1 = nodeAttributes.getStringAttribute(nodeID,
            BioPAXUtil.BIOPAX_UNIFICATION_REFERENCES);
        String xrefs2 = nodeAttributes.getStringAttribute(nodeID,
            BioPAXUtil.BIOPAX_RELATIONSHIP_REFERENCES);
