...
public class SlantedPhylogram extends AbstractLayout{
...
//				new Double(1000.0), Tunable.USESLIDER));
	...
	private void positionNodeX(Node node)
	{
		...
		// Adjust the position by incorporating the branchLength
