...
public class CriteriaTablePanel implements ActionListener, ListSelectionListener {
    ...
    /*
     * This method handles all of the list and table selection events.  Essentially if you click on one
     * row of the table it calls createDiscreteMapping from ColorMapper.java. If you highlight a number
     * of rows it calls createCompositeMapping from ColorMapper.java to map all of the highlighted rows to
     * colors.
     */
                ...
                if (lsm.isSelectedIndex(i)) {
                		...
                		if(temp.length == 1){
                			...
                			try{
                				...
                				System.out.println(setAttFailure.getMessage());
                			}
