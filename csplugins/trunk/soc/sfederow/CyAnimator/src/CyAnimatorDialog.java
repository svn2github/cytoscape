...
public class CyAnimatorDialog extends JDialog implements ActionListener, java.beans.PropertyChangeListener {
	...
	public void updateThumbnails(){
		...
		java.net.URL leftIconURL = CyAnimatorDialog.class.getResource("img/leftArrow.png");
		java.net.URL rightIconURL = CyAnimatorDialog.class.getResource("../../../src/img/rightArrow.png");
