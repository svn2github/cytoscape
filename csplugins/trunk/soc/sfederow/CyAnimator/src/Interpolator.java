...
public class Interpolator {
	...
	public CyFrame[] makePositionFrames(CyFrame frameOne, CyFrame frameTwo, int framenum){ // throws Exception {
	...
	public CyFrame[] makeColorFrames(CyFrame frameOne, CyFrame frameTwo, int framenum){
