...
public class Interpolator {
	...
	public CyFrame[] makeFrames(CyFrame frameOne, CyFrame frameTwo, int framenum){
		...
		cyFrameArray = interpolateColor(frameOne, frameTwo, 0, framenum+2, cyFrameArray);
	...
	public CyFrame[] interpolateColor(CyFrame frameOne, CyFrame frameTwo, int start, int stop, CyFrame[] cyFrameArray){
