...
public class CyFrame {
	...
	HashMap<String, float[]> nodeTransMap;
	...
	public CyFrame(CyNetwork currentNetwork){
		...
		nodeTransMap = new HashMap<String, float[]>();
	...
	public void populate(CyNetworkView networkView){
		...
		for(Node node: nodeList)
        {
		   ...
		   nodeTransMap.put(node.getIdentifier(), trans);
	...
	public void display(){
		...
		for(Node node: nodeList)
        {
			...
			float[] trans = nodeTransMap.get(node.getIdentifier());
