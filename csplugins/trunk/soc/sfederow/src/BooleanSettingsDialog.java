...
public class BooleanSettingsDialog extends JDialog implements ActionListener, TableModelListener {
	...
	private String[] attributes = Cytoscape.getNodeAttributes().getAttributeNames();
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (command.equals("add")){
			...
			value = currentAlgorithm.getSettings().get("criteriaField").getValue().toString();
			criteria = currentAlgorithm.getSettings().get("criteriaField").getValue().toString();
			if(checkCriteria(value)){ 
				populateList(value, criteria);
			}
		}
