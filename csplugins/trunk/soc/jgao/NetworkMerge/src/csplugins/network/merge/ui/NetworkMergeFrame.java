        ...
        rightButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ...
                if (getOperation()==Operation.DIFFERENCE && selectedNetworkData.getSize()+indices.length>2) {
                    JOptionPane.showMessageDialog(frame,"Difference operation only support two networks! If you need to replace the selected network, remove it first and select the new one.", "Warning", JOptionPane.WARNING_MESSAGE );
                    return;
                }
