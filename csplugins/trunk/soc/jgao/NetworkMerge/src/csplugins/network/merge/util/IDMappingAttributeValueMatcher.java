/* File: IDMappingAttributeValueMatcher.java
...
public class IDMappingAttributeValueMatcher implements AttributeValueMatcher {
        ...
        public boolean matched(String id1, String attr1,
                ...
                if ((type1<0&&type1!=CyAttributes.TYPE_SIMPLE_LIST)
                    ...
                    return o1.equals(o2) // idmapping does not support here
                ...
                // if ID mapping match not successful, use value match?
                if (type1>0&&type2>0) { // simple type
                    ...
                    if (type1>0||type2>0) { // then one is simple type; the other is simple list
                        ...
                        } else { // type2 is simple type and type1 is simple list
