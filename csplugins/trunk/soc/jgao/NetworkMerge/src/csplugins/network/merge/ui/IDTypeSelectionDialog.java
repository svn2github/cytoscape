...
public class IDTypeSelectionDialog extends javax.swing.JDialog {
    ...
    public IDTypeSelectionDialog(java.awt.Frame parent, boolean modal, String[] idTypes, Set<String> selectedIdTypes) {
        super(parent, modal);
    ...
    private void initComponents() {
        ...
        idTypeCheckBoxes = new javax.swing.JCheckBox[n];
        for (int i=0; i<n; i++) {
            idTypeCheckBoxes[i] = new javax.swing.JCheckBox();
            idTypeCheckBoxes[i].setText(idTypes[i]);
            idTypeCheckBoxes[i].setSelected(selectedIdTypes.contains(idTypes[i]));
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                IDTypeSelectionDialog dialog = new IDTypeSelectionDialog(
                        new javax.swing.JFrame(), 
                        true, 
                        new String[]{"Entrez Gene ID","RefSeq Accession","UniProt ID","EMBL ID"},
    ...
    private String[] idTypes; //ID types to be selected
