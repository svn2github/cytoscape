 ...
 */
public abstract class ModifiedForceDirectedLayout extends AbstractGraphPartition
{
	...
	public ModifiedForceDirectedLayout(boolean supportWeights) {
		super();

		logger = CyLogger.getLogger(ModifiedForceDirectedLayout.class);
