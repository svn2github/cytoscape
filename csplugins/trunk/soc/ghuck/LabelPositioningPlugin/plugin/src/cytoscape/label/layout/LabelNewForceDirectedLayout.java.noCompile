...
public class LabelNewForceDirectedLayout extends ModifiedForceDirectedLayout {
    ...
    /**
     * This is the constructor for the ofrce directed layout algorithm.
     */
    public LabelNewForceDirectedLayout(boolean supportEdgeWeights) {

	super(supportEdgeWeights);
	
	logger = CyLogger.getLogger(LabelNewForceDirectedLayout.class);
	...
	return "Label-New-Force-Directed-Layout";
    }
	...
	if (supportWeights)
	    return "Edge-Weighted NEW Force-Directed Label Layout";
	else

	    return "Force-Directed NEW Label Layout";
    }
