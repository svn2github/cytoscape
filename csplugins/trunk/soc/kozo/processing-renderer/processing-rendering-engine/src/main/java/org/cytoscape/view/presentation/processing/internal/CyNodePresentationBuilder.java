...
public class CyNodePresentationBuilder {
	...
	public P5Presentation<CyNode> buildPresentation(View<CyNode> nodeView) throws InstantiationException, IllegalAccessException {
		...
		final P5Presentation<CyNode> presentation = new P5NodePresentation(
				nodeView, value);
