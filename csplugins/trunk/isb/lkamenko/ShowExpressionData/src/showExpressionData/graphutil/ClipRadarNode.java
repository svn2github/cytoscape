...
package csplugins.showExpressionData.graphutil;
...
/**
 * This Class is the BasicClipRadarNode. 
 * It has very limited support. Go look at plain old @see ClipRadarNode.
 ...
 * PImage and PLens. The phoebe default class, ClipRadarNode is 
 * in fact a PClip. 
...
public class ClipRadarNode extends PClip
  ...
  public ClipRadarNode ( int node_index, PGraphView view, Vector data, Vector lamda, String[] conditions, ColorInterpolator interpolP, ColorInterpolator interpolN) {
