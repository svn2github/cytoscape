...
public class StatementTable extends JFrame {
  ...
  /**
   * The <code>StatementCalculator</code> which provides the data
   */
  public StatementCalculator  clientObject;
   ...
   * }
   */
  public StatementTable (StatementCalculator client, 
  ...
  public void addMouseListenerToRows(StatementTable sTable, JTable table) {
    ...
    MouseAdapter listMouseListener = new MouseAdapter() {
        public void mouseClicked(MouseEvent e) {
          ...
          //TODO: Need a better way of dealing with multiple networks!!!!!
          CyNetworkView netView = 
            Cytoscape.getNetworkView(Cytoscape.getCurrentNetwork().getIdentifier());
          netView.setSelected(nodesToSelect);
          //sTableView.clientObject.cytoscapeWindow.selectNodesByName(nodeNames, true);
        }
      };
