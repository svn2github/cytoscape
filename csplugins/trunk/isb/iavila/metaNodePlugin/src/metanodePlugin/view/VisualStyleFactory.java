...
public class VisualStyleFactory {
  ...
  /**
   * Creates and returns a visual style for meta-nodes, sizing of nodes proportional to children number is optional
   * 
   * @param network the CyNetwork with metanodes
   * @return the VisualStyle
   */
  public static VisualStyle createAbstractMetaNodeVisualStyle (CyNetwork network){
	  VisualMappingManager vmManager = Cytoscape.getVisualMappingManager();
	    ...
	    if(sizeProportionalToNumChildren){
