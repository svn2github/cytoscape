 ...
 */
public class NodeDistances implements MonitoredTask {
  ...
  // Methods to implement cytoscape.util.MonitoredTask:
  public void cancel (){this.done = true;}//cancel
  public void incrementProgress (){this.currentProgress++;}//incrementProgress
  ...
  public String getTaskName (){return "APSP...";}//getTaskName
  public String getMessage (){return this.statusMessage;}//getMessage
  public int getCurrent (){return this.currentProgress;}//getCurrent
  public boolean done (){return this.done;}//done
  //----------- cytoscape.util.MonitoredTask
