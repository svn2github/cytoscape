...
# DIP Download must be obtained before hand and copied to "dip" directory at the same level as this script.
# The download can be obtained from DIPs website (http://dip.doe-mbi.ucla.edu/, free registration for academic users), and must be in MIF format.
