...
if(scalar @ARGV < 3){
	print "USAGE: perl update_bind.pl <dbuser> <dbpassword> <dbname>\n";
}
...
print "Creating $dbname if it does not exist...\n";
# make sure user has create permissions!
...
# If this seems to be hanging, then you may need to create your own user name and password because mine expired

print "In subroutine downloadFiles().\n\n";

print "Opening FTP connection to ftp.bind.ca...\n";
...
print "Changing directory to /pub/BIND/current/bindflatfiles/bindindex...\n";
...
print "Finding interaction file names...\n";
foreach $file (@ls){
