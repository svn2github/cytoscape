...
public class AttributesPanel extends JPanel{
    ...
    protected JRadioButton xrefs, definition,hpfp,dburls, encodedBy, geneName, prodName;
    ...
    protected JPanel createAttsPanel (){
        ...
        this.definition = new JRadioButton("Attach a GenBank/RefSeq \"definition\" node attribute.");
        this.hpfp = new JRadioButton("Attach a Proteome Folding Project URL to nodes.");
