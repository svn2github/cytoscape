...
public class InteractionsHandler implements InteractionsDataSource {
	...
	/**
	 * 
	 * @param interaction_sources a Vector of Strings of fully specified classes of InteractionDataSources
	 */
	 ...
	 * 
	 * @param interaction_source fully specified class of the InteractionDataSource to add
	 * @return true if the source was added, false if it was not added (e.g. if it was already there or there was an exception during creation)
	 */
	public boolean addSource (String source_class){
		...
		try{
			...
			System.out.println("Requested class for source is not an InteractionsDataSource:" +
						source_class);
			return false;
	 ...
	 * 
	 * @param interaction_source fully specified class of the InteractionDataSource to add
	 * @param arg an argument to be used to create the InteractionDataSource
	 * @return true if the source was added, false if it was not added (e.g. if it was already there or there was an exception during creation)
	 */
	public boolean addSource (String source_class, Object arg){
		...
		try{
			...
			Class classForName = Class.forName(source_class);
			Constructor cons = classForName.getConstructor(new Class[]{arg.getClass()}); 
	 ...
	 * 
	 * @param interaction_source fully specified class of the InteractionDataSource to add
	 * @param arg1 an argument to be used to create the InteractionDataSource
	 * @param arg2 an argument to be used to create the InteractionDataSource
	 * @return true if the source was added, false if it was not added (e.g. if it was already there or there was an exception during creation)
	 */
	public boolean addSource (String source_class, Object arg1, Object arg2){
		...
		try{
			...
			Class classForName = Class.forName(source_class);
			Constructor cons = classForName.getConstructor(new Class[]{ arg1.getClass(), arg2.getClass() } ); 
	 ...
	 * @param arg1 an argument to be used to create the InteractionDataSource
	 * @param arg2 an argument to be used to create the InteractionDataSource
	 * @param arg3 an argument to be used to create the InteractionDataSource
	 * @return true if the source was added, false if it was not added (e.g. if it was already there or there was an exception during creation)
	 */
	public boolean addSource (String source_class, Object arg1, Object arg2, Object arg3){
	...
	/**
	 * @return the fully specified classes of the InteractionDataSources in this handler
	 */
	public Vector getSources (){
		...
		while(it.hasNext()){
			...
			classes.add(dataSource.getClass());
		}// while it.hasNext
		return classes;
	}
	
	/**
	 * @param source_class the fully specified class of the InteractionsDataSource to check
	 * @return true if an InteractionsDataSource with the given class already exists, false otherwise
	 */
