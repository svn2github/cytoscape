...
public abstract class MyDataClient {
  ...
  /**
   * @param server_url the server URL to which this client connects
   */
   ...
   * you may discover that your round-trip time is fairly high, thanks to Internet backbone latency. 
   * Some servers allow you to batch up multiple requests using the following function.
   */
  ...
  /**
   * Executes any accumulated calls in the batchVector, and then clears it and sets
   * nCallsPerBatch to 0
   */
  ...
  /**
   * Adds to the vector of batch calls the given method and parameters and then
   * does a multicall using that batch vector
   */
  ...
  public synchronized Object call (String method, Object arg0, Object arg1, Object arg2) 
    throws XmlRpcException, IOException{
    args.clear();
    args.add(arg0);
    args.add(arg1);
  ...
  public synchronized Object call (String method, Object arg0, Object arg1, Object arg2, Object arg3)
    throws XmlRpcException, IOException {
    args.clear();
    args.add(arg0);
    args.add(arg1);
  ...
  /**
   * Requests SERVICE_NAME.query with the given argument and then returns the result
   */
  public Object query (String arg0) throws XmlRpcException, IOException{
    Object out = call(SERVICE_NAME + ".query", arg0);
    return (java.lang.Object)XmlRpcUtils.GetObjectFromStruct((Hashtable)out);
  }
  ...
  /**
   * Not implemented in MyDataClient (to be implemented by implementing classes)
   */
