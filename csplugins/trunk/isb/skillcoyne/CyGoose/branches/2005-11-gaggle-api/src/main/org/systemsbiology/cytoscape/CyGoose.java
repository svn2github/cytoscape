...
public class CyGoose implements Goose
   ...
   * @param names
   * 
   * If sent to a network goose (not the default 'null' goose) all matching
   * nodes will be selected. Species is ignored.
   */
	public void handleNameList(String species, String[] names)
			throws RemoteException
		{
		...
		// }
			...
			if (this.getNetworkId() == null || this.getNetworkId().equals("0"))
				...
				CyNetwork NewNet = Cytoscape.createNetwork(species, false);
   ...
   */
	public void handleNetwork(String species, Network gNetwork)
			throws RemoteException
		{
		...
		if (this.getNetworkId() == null || this.getNetworkId().equals("0"))
			...
			handleNetwork(species, gNetwork, Cytoscape
   ...
   * @throws RemoteException
   * 
   * Create a network from the gaggle network either de novo (if null network is
   * handling) or add to the network goose and select added nodes.
   */
	public void handleNetwork(String species, Network GaggleNet, CyNetwork CyNet,
