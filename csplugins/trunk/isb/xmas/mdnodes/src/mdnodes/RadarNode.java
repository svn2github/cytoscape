...
public class RadarNode extends PPath
  ...
  /**
*/
  public RadarNode ( int node_index, PGraphView view, Vector data, Vector lamda, String[] conditions) {
...
public void setLocation (double x, double y)
  ...
  public giny.view.Label getLabel () {
    //return  new giny.view.Label(( String)view.getNodeObjectProperty( rootGraphIndex,
      //                                           PGraphView.NODE_LABEL));
