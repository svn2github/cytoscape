...
/**
*/
  public PetalNode ( int node_index, PGraphView view, Vector data, Vector lamda, String[] conditions) {
...
//                                                    PGraphView.NODE_PAINT ) );
	...
	wedge.quadTo( X2[n],Y2[n],X1[n],Y1[n] );
        ...
        if ( expression < 0 ) {
          ...
          wedge.setPaint( MDNodePlugin.colorInterpolatorNegative.colorFromValue( lamdaValue ) );
	  ...
	  //GradientPaint( bpx, bpy, start, X[n], Y[n], end ) );
          ...
          // POSITIVE
          wedge.setPaint( MDNodePlugin.colorInterpolatorPositive.colorFromValue( lamdaValue ) );
