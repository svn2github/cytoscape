...
public class FilterTreeView 
   ...
   */
  public FilterTreeView ( FilterListPanel flp ) {
    super();
    this.filterListPanel = flp;
    initialize();
  }
  ...
  public void setFilterTree( String name ) {
  }

  public void setFilterTree ( FilterTree tree ) {
  ...
  public void actionPerformed ( ActionEvent e ) {
    ...
    if ( e.getSource() == filterTreeList ) {
      ...
      if ( FilterManager.defaultManager().filterExists( name ) ) {
        ...
        setFilterTree( FilterManager.defaultManager().getFilterTree( name ) );
      } else {
        //status.setText( "" );
        if ( filterTree == null ) {
