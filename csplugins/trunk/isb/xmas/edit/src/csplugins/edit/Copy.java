...
public class Copy extends CytoscapeAction {

  public Copy ( ImageIcon icon ) {
    super( "Copy Nodes and Connecting Edges", icon );
    setPreferredMenu( "Edit" );
    setAcceleratorCombo( java.awt.event.KeyEvent.VK_C,  ActionEvent.CTRL_MASK );
  }
