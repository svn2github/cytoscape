...
*/
public class HierarchicalLayoutListener  {
	

	public void layout ( GraphView networkView ) {

    GraphPerspective network = networkView.getGraphPerspective();
