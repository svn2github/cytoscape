 ...
 * in any of them.
 */
public class NetworkLinkerPlugin extends CytoscapePlugin
    ...
    public NetworkLinkerPlugin() {
        //creates two menu options for turning this plugin on and off
        activateAction = new ActivateNetworkLinkerAction();
        activateAction.setPreferredMenu("Plugins");
        deactivateAction = new DeactivateNetworkLinkerAction();
     ...
     */
    private class ActivateNetworkLinkerAction extends CytoscapeAction {
        
        public ActivateNetworkLinkerAction() {super("Activate Network Linker");}
     ...
     */
    private class DeactivateNetworkLinkerAction extends CytoscapeAction {
        
        public DeactivateNetworkLinkerAction() {super("Deactivate Network Linker");}
