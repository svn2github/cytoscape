...
//					+ adapterName);
	...
	public static void setupNewNetworkView(CyNetworkView newView) {
		...
		// AJK: 07/27/06 BEGIN
		//     experiment with background canvas by putting InnerCanvas on GlassPane
//		((JInternalFrame) Cytoscape.getDesktop()
//				.getNetworkViewManager().getComponentForView(
//				// Cytoscape.getCurrentNetworkView());
//						newView)).setGlassPane(canvas);
//		((JInternalFrame) Cytoscape.getDesktop()
//				.getNetworkViewManager().getComponentForView(
//				// Cytoscape.getCurrentNetworkView());
//						newView)).getGlassPane().setVisible(true);	
		// AJK: 07/27/06 END
	}
