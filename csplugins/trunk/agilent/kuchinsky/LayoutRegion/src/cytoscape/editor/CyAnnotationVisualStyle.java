 ...
 * visual attributes.
 */
public class CyAnnotationVisualStyle implements Cloneable {
    
	// AJK: 08/31/06
    String name = "CyAnnotationVisualStyle";
	...
	CyAnnotationVisualStyle copy = (CyAnnotationVisualStyle) super.clone();
	String dupeFreeName;
	if (dupeCount != 0) {
     ...
     */
    public CyAnnotationVisualStyle(String name) {
        setName(name);
     ...
     * Full constructor.
     */
    public CyAnnotationVisualStyle(String name, NodeAppearanceCalculator nac,
     ...
     */
    public CyAnnotationVisualStyle(CyAnnotationVisualStyle toCopy) {
     ...
     */
    public CyAnnotationVisualStyle(CyAnnotationVisualStyle toCopy, String newName) {
        if (newName == null) {
