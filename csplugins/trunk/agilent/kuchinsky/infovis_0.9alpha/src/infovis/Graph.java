...
public interface Graph extends Metadata {
    ...
    /**
     * Given a specified edge and a vertex on a side of this edge,
     * n
     * 
     * @param edge the edge
    ...
    /**
     * Returns the outgoing edge of a specified vertrex at a specified index
     *  
    ...
    /**
     * Returns an iterator over the out edges of a specified vertex.
     *
     * @param vertex the vertex.
     *
