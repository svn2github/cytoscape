...
public class DynamicQueryPanel
    ...
    public DynamicQueryPanel(
        ...
        hideFilteredButton = new JButton("Hide Filtered");
        hideFilteredButton.addActionListener(this);
        hbox.add(hideFilteredButton);
        hideSelectedButton = new JButton("Hide Selected");
        hideSelectedButton.addActionListener(this);
        hbox.add(hideSelectedButton);
        showAllButton = new JButton("Show All");
        showAllButton.addActionListener(this);
        hbox.add(showAllButton);
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == hideFilteredButton) {
            ...
            //TODO keep the current sort column
            getVisualization().setPermutation(
                    new FilteredRowComparator(
