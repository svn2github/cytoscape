...
public class ExcentricItem implements LabeledComponent.LabeledItem {
    ...
    public Color getColor() {
        VisualColor vc = 
            (VisualColor)visualization.getVisualColumnDescriptor(Visualization.VISUAL_COLOR);
        return vc.getColorAt(index);
    }

    public String getLabel() {
        VisualLabel vl =
            (VisualLabel)visualization.getVisualColumnDescriptor(Visualization.VISUAL_LABEL);
