...
public class Algorithms {
    ...
    public static OpenIntIntHashMap copy(Graph fromGraph, Graph toGraph) {
        ...
        for (RowIterator edge = fromGraph.edgeIterator(); edge
                .hasNext();) {
            int e = edge.nextRow();
            int v1 = fromGraph.getInVertex(e);
            ...
            int v2 = fromGraph.getOutVertex(e);
...
//        }
    ...
    public static int labelComponents(Graph graph, IntColumn labels, IntColumn sizes) {
        int comp = 0;
