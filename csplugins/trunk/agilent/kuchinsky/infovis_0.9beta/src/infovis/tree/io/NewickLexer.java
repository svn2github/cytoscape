// $ANTLR : "Newick.g" -> "NewickLexer.java"$
...
public class NewickLexer extends antlr.CharScanner implements NewickTokenTypes, TokenStream
 {
...
public NewickLexer(InputBuffer ib) {
	this(new LexerSharedInputState(ib));
}
public NewickLexer(LexerSharedInputState state) {
	super(state);
