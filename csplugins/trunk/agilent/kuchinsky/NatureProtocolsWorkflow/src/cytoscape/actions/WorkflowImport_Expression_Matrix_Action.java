 ...
 * 
 */
public class WorkflowImport_Expression_Matrix_Action extends WorkflowPanelAction {

	private static final String IMPORT_MENU_TEXT = "Import";

	private static final String EXPRESSION_MATRIX_MENU_TEXT = "Attribute/Expression Matrix...";
	 ...
	 *            WindowMenu Object.
	 */
	public WorkflowImport_Expression_Matrix_Action(String myString) {
		super(myString);
							...
							if (subMenuItems[j] instanceof JPopupMenu) {
								...
								for (int k = 0; k < popupItems.length; k++) {
									if (popupItems[k] instanceof JMenuItem) {
										...
										if (menuItemText != null) {
											if (menuItemText
													.equals(EXPRESSION_MATRIX_MENU_TEXT)) {
