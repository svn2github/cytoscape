 ...
 * 
 */
public class WorkflowImportNetworkFromFileAction extends WorkflowPanelAction {

	private static final String IMPORT_MENU_TEXT = "Import";

	private static final String GRAPH_FILE_MENU_TEXT = "Network (multiple file types)...";
	 ...
	 *            WindowMenu Object.
	 */
	public WorkflowImportNetworkFromFileAction(String myString) {
		super(myString);
