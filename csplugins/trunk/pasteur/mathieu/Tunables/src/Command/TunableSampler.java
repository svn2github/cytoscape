...
public class TunableSampler implements command {
	...
	@Tunable(description="Test bounded integer (pretend slider)", group={"Numeric Tunables","pretend int slider"})
	...
	@Tunable(description="Single value edge attr", group={"Numeric Tunables","Attribute Tunables"}, flag={Param.Collapsable})
