/*
 * StartTableSortFilterModel.java
 *
 * Created on August 4, 2006, 6:18 PM
 *
 ...
 * @author ogarcia
 */
public class StartTableSortFilterModel extends AbstractTableModel {
    private TableModel model;
    private int sortColumn;
    private Row[] rows;
    /** Creates a new instance of StartTableSortFilterModel */
    public StartTableSortFilterModel(TableModel m) {
        model =m;
