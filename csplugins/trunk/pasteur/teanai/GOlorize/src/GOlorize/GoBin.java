...
public class GoBin extends javax.swing.JFrame{
    ...
    public GoBin(){
        ...
        CyNetworkviewListener cl2 = new CyNetworkviewListener(this);
            ...
            public void actionPerformed(ActionEvent ev){
                ...
                if (comp instanceof ResultPanel)
                    ((ResultPanel)comp).getDisplayPieChart().doIt(((ResultPanel)comp).displayPieChartListener.APPLY_CHANGE,
                            true,Cytoscape.getCurrentNetworkView());
                    ...
                    if (comp2 instanceof StartPanelPanel)
                        ((StartPanelPanel)comp2).getDisplayPieChart().doIt(((StartPanelPanel)comp2).getDisplayPieChart().
                                APPLY_CHANGE,true,Cytoscape.getCurrentNetworkView());
                    else {
...
//startPanel.validate();
    ...
    public void createResultTab(HashMap testMap,
        ...
        ResultPanel result=new ResultPanel( testMap,correctionMap,mapSmallX, mapSmallN,bigX, bigN, alphaString,
                                         annotation, ontology, annotationFile, ontologyFile, testString, correctionString,
...
class CyNetworkviewListener implements PropertyChangeListener {
    GoBin goBin;
    public CyNetworkviewListener(GoBin goB){
        this.goBin=goB;
    }
