...
import GOlorize.BiNGO.SignificantFigures;
import java.io.*;
import java.util.*;
import java.text.*;
import java.math.*;
...
public class ResultPanel extends JPanel implements ResultAndStartPanel{
    ...
    public ResultPanel(HashMap testMap,
        ...
        System.out.println("annotation curator "+annotation.getCurator()+" espece:"+annotation.getSpecies()+" type:"+annotation.getType());
     ...
     void initComponents() { 
                ...
                JLabel annotation_Description = new JLabel(annotation.getCurator()+","+annotation.getSpecies()+","+annotation.getType()+", ontology type:"+annotation.getOntologyType()+","+annotation.getType());
                ...
                for (int i=0;i<columnNames.length;i++){
                        ...
                        if (columnNames[i].equals("GO-ID"))
                         ...
                         if (columnNames[i].equals("total freq"))
                            tcModel.getColumn(i).setPreferredWidth(85);
                         if (columnNames[i].equals("genes annotated to the term"))
                            tcModel.getColumn(i).setPreferredWidth((screenSize.width-15-50-85-85-70-70-40)/2);
...
/////// fin de truc inutile 
    ...
    private Object[] makeHeadersForJTable(){
                ...
                if (testString.equals(NONE)){
                        ...
                        header[3]="cluster frequency";
                        header[4]="total frequency";
                        header[5]="representated genes";
                }	
                else if (correctionString.equals(NONE)){
                        header = new Object[7];
                        ...
                        header[5]="total freq";
                        header[6]="genes annotated to the term";
                        header[3]="p-val";
                }
                else {
                        ...
                        header[6]="total freq";
                        header[7]="genes annotated to the term";
                        header[3]="p-val";
                        header[4]="corr p-val";
                }
