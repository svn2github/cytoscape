...
public class CyFrame {
	...
	private Map<String, NodeView> nodeMap = null;
	private Map<String, EdgeView> edgeMap = null;
	...
	public CyFrame(CyNetwork currentNetwork){
		...
		edgeMap = new HashMap<String, EdgeView>();
		nodeMap = new HashMap<String, NodeView>();
		...
		while(eviter.hasNext()) {
			...
			if (ev.getEdge() == null) continue;
			String edgeid = ev.getEdge().getIdentifier();
