...
public class SMARTSSearchTask extends AbstractCompoundTask {
	...
	/**
 	 ...
 	 */
	public SMARTSSearchTask(String searchString, Collection<GraphObject> selection, CyAttributes attributes,
	                        ChemInfoSettingsDialog dialog, int maxCompounds) {
	...
	public SMARTSSearchTask(String searchString, Collection<GraphObject> selection, CyAttributes attributes,
	                        ChemInfoSettingsDialog dialog, int maxCompounds, List<String> columnList) {
		this.selection = selection;
		this.settingsDialog = dialog;
		this.canceled = false;
		this.maxCompounds = maxCompounds;
	...
	public void run() throws RuntimeException {
		...
		if (cList.size() > 0 && !canceled) {
			...
			compoundTable = new CompoundTable(matches, columnList);
		}
	}
