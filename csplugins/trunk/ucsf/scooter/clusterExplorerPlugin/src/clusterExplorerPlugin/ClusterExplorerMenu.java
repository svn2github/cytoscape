...
public class ClusterExplorerMenu extends JMenu implements ActionListener {
	
	private ClusterExplorerGui gui = null;
	...
	public ClusterExplorerMenu() {
		super("ClusterExplorer");
	...
	private void addMenuItems() {
		...
		startGuiButton = new JMenuItem("Start ClusterExplorer GUI");
		startGuiButton.setActionCommand("embedd");
		startGuiButton.addActionListener(this);
		
		startGuiPanelButton = new JMenuItem("Start ClusterExplorer GUI in an own frame");
		startGuiPanelButton.setActionCommand("frame");
		startGuiPanelButton.addActionListener(this);
		
		stopGuiButton = new JMenuItem("Remove/stop ClusterExplorer GUI");
	...
	private void startGuiFrame() {
		...
		JFrame f = new JFrame("ClusterExplorer");
