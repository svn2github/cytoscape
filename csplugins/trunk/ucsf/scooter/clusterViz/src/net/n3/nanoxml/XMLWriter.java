...
public class XMLWriter
{
      ...
      throws IOException
   {
      ...
      if (xml.getName() == null) {
         ...
         Enumeration n3enum = xml.enumerateAttributeNames();

         while (n3enum.hasMoreElements()) {
            String key = (String) n3enum.nextElement();
         ...
         n3enum = xml.enumerateAttributeNames();
         ...
         if ((xml.getContent() != null)
            ...
            n3enum = xml.enumerateChildren();

            while (n3enum.hasMoreElements()) {
               IXMLElement child = (IXMLElement) n3enum.nextElement();
