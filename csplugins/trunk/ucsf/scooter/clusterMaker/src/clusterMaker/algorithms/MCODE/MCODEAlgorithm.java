package clusterMaker.algorithms.MCODE;
...
public class MCODEAlgorithm {
	 ...
	 */
	public MCODEAlgorithm(String networkID, CyLogger logger) {
		//get current parameters
		params = MCODECurrentParameters.getInstance().getParamsCopy(networkID);
		this.logger = logger;
	}

	public MCODEAlgorithm(TaskMonitor taskMonitor, String networkID, CyLogger logger) {
		this(networkID, logger);
