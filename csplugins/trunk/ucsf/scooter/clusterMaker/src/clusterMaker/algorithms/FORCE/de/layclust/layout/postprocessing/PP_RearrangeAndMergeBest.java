...
//		System.out.println("no of clusters in cluster object: "+ clusterObject.size());
...
//		this.cc.setClusteringScore(this.bestScore);
...
//		System.out.println("score_rearrange = " + this.bestScore);
...
//		System.out.println("score_merge = " + this.bestScore);
...
//		time = System.currentTimeMillis() - time;
//		System.out.println("time taken for updating clusters array: "+time);
	}
...
//				System.out.println("edited clusters!!");
	 ...
	 * @param clusters The ConnectedCompontent clusters array with the cluster number for each node.
...
//					if(!alreadyCompared.contains(v1.toString()+"#"+ v2.toString())){
//						alreadyCompared.add(v1.toString()+"#"+v2.toString());
