...
import clusterMaker.algorithms.TransClust.de.layclust.datastructure.CostMatrixReader;
...
import clusterMaker.algorithms.TransClust.de.layclust.layout.parameter_training.ParameterTraining_SE;
...
public class GeneralParameterTraining {
	...
	public IParameters[] runGeneralTraining() throws InvalidInputFileException, 
		...
		log.debug("terminate training? "+terminateTraining);
	...
	private boolean terminateTraining(IParameters[][] parameters) {
		...
		log.debug("Terminate training: "+terminate);
		return terminate;
	}
	...
	private void runOneGeneration(IParameters[][] parameters, 
		...
		log.info("Start training generation: "+gen);
