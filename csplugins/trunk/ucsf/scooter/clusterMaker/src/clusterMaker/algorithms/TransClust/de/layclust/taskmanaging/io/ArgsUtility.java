...
import de.layclust.geometric_clustering.GeometricClusteringFactory.EnumGeometricClusteringClass;
import de.layclust.layout.LayoutFactory.EnumCCEdgesStructure;
import de.layclust.layout.LayoutFactory.EnumLayouterClass;
import de.layclust.layout.acc.ACCConfig;
import de.layclust.layout.forcend.FORCEnDLayoutConfig;
import de.layclust.layout.parameter_training.ParameterTrainingFactory.EnumParameterTrainingClass;
import de.layclust.postprocessing.PostProcessingFactory.EnumPostProcessingClass;
...
//		optionsNote("", "Turn off parameter training 'none' is also an option.", sb);
		...
		optionsLine("-am", "{'integer'}", "("+ACCConfig.memorySize+")", "Memory size: The number of items that the ant remembers.", sb);
