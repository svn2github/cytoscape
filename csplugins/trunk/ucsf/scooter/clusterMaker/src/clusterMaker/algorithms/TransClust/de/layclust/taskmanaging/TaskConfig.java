...
public class TaskConfig {
	...
	// --------------------- FIXED VARIABLES ---------------------- //	
	/* program details */
	public final static String NAME = "Transitive Clustering";	
	public final static String NAME_EXTENDED = "A Weighted Graph Cluster Editing Tool using Layout-Based Heuristics";
...
//	public static boolean useThreadsForCCs= useThreads;
	public static int maxNoThreads = 2;
...
//	/* ---- logging ---- */
	...
	public static String similarityPath;

	public static boolean greedy = false;

	public static boolean fixedParameter  = true;

	public static int fixedParameterMax = 50;
	
	public static long fpMaxTimeMillis = 2000;
...
//		confile.printParameter("layout.useThreadsForParameterTraining", Boolean.toString(TaskConfig.useThreadsForParameterTraining));
		...
		ACCConfig.printParametersToConfig(confile);
	...
	public static StringBuffer printConfiguration(){
		...
		if(TaskConfig.mode == TaskConfig.CLUSTERING_MODE){
			...
			log.severe("This mode does not exist or needs to be added here: "+TaskConfig.mode);
			System.exit(-1);
		}
		...
		if(TaskConfig.useConfigFile){
			...
			sb.append("No config file! Default configurations as defined in static config classes were used.");
			sb.append(NL);
		}
		sb.append(NL);
