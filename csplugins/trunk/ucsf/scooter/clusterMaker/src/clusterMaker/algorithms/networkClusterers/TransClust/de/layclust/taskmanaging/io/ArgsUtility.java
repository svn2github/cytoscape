...
import clusterMaker.algorithms.networkClusterers.TransClust.de.layclust.geometric_clustering.GeometricClusteringFactory.EnumGeometricClusteringClass;
import clusterMaker.algorithms.networkClusterers.TransClust.de.layclust.layout.LayoutFactory.EnumCCEdgesStructure;
import clusterMaker.algorithms.networkClusterers.TransClust.de.layclust.layout.LayoutFactory.EnumLayouterClass;
import clusterMaker.algorithms.networkClusterers.TransClust.de.layclust.layout.forcend.FORCEnDLayoutConfig;
import clusterMaker.algorithms.networkClusterers.TransClust.de.layclust.layout.parameter_training.ParameterTrainingFactory.EnumParameterTrainingClass;
import clusterMaker.algorithms.networkClusterers.TransClust.de.layclust.postprocessing.PostProcessingFactory.EnumPostProcessingClass;
...
public class ArgsUtility {
	...
	public static StringBuffer createUsage() {
		...
		optionsLine("-log", "{ALL,FINEST,FINER,FINE,CONFIG,INFO,WARNING,SEVERE,OFF}", "("+TaskConfig.logLevel+")", "Defines the level of logging from the most sensitive level to completely off.", sb);
