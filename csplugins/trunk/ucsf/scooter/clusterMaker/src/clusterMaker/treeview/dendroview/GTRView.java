...
import clusterMaker.treeview.LinearTransformation;
import clusterMaker.treeview.ModelViewBuffered;
...
//		System.out.println("GTRView updateBuffer() called offscreenChanged " + offscreenChanged + " valid " + offscreenValid + " yScaleEq " + getYScaleEq());
	...
	if ((drawer != null) && (getXScaleEq() != null)) {
	  if (drawer == null) CyLogger.getLogger(GTRView.class).warn("GTRView.mouseClicked() : drawer is null");
	  if (getXScaleEq() == null) CyLogger.getLogger(GTRView.class).warn("GTRView.mouseClicked() : xscaleEq is null");
