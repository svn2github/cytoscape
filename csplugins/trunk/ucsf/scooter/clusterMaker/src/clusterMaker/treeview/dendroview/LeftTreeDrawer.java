...
public class LeftTreeDrawer extends TreeDrawer {
    ...
    public void paintSubtree(Graphics graphics, LinearTransformation xScaleEq, 
		...
		if ((root == null) || (root.isLeaf() == true))
		  return;
			...
			if (yScaleEq == null) {
				CyLogger.getLogger(LeftTreeDrawer.class).warn("yScaleEq was null in LeftTreeDrawer.paintSubTree!");
	...
	public NodeDrawer(Graphics g, LinearTransformation xScaleEq, 
			  ...
			  {
	  if (yScaleEq == null) {
		  CyLogger.getLogger(LeftTreeDrawer.class).warn("yScaleEq was null!");
		  return;
	  }
	  graphics = g;
	  selected = sel;
