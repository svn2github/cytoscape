...
public class newWindow implements BooleanAlgorithm {
	...
	protected void initializeProperties() {
		...
		booleanProperties.add(new Tunable("operationsList",
										  "Operations",
										  Tunable.LIST,"",(Object)opArray,(Object)null,Tunable.LIST));

		booleanProperties.add(new Tunable("criteriaGroup",
                						  "View Criteria",
                                          Tunable.GROUP, new Integer(2)));
		
		booleanProperties.add(new Tunable("criteriaField",
										  "",
										  Tunable.STRING, new String()));
		
		booleanProperties.add(new Tunable("clearButton",
				  						  "",
                                          Tunable.BUTTON, new String("Clear")));
		
		booleanProperties.add(new Tunable("colorGroup",
				                          "Choose Color",
				                          Tunable.GROUP, new Integer(1)));
		
		booleanProperties.add(new Tunable("mapColor",
                                          "Map to node Color", 
                                          Tunable.BOOLEAN, new Boolean(false)));
		
		/*booleanProperties.add(new Tunable("test",
                                          "test",
                                          Tunable.INTEGER, new Integer(6),(Object)new Integer(0), (Object)new Integer(10),Tunable.USESLIDER));
		*/
