...
public class EnhancedSearchFactory extends AbstractNetworkViewTaskFactory implements EnhancedSearch {
...
//	public EnhancedSearchFactory(CyNetworkManager netmgr) {
//		this.netmgr = netmgr;
//	}

	public Task getTask() {
	
		return new IndexAndSearchTask(view, this);
	}
