...
public class OldStyleCalculatorIO {
    ...
    * @deprecated Use CalculatorIO instead. Will be removed 10/2007
    ...
    public static void checkForCalculators(Properties props,
        ...
        if (!found) {
            return;
        } //not found, so there's nothing to do
        ...
        message.append(
            "Your cytoscape.props file contains visual mappings specified");
        message.append(" in an old format.")
               .append(lineSep);
        message.append(
            "Cytoscape can automatically convert these mappings into the");
        message.append(" new format.")
               .append(lineSep);
        message.append(
            "Simply specify a name for this group of visual mappings,");
        message.append(" and Cytoscape")
               .append(lineSep);
        ...
        message.append(lineSep)
               .append(lineSep);
        message.append(
            "To avoid seeing this message again, please remove all visual");
            ...
            new ActionListener() {
                public void actionPerformed(ActionEvent ae) {
                    ...
                    if ((calcName == null) || calcName.equals("")) {
                        ...
                        JOptionPane.showMessageDialog(frame, s, "Bad name",
    ...
    * @deprecated Use CalculatorIO instead. Will be removed 10/2007
    ...
    public static void loadCalculators(Properties props,
        ...
        loadCalculator(props, catalog, "node.fillColor", nodeColorName,
        ...
        String nodeLineTypeClass = packageHeader +
        ...
        loadCalculator(props, catalog, "node.width", nodeSizeName,
            nodeSizeClass, nodeSizeIntClass, numberInterpolator);

        String nodeSizeName2 = nodeSizeName + "2";
        loadCalculator(props, catalog, "node.height", nodeSizeName2,
            nodeSizeClass, nodeSizeIntClass, numberInterpolator);
        ...
        loadCalculator(props, catalog, "node.shape", nodeShapeName,
            nodeShapeClass, nodeShapeIntClass, flatInterpolator);
        ...
        loadCalculator(props, catalog, "edge.color", edgeColorName,
            edgeColorClass, edgeColorIntClass, colorInterpolator);

        String edgeLineTypeName = "edgeLineTypeCalculator." + calcName;
        String edgeLineTypeClass = packageHeader +
    ...
    * @deprecated Use CalculatorIO instead. Will be removed 10/2007
     */
    private static void loadCalculator(Properties props,
        CalculatorCatalog catalog, String oldBaseKey, String newBaseKey,
        String className, String intClassName, String interpolator) {
        Properties newProps = getNewProperties(props, oldBaseKey, newBaseKey,
        ...
        Calculator c = CalculatorFactory.newCalculator(name, newProps,
                newBaseKey, intClassName);
     ...
     */
    private static Properties getNewProperties(Properties props,
        String oldBaseKey, String newBaseKey, String className,
        String interpolator) {
        ...
        if (controller != null) {
            ...
            if (type == null)
                ...
                newProps.setProperty(newBaseKey + ".mapping.interpolator",
                    interpolator);
            } else
     ...
     * @return  a properties object in the new format
     */
    private static Properties translateDiscrete(Properties props,
        String header, String newBaseKey) {
     ...
     * @return  a properties object in the new format
     */
    private static Properties translateContinuous(Properties props,
        String header, String newBaseKey) {
        Properties newProps = new Properties();
        ...
        for (int i = 0; i < numBV; i++) {
            ...
            String newBvBase = newBaseKey + ".mapping.bv" +
                Integer.toString(i);
    ...
    private static void loadNodeAppearanceCalculator(Properties props,
        CalculatorCatalog catalog, VisualStyle vs, VisualStyle defVS) {
        ...
        String defaultNodeFillString = props.getProperty(
                "node.fillColor.default");
        ...
        String defaultBorderColorString = props.getProperty(
        ...
        if (defaultBorderColorString != null) {
            ...
            defNACAppr.setBorderColor(
                Misc.parseRGBText(defaultBorderColorString));
        }

        String defaultLineTypeString = props.getProperty(
                "node.borderLinetype.default");

        if (defaultLineTypeString != null) {
            defAppr.setBorderLineType(
                ltParser.parseLineType(defaultLineTypeString));
            defNACAppr.setBorderLineType(
                ltParser.parseLineType(defaultLineTypeString));
        }
        ...
        if (defaultShapeString != null) {
            defAppr.setShape(
                ShapeNodeRealizer.parseNodeShapeText(defaultShapeString));
            defNACAppr.setShape(
                ShapeNodeRealizer.parseNodeShapeText(defaultShapeString));
        }
    ...
    private static void loadEdgeAppearanceCalculator(Properties props,
        ...
        String defaultLineTypeString = props.getProperty(
                "edge.linetype.default");

        if (defaultLineTypeString != null) {
            defAppr.setLineType(ltParser.parseLineType(defaultLineTypeString));
            defEACAppr.setLineType(
                ltParser.parseLineType(defaultLineTypeString));
        }

        String defaultSourceString = props.getProperty(
                "edge.sourceDecoration.default");

        if (defaultSourceString != null) {
            defAppr.setSourceArrow(arrowParser.parseArrow(defaultSourceString));
            defEACAppr.setSourceArrow(
                arrowParser.parseArrow(defaultSourceString));
        }

        String defaultTargetString = props.getProperty(
                "edge.targetDecoration.default");

        if (defaultTargetString != null) {
            defAppr.setTargetArrow(arrowParser.parseArrow(defaultTargetString));
            defEACAppr.setTargetArrow(
