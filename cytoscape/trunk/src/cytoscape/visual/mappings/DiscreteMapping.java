 ...
 */
public class DiscreteMapping extends SubjectBase
    ...
    protected byte mapType; //  node or edge; specifies which attributes
                            //  to use.
    private TreeMap<Object, Object> treeMap; //  contains the actual map elements (sorted)
    ...
    */
     ...
     */
    public Object clone() {
        DiscreteMapping clone = new DiscreteMapping(defaultObj, attrName,
                mapType);
    ...
    public Object calculateRangeValue(Map attrBundle) {
        final DiscreteRangeCalculator calculator = new DiscreteRangeCalculator(treeMap,
                attrName);
