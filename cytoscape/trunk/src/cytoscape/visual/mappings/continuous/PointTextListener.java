...
public class PointTextListener extends FocusAdapter {
	...
	public void focusLost(FocusEvent e) {
		...
		try {
			...
			JOptionPane.showMessageDialog(parent, arge.getMessage() + " Please try again.",
	...
	private void checkNextPoint(double newValue) {
		try {
			...
			if (newValue > nextValue) {
				throw new IllegalArgumentException(newValue + " must be greater than "
	...
	private boolean checkPreviousPoint(double newValue) {
		...
		try {
			...
			if (newValue < previousValue) {
				throw new IllegalArgumentException(newValue + " must be less than "
