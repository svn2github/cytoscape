...
public class ContinuousMappingWriter {
	 ...
	 */
	public ContinuousMappingWriter(ArrayList points, String baseKey, String attrName,
	                               Interpolator interp) {
	 ...
	 */
	private void loadProperties(ArrayList points, String baseKey, String contAttrName,
	                            Interpolator interp) {
