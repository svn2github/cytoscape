...
public class EdgeAppearance implements Appearance, Cloneable {
	...
	public void applyAppearance(final EdgeView edgeView) {
		...
		final Stroke newStroke = getLine().getStroke();

		if (!newStroke.equals(edgeView.getStroke()))
			edgeView.setStroke(newStroke);

		final int newSourceEdge = getSourceArrow().getShape().getGinyArrow();
	 ...
	 */
	public void applyDefaultProperties(final Properties eacProps, final String baseKey) {
		String value = null;
		...
		value = eacProps.getProperty(EDGE_LINETYPE.getDefaultPropertyKey(baseKey));
		...
		value = eacProps.getProperty(EDGE_LINE_WIDTH.getDefaultPropertyKey(baseKey));
		...
		value = eacProps.getProperty(EDGE_SRCARROW_SHAPE.getDefaultPropertyKey(baseKey));
		...
		value = eacProps.getProperty(EDGE_SRCARROW_COLOR.getDefaultPropertyKey(baseKey));
		...
		value = eacProps.getProperty(EDGE_TGTARROW_SHAPE.getDefaultPropertyKey(baseKey));
		...
		value = eacProps.getProperty(EDGE_TGTARROW_COLOR.getDefaultPropertyKey(baseKey));
		...
		value = eacProps.getProperty(EDGE_TOOLTIP.getDefaultPropertyKey(baseKey));

		if (value != null)
			setToolTip(value);

		value = eacProps.getProperty(EDGE_FONT_FACE.getDefaultPropertyKey(baseKey));
		...
		value = eacProps.getProperty(EDGE_LABEL_COLOR.getDefaultPropertyKey(baseKey));
	...
	public String getDescription(String prefix) {
		...
		sb.append(prefix + "EdgeSourceArrowColor = ").append(sourceArrow.getColor()).append(lineSep);

		sb.append(prefix + "EdgeTargetArrowColor = ").append(targetArrow.getColor()).append(lineSep);
	...
	public void set(final byte type, final Object c) {
		set(VisualPropertyType.getVisualPorpertyType(type), c);
	}
	...
	public void applyBypass(final Edge e) {
		...
		setColor(BypassHelper.getColorBypass(attrs, id, EDGE_COLOR.getBypassAttrName()));
		setLine((Line) BypassHelper.getBypass(attrs, id, EDGE_LINETYPE.getBypassAttrName(),
		                                      Line.class));
		setSourceArrow((Arrow) BypassHelper.getBypass(attrs, id,
		                                              EDGE_SRCARROW_SHAPE.getBypassAttrName(),
		                                              Arrow.class));
		setTargetArrow((Arrow) BypassHelper.getBypass(attrs, id,
		                                              EDGE_TGTARROW_SHAPE.getBypassAttrName(),
		                                              Arrow.class));

		// New from 2.5:
		setSourceArrowColor(BypassHelper.getColorBypass(attrs, id,
		                                                EDGE_SRCARROW_COLOR.getBypassAttrName()));
		setTargetArrowColor(BypassHelper.getColorBypass(attrs, id,
		                                                EDGE_TGTARROW_COLOR.getBypassAttrName()));

		setLabel((String) BypassHelper.getBypass(attrs, id, EDGE_LABEL.getBypassAttrName(),
		                                         String.class));
		setToolTip((String) BypassHelper.getBypass(attrs, id, EDGE_TOOLTIP.getBypassAttrName(),
		                                           String.class));
		setFont((Font) BypassHelper.getBypass(attrs, id, EDGE_FONT_FACE.getBypassAttrName(),
		                                      Font.class));

		final Double d = (Double) BypassHelper.getBypass(attrs, id,
		...
		setLabelColor(BypassHelper.getColorBypass(attrs, id, EDGE_LABEL_COLOR.getBypassAttrName()));
	}
}
