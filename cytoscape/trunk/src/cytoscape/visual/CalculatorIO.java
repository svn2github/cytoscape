...
public class CalculatorIO {
	...
	private static final String nodeFillColorBaseKey = CalculatorFactory.getPropertyLabel(VizMapUI.NODE_COLOR);
	private static final String nodeBorderColorBaseKey = CalculatorFactory.getPropertyLabel(VizMapUI.NODE_BORDER_COLOR);
	private static final String nodeWidthBaseKey = CalculatorFactory.getPropertyLabel(VizMapUI.NODE_WIDTH);
	private static final String nodeHeightBaseKey = CalculatorFactory.getPropertyLabel(VizMapUI.NODE_HEIGHT);
	private static final String nodeUniformSizeBaseKey = CalculatorFactory.getPropertyLabel(VizMapUI.NODE_SIZE);
	private static final String edgeSourceArrowBaseKey = CalculatorFactory.getPropertyLabel(VizMapUI.EDGE_SRCARROW);
	private static final String edgeTargetArrowBaseKey = CalculatorFactory.getPropertyLabel(VizMapUI.EDGE_TGTARROW);
	...
	public static void loadCalculators(Properties props, CalculatorCatalog catalog,
		...
		for (String name : nacNames.keySet()) {
			...
			NodeAppearanceCalculator nac = new NodeAppearanceCalculator(name, nacProps, apprType,
			                                                            catalog);
		...
		for (String name : eacNames.keySet()) {
			...
			EdgeAppearanceCalculator eac = new EdgeAppearanceCalculator(name, eacProps, apprType,
			                                                            catalog);
		...
		for (String name : gacNames.keySet()) {
			...
			GlobalAppearanceCalculator gac = new GlobalAppearanceCalculator(name, gacProps,
			                                                                apprType, catalog);
