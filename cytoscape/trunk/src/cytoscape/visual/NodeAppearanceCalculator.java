...
public class NodeAppearanceCalculator extends AppearanceCalculator {
	 ...
	 */
	public NodeAppearanceCalculator(String name, Properties nacProps, String baseKey,
	...
	protected void copyDefaultAppearance(AppearanceCalculator toCopy) {
		defaultAppearance = (NodeAppearance) (((NodeAppearanceCalculator) toCopy).getDefaultAppearance()
		                                       .clone());
	}
