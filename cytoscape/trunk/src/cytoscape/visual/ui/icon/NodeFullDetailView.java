...
public class NodeFullDetailView extends JPanel {
	...
	private String originalId = Cytoscape.getCurrentNetwork().getIdentifier();
	...
	static {
		...
		edge = Cytoscape.getCyEdge(source.getIdentifier(), "Edge", target
				.getIdentifier(), "Interaction");
		
	}
	
//	public static Component getCurrent() {
//		final NodeFullDetailView nv = new NodeFullDetailView();
//		nv.createTempNetwork();
//		nv.createView();
//		final Component c = nv.getCanvas();
//		nv.clean();
//		return c;
//	}
	...
	public void createTempNetwork() {
		...
		System.out.println("Focused: " + Cytoscape.getCurrentNetworkView().getTitle());
		System.out.println("Focused2: " + Cytoscape.getCurrentNetworkView().getTitle());
