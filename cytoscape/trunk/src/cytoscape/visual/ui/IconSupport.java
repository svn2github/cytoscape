...
public class IconSupport {
	...
	public static ImageIcon[] getArrowIcons() {
		...
		arrowIcons[0] = new ImageIcon(locateImage("/cytoscape/images/edgeEnds/arrow_none.jpg"),
		                              "NONE");

		arrowIcons[1] = new ImageIcon(locateImage("/cytoscape/images/edgeEnds/WHITE_DIAMOND.jpg"),
		                              "WHITE_DIAMOND");
		arrowIcons[2] = new ImageIcon(locateImage("/cytoscape/images/edgeEnds/BLACK_DIAMOND.jpg"),
		                              "BLACK_DIAMOND");
		arrowIcons[3] = new ImageIcon(locateImage("/cytoscape/images/edgeEnds/COLOR_DIAMOND.jpg"),
		                              "COLOR_DIAMOND");

		arrowIcons[4] = new ImageIcon(locateImage("/cytoscape/images/edgeEnds/WHITE_DELTA.jpg"),
		                              "WHITE_DELTA");
		arrowIcons[5] = new ImageIcon(locateImage("/cytoscape/images/edgeEnds/BLACK_DELTA.jpg"),
		                              "BLACK_DELTA");
		arrowIcons[6] = new ImageIcon(locateImage("/cytoscape/images/edgeEnds/COLOR_DELTA.jpg"),
		                              "COLOR_DELTA");

		arrowIcons[7] = new ImageIcon(locateImage("/cytoscape/images/edgeEnds/WHITE_CIRCLE.jpg"),
		                              "WHITE_CIRCLE");
		arrowIcons[8] = new ImageIcon(locateImage("/cytoscape/images/edgeEnds/BLACK_CIRCLE.jpg"),
		                              "BLACK_CIRCLE");
		arrowIcons[9] = new ImageIcon(locateImage("/cytoscape/images/edgeEnds/COLOR_CIRCLE.jpg"),
		                              "COLOR_CIRCLE");

		arrowIcons[10] = new ImageIcon(locateImage("/cytoscape/images/edgeEnds/WHITE_ARROW.jpg"),
		                               "WHITE_ARROW");
		arrowIcons[11] = new ImageIcon(locateImage("/cytoscape/images/edgeEnds/BLACK_ARROW.jpg"),
		                               "BLACK_ARROW");
		arrowIcons[12] = new ImageIcon(locateImage("/cytoscape/images/edgeEnds/COLOR_ARROW.jpg"),
		                               "COLOR_ARROW");

		arrowIcons[13] = new ImageIcon(locateImage("/cytoscape/images/edgeEnds/WHITE_T.jpg"),
		                               "WHITE_T");
		arrowIcons[14] = new ImageIcon(locateImage("/cytoscape/images/edgeEnds/BLACK_T.jpg"),
		                               "BLACK_T");
		arrowIcons[15] = new ImageIcon(locateImage("/cytoscape/images/edgeEnds/COLOR_T.jpg"),
		                               "COLOR_T");
	...
	public static ImageIcon[] getShapeIcons() {
		...
		shapeIcons[0] = new ImageIcon(locateImage("images/ellipse.jpg"), "ELLIPSE");
		shapeIcons[1] = new ImageIcon(locateImage("images/round_rect.jpg"), "ROUND_RECT");
		shapeIcons[2] = new ImageIcon(locateImage("images/rect.jpg"), "RECTANGLE");
		shapeIcons[3] = new ImageIcon(locateImage("images/diamond.jpg"), "DIAMOND");
		shapeIcons[4] = new ImageIcon(locateImage("images/hexagon.jpg"), "HEXAGON");
		shapeIcons[5] = new ImageIcon(locateImage("images/octagon.jpg"), "OCTAGON");
		shapeIcons[6] = new ImageIcon(locateImage("images/parallelogram.jpg"), "PARALLELOGRAM");
		shapeIcons[7] = new ImageIcon(locateImage("images/triangle.jpg"), "TRIANGLE");
	...
	public static ImageIcon[] getLineTypeIcons() {
		...
		lineTypeIcons[0] = new ImageIcon(locateImage("images/line_1.jpg"), "LINE_1");
		lineTypeIcons[1] = new ImageIcon(locateImage("images/line_2.jpg"), "LINE_2");
		lineTypeIcons[2] = new ImageIcon(locateImage("images/line_3.jpg"), "LINE_3");
		lineTypeIcons[3] = new ImageIcon(locateImage("images/line_4.jpg"), "LINE_4");
		lineTypeIcons[4] = new ImageIcon(locateImage("images/line_5.jpg"), "LINE_5");
		lineTypeIcons[5] = new ImageIcon(locateImage("images/line_6.jpg"), "LINE_6");
		lineTypeIcons[6] = new ImageIcon(locateImage("images/line_7.jpg"), "LINE_7");
		lineTypeIcons[7] = new ImageIcon(locateImage("images/dashed_1.jpg"), "DASHED_1");
		lineTypeIcons[8] = new ImageIcon(locateImage("images/dashed_2.jpg"), "DASHED_2");
		lineTypeIcons[9] = new ImageIcon(locateImage("images/dashed_3.jpg"), "DASHED_3");
		lineTypeIcons[10] = new ImageIcon(locateImage("images/dashed_4.jpg"), "DASHED_4");
		lineTypeIcons[11] = new ImageIcon(locateImage("images/dashed_5.jpg"), "DASHED_5");
	...
	public static ImageIcon getNodeSizeIcon(Double d) {
		...
		BufferedImage bi = new BufferedImage(size + bound + bound, size + bound + bound,
