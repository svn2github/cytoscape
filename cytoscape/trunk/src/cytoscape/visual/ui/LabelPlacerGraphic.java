 ...
 * of node labels.
 */
class LabelPlacerGraphic extends JPanel
    ...
    public void paint(Graphics gin) {
        ...
        if (renderDetail) {
            ...
            if (justify == Label.JUSTIFY_LEFT) {
                ...
                g.drawString(label,
                    (xOffset + xPos + ((lx - labelLen) / 2)) -
                    detailStrokeWidth, yOffset + yPos + vspace + ascent);
                g.drawString(click,
                    (xOffset + xPos + ((lx - clickLen) / 2)) -
            ...
            if (justify == Label.JUSTIFY_LEFT)
                ...
                g.drawLine(xOffset + xPos + ((2 * lx) / 3),
                    yOffset + yPos + (ly / 2), xOffset + xPos + lx,
                    yOffset + yPos + (ly / 2));
            else
        ...
        if (renderDetail) {
            ...
            for (int i = 0; i < lxpoints.length; i++)
                for (int j = 0; j < lypoints.length; j++) {
                    ...
                    g.fillOval((xPos + lxpoints[i]) - (dot / 2),
                        (yPos + lypoints[j]) - (dot / 2), dot, dot);
            ...
            for (int j = 0; j < npoints.length; j++) {
                ...
                for (int a = 0; a < lxpoints.length; a++) {
                    for (int b = 0; b < lypoints.length; b++) {
                        Point labelPoint = new Point((xPos + lxpoints[a]) -
                                (dot / 2), (yPos + lypoints[b]) - (dot / 2));
