...
class NodeBypass extends VizMapBypass {
	...
	protected String[] getBypassNames() {
		String[] names = {
		                     "node.fillColor", "node.borderColor", "node.lineType", "node.size",
		                     "node.width", "node.height", "node.shape", "node.label",
		                     "node.labelColor", "node.labelPosition", "node.font", "node.fontSize"
		                 };
