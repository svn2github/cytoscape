...
public class VizMapperMainPanel extends JPanel
    ...
    public static Object showValueSelectDialog(VisualPropertyType type,
        ...
        switch (type) {
        case NODE_SHAPE:
            newValue = ValueSelectDialog.showDialog(VisualPropertyType.NODE_SHAPE,
                    null);
        ...
        case EDGE_TGTARROW_SHAPE:
            newValue = ValueSelectDialog.showDialog(VisualPropertyType.EDGE_SRCARROW_SHAPE,
                    (JDialog) caller);
        ...
        case EDGE_LINETYPE:
        case NODE_LINETYPE:
            newValue = ValueSelectDialog.showDialog(VisualPropertyType.EDGE_LINETYPE,
                    (JDialog) caller);
        ...
        case EDGE_LABEL_COLOR:
            ...
            newValue = JColorChooser.showDialog(caller,
                    "Select " + type.getName(), null);
        ...
        case EDGE_LINE_WIDTH:
            newValue = Double.valueOf(
                    JOptionPane.showInputDialog(caller, "Please enter new value"));
    ...
    // For colors
    private CyColorCellRenderer cr = new CyColorCellRenderer();
    ...
    private void setDefaultPanel(int viewType) {
        ...
        for (int i = 0; i < VisualPropertyType.values().length; i++) {
            String name = CalculatorFactory.getTypeName(
                    VisualPropertyType.values()[i].getType());
    ...
    private void setPropertySheetAppearence() {
                    ...
                    for (int i = 0; i < rowCount; i++) {
                        ...
                        if ((shownProp != null) &&
                            ...
                            if (type instanceof VisualPropertyType) {
                                ObjectMapping mapping = vmm.getVisualStyle()
                                                           .getNodeAppearanceCalculator()
                    ...
                    if (SwingUtilities.isRightMouseButton(e)) {
                        ...
                        if (0 <= selected) {
                            ...
                            if ((curProp != null) &&
                                ...
                                prop = (VizMapperProperty) curProp.getParentProperty();

                            if ((prop != null) &&
                                    (prop.getType() == VisualPropertyType.class)) {
                                final VisualPropertyType type = (VisualPropertyType) prop.getHiddenObject();
         ...
         * Set editors
         */
        cr.setForeground(Color.DARK_GRAY);
        cr.setOddBackgroundColor(new Color(150, 150, 150, 20));
        cr.setEvenBackgroundColor(Color.white);
    ...
    private void setDiscreteProps(VisualPropertyType type, Map discMapping,
        ...
        for (Object key : attrKeys) {
            final VizMapperProperty valProp = new VizMapperProperty();
            ...
            //			if(type == VisualPropertyType.NODE_SHAPE) {
            //				((ShapeCellRenderer)rend).set
            //			}
                ...
                if ((firstMap.getClass() == DiscreteMapping.class) &&
                    ...
                    case EDGE_LABEL_COLOR:
                        setDiscreteProps(type, discMapping, attrSet,
                            colorCellEditor, cr, calculatorTypeProp);
    ...
    private void editSelectedCells() {
        ...
        case EDGE_TOOLTIP:
            newValue = JOptionPane.showInputDialog(this,
                    "Please enter new " + type.getName() + " text.");

            break;

        case NODE_LABEL_POSITION:
            newValue = PopupLabelPositionChooser.showDialog(
                    Cytoscape.getDesktop(),
                    null);
        ...
        case NODE_SHAPE:
            newValue = showValueSelectDialog(
                    type,
                    Cytoscape.getDesktop());
