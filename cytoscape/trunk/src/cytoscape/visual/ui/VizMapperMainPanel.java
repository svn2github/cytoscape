...
public class VizMapperMainPanel extends JPanel implements PropertyChangeListener, CyNetworkListener {
	...
	private void setVSSelector() {
		...
		for (String name : vsNames) {
			...
			vmm.setVisualStyle(name);
			defPanel = DefaultAppearenceBuilder.getDefaultView();
	...
	private void buildProperty(Calculator calc, VizMapperProperty calculatorTypeProp,
		...
		if (firstMap != null) {
			...
			if (attrName == null) {
				...
				calculatorTypeProp.setShortDescription("Attribute Data Type = " + CyAttributesUtils.getClass(attrName, attr).toString());
	...
	public void propertyChange(PropertyChangeEvent e) {
		...
		*/
		...
		//		System.out.println("Event = " + e.getPropertyName() + ", Source = "
		//                + e.getSource() + ", New val = " + e.getNewValue());
		if (e.getPropertyName().equals(Cytoscape.CYTOSCAPE_INITIALIZED)) {
			...
			this.setDefaultPanel(this.defaultImageManager.get(vmName));
		...
		public void actionPerformed(ActionEvent e) {
			final SwingWorker worker = new SwingWorker() {
				public Object construct() {
					LegendDialog ld = new LegendDialog(parent, vmm.getVisualStyle());
					ld.setVisible(true);
	...
	private class NewStyleListener extends AbstractAction {
		public void actionPerformed(ActionEvent e) {
			...
			final JPanel defPanel = DefaultAppearenceBuilder.getDefaultView();
	...
	*/
	private class RenameStyleListener extends AbstractAction {
		public void actionPerformed(ActionEvent e) {
			...
			System.out.println("New props for ");
	...
	private void editSelectedCells() {
		...
		Object key = null;
		final Class keyClass = CyAttributesUtils.getClass(mapping.getControllingAttributeName(), attr);
