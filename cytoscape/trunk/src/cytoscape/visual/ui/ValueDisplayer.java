...
public class ValueDisplayer extends JButton {
	 ...
	 * @return  DOCUMENT ME!
	 */
	public static ValueDisplayer getDisplayForLabelPosition(JDialog parent, String title,
	                                                        LabelPosition c) {
	...
	protected void fireItemSelected() {
		this.fireItemStateChanged(new ItemEvent(this, ItemEvent.ITEM_STATE_CHANGED, inputObj,
		                                        ItemEvent.SELECTED));
	}
	...
	private class ColorListener extends AbstractAction {
		...
		public void actionPerformed(ActionEvent e) {
			if (enabled) {
				Color tempColor = CyColorChooser.showDialog(parent.parent, parent.title,
	...
	private class LabelPositionListener extends AbstractAction {
		...
		public void actionPerformed(ActionEvent e) {
			if (enabled) {
				LabelPosition pos = PopupLabelPositionChooser.showDialog(parent.parent,
				                                                         (LabelPosition) parent.inputObj);
	...
	private static ValueDisplayer getDisplayForIcons(JDialog parent, String title, Object startObj,
	                                                 byte type) {
	...
	private void setInputIconListener(String title, String objectName, Object startObject,
	...
	private static ValueDisplayer getDisplayForDouble(JDialog parent, String title, double init) {
		ValueDisplayer v = new ValueDisplayer(parent, formatter.format(init), title, DOUBLE);
	...
	private static ValueDisplayer getDisplayForInt(JDialog parent, String title, int init) {
		ValueDisplayer v = new ValueDisplayer(parent, Integer.toString(init), title, INT);
	...
	public static ValueDisplayer getBlankDisplayFor(JDialog parent, String title, byte type) {
		switch (type) {
			...
			case NODESHAPE:
				return getDisplayForIcons(parent, title, new Byte(ShapeNodeRealizer.ELLIPSE),
				                          NODESHAPE);
	...
	public static ValueDisplayer getBlankDisplayFor(JDialog parent, String title, Object sampleObj) {
		if (sampleObj instanceof Color) {
			...
			throw new ClassCastException("ValueDisplayer doesn't know how to display type "
	 ...
	 *             if you didn't pass in a known type
	 */
	public static ValueDisplayer getDisplayFor(JDialog parent, String title, Object o)
	    throws ClassCastException {
