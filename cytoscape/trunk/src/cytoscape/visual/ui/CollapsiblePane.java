...
public class CollapsiblePane extends JPanel {
    ...
    final static int COLLAPSED = 0; // image States

    //Expand/Collapse button
    final static int EXPANDED = 1; // image States
     ...
     */
    public CollapsiblePane(JRadioButton component) {
        component.addItemListener(
            new CollapsiblePane.ExpandAndCollapseAction());
     ...
     */
    public CollapsiblePane(String text) {
        arrow.setText(text);
    ...
    private void placeTitleComponent() {
        ...
        Rectangle componentRectangle = border.getComponentRect(containerRectangle,
                insets);
    ...
    private ImageIcon[] createExpandAndCollapseIcon() {
        ...
        iconURL = Cytoscape.class.getResource(
                "images/ximian/arrow_collapsed.gif");

        if (iconURL != null)
            iconArrow[COLLAPSED] = new ImageIcon(iconURL);

        iconURL = Cytoscape.class.getResource(
                "images/ximian/arrow_expanded.gif");
    ...
    private JButton createArrowButton() {
        ...
        Font font = BorderFactory.createTitledBorder("Sample")
                                 .getTitleFont();
        ...
        button.addActionListener(new CollapsiblePane.ExpandAndCollapseAction());
    ...
    private class CollapsableTitledBorder extends TitledBorder {
        ...
        public void paintBorder(Component c, Graphics g, int x, int y,
            ...
            Rectangle borderR = new Rectangle(x + EDGE_SPACING,
                    y + EDGE_SPACING, width - (EDGE_SPACING * 2),
        ...
        public Rectangle getComponentRect(Rectangle rect, Insets borderInsets) {
            ...
            case DEFAULT_POSITION:
                ...
                if (titleComponent instanceof JButton)
                    ...
                    compR.y = (borderInsets.top - EDGE_SPACING - TEXT_SPACING -
                        compD.height) / 2;
