...
public class PluginManageDialog extends javax.swing.JDialog implements
	...
	public void switchDownloadSites()
		{
		MutableTreeNode[] DeletableNodes = new MutableTreeNode[availableNode
				.getChildCount()];
		...
		totalAvailable = 0;
		int i = 0;
		for (java.util.Enumeration<javax.swing.tree.TreeNode> E = availableNode
	...
	private void deleteHandler(ActionEvent evt)
		...
		if (JOptionPane.YES_OPTION == JOptionPane.showConfirmDialog(Cytoscape
				.getDesktop(), VerifyMsg, "Verify Delete Plugin",
				...
				License.addListenerToFinish(new ActionListener()
					{
						public void actionPerformed(java.awt.event.ActionEvent evt)
							...
							worker.start();
							System.out.println("Finish listener called");
							License.dispose();
							}
					});
	...
	private void initComponents()
		...
		installedNode = new DefaultMutableTreeNode(PluginInstallStatus.INSTALLED
				.toString());
		availableNode = new DefaultMutableTreeNode(PluginInstallStatus.AVAILABLE
				.toString());
		...
		labelPaneLayout.setHorizontalGroup(labelPaneLayout.createParallelGroup(
				...
				labelPaneLayout.createSequentialGroup().add(siteLabel,
		...
		buttonPanelLayout.setHorizontalGroup(buttonPanelLayout.createParallelGroup(
				...
				buttonPanelLayout.createSequentialGroup().addContainerGap(36,
						...
						downloadButton).add(18, 18, 18).add(deleteButton).add(30, 30, 30)
		...
		buttonPanelLayout.setVerticalGroup(buttonPanelLayout.createParallelGroup(
				...
				buttonPanelLayout.createParallelGroup(
						...
						deleteButton).add(downloadButton).add(changeSiteButton)));
		...
		SwingWorker worker = new SwingWorker()
			{
				public Object construct()
					...
					final IndeterminateProgressBar InstallBar = new IndeterminateProgressBar(
							Dialog, "Downloading Plugin", info.getName()
					...
					try
						...
						Mgr.download(info);
						InstallBar.dispose();
						JOptionPane.showMessageDialog(Dialog, "Plugin '" + info.getName()
								+ "' downloaded.\n"
