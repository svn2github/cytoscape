...
public class LicenseDialog extends javax.swing.JDialog
	...
	private void initComponents()
		...
		agreeRadio.setBorder(javax.swing.BorderFactory
		...
		declineRadio.setBorder(javax.swing.BorderFactory.createEmptyBorder(0, 0, 0,
				0));
						...
						layout.createSequentialGroup().addContainerGap().add(
								layout.createParallelGroup(
										...
										layout.createParallelGroup(
												org.jdesktop.layout.GroupLayout.LEADING).add(
												jScrollPane1,
												org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 363,
												org.jdesktop.layout.GroupLayout.PREFERRED_SIZE).add(
												org.jdesktop.layout.GroupLayout.TRAILING,
												layout.createSequentialGroup().add(agreeRadio).add(30,
														30, 30).add(declineRadio).add(42, 42, 42).add(
														finishButton).add(30, 30, 30).add(cancelButton)))
										.add(pluginLicenseLabel)).addContainerGap(24,
								Short.MAX_VALUE)));
		layout.setVerticalGroup(layout.createParallelGroup(
				org.jdesktop.layout.GroupLayout.LEADING).add(
				layout.createSequentialGroup().add(12, 12, 12).add(pluginLicenseLabel)
						.addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED).add(
								jScrollPane1, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE,
								225, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE).add(15,
								15, 15).add(
								layout.createParallelGroup(
										org.jdesktop.layout.GroupLayout.BASELINE).add(cancelButton)
										.add(finishButton).add(declineRadio).add(agreeRadio))
