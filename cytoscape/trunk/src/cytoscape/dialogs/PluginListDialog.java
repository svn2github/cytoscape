...
public class PluginListDialog extends JDialog
	...
	private void initButtons()
		...
		SearchForNew.addActionListener( new ActionListener()
			...
			public void actionPerformed(ActionEvent Event)
				...
				String[] Urls = new String[] { CytoscapeInit.getProperties().getProperty("defaultPluginUrl") };
			...
			public void actionPerformed(ActionEvent Event)
				...
				if (Obj.getCategory().equalsIgnoreCase("core"))
					...
					if(JOptionPane.YES_OPTION == 
								JOptionPane.showConfirmDialog(Cytoscape.getDesktop(), Msg, "Core Plugin Removal", 
				...
				if (delete)
					...
					if (CytoscapeInit.getPluginManager().delete(Obj))
						JOptionPane.showMessageDialog(Cytoscape.getDesktop(), "Plugin " + Obj.getName() + " successfully deleted.", "Plugin Deletion", JOptionPane.PLAIN_MESSAGE);
					else
						JOptionPane.showMessageDialog(Cytoscape.getDesktop(), "Failed to delete plugin " + Obj.getName() + ".  You may need to manually delete it.");
					PluginListDialog.this.dispose();
					}
	...
	private class TableModel extends AbstractTableModel
		...
		public void setValueAt(Object Value, int row, int col)
			{ // TODO fix this, it's not setting correctly
		...
		public void removeRow(int row)
			{ // this doesn't actually work....causes a nasty exception (is there another kind??)
			removeRow(row);
