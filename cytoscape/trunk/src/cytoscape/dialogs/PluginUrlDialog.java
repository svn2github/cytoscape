	...
	private void bookmarksSetUp()
		...
		try
			...
			JOptionPane.showMessageDialog(Cytoscape.getDesktop(),
					"Failed to retrieve bookmarks for plugin download sites.", "Error",
...
//			}
	...
	private void okHandler(java.awt.event.ActionEvent evt)
		...
		try
			...
			Map<String, List<PluginInfo>> NewPlugins = Mgr.getPluginsByCategory( 
					Mgr.inquire(SelectedSite.getHref()) );
			for(String Category: NewPlugins.keySet())
				{
				parentDialog.addCategory(Category, NewPlugins.get(Category), 
						PluginManageDialog.PluginStatus.AVAILABLE);
				}
			PluginUrlDialog.this.dispose();
			}
		catch (cytoscape.plugin.ManagerError E)
			{
			JOptionPane.showMessageDialog(parentDialog, E.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
			E.printStackTrace();
			}
		}
	...
	private void initComponents()
		...
		labelPanelLayout.setHorizontalGroup(labelPanelLayout.createParallelGroup(
				GroupLayout.LEADING).add(
				labelPanelLayout.createSequentialGroup().addContainerGap().add(label,
						GroupLayout.DEFAULT_SIZE, 239, Short.MAX_VALUE).addContainerGap()));
		labelPanelLayout.setVerticalGroup(labelPanelLayout.createParallelGroup(
				GroupLayout.LEADING).add(
				labelPanelLayout.createSequentialGroup().addContainerGap().add(label,
						GroupLayout.DEFAULT_SIZE, 16, Short.MAX_VALUE).addContainerGap()));
		okButton.setText("Ok");
		...
		jPanel1Layout.setHorizontalGroup(jPanel1Layout.createParallelGroup(
				GroupLayout.LEADING).add(
				jPanel1Layout.createSequentialGroup().add(8, 8, 8).add(okButton)
						.addPreferredGap(LayoutStyle.RELATED).add(addSiteButton)
		...
		jPanel1Layout.setVerticalGroup(jPanel1Layout.createParallelGroup(
				...
				jPanel1Layout.createSequentialGroup().addContainerGap().add(
						jPanel1Layout.createParallelGroup(GroupLayout.BASELINE).add(
								okButton).add(addSiteButton).add(cancelButton))
		...
		layout.setHorizontalGroup(layout.createParallelGroup(GroupLayout.LEADING)
				.add(
						layout.createSequentialGroup().add(
								layout.createParallelGroup(GroupLayout.LEADING).add(labelPanel,
										GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
										GroupLayout.PREFERRED_SIZE).add(
										layout.createSequentialGroup().add(21, 21, 21).add(
												layout.createParallelGroup(GroupLayout.LEADING).add(
														urlComboBox, 0, 296, Short.MAX_VALUE).add(jPanel1,
		...
		layout.setVerticalGroup(layout.createParallelGroup(GroupLayout.LEADING)
				.add(
						layout.createSequentialGroup().add(labelPanel,
								...
								.addPreferredGap(LayoutStyle.RELATED).add(urlComboBox,
										GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
