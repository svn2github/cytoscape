...
public class PluginManageDialog extends javax.swing.JDialog implements
	...
	public void valueChanged(TreeSelectionEvent e)
		...
		if (Node.isLeaf())
			...
			pluginInfoPane
					.setText(((PluginInfo) Node.getUserObject()).prettyOutput());
	...
	public void switchDownloadSites()
		...
		// not sure why I had to do it like this, always missed the second node if I tried to 
	...
	// get updates -- NEED A BUTTON TO ATTACH TO THIS
	private void updateHandler(java.awt.event.ActionEvent evt)
		{
		PluginManager Mgr = PluginManager.getPluginManager();
		for(PluginInfo obj: Mgr.getInstalledPlugins())
			{
			try
				{
				Mgr.update(obj);
	...
	private void deleteHandler(ActionEvent evt)
		...
		if (JOptionPane.YES_OPTION == JOptionPane.showConfirmDialog(Cytoscape
				.getDesktop(), VerifyMsg, "Verify Delete Plugin", JOptionPane.YES_NO_OPTION,
				JOptionPane.QUESTION_MESSAGE)) 
			{
			PluginManager.getPluginManager().delete(NodeInfo);
			removeNode(Node);
			JOptionPane.showMessageDialog(Cytoscape.getDesktop(), "Plugin "
					+ NodeInfo.getName() + " will be removed when you restart Cytoscape.", "Plugin Deletion",
	...
	public void removeNode(DefaultMutableTreeNode Node)
		...
		if (parent != null) treeModel.removeNodeFromParent(Node);

		if (!parent.children().hasMoreElements() && !parent.equals(availableNode)
				&& !parent.equals(installedNode)) treeModel
	...
	private void initComponents()
		...
		installedNode = new DefaultMutableTreeNode(PluginStatus.INSTALLED
				.toString());
		availableNode = new DefaultMutableTreeNode(PluginStatus.AVAILABLE
				.toString());
		...
		labelPaneLayout.setHorizontalGroup(labelPaneLayout.createParallelGroup(
				...
				labelPaneLayout.createSequentialGroup().addContainerGap().add(
						dialogLabel, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 191,
						org.jdesktop.layout.GroupLayout.PREFERRED_SIZE).addPreferredGap(
						org.jdesktop.layout.LayoutStyle.RELATED, 63, Short.MAX_VALUE).add(
						siteLabel).add(126, 126, 126)));
		labelPaneLayout.setVerticalGroup(labelPaneLayout.createParallelGroup(
				org.jdesktop.layout.GroupLayout.LEADING).add(dialogLabel,
				org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 50, Short.MAX_VALUE).add(
				org.jdesktop.layout.GroupLayout.TRAILING, siteLabel,
		...
		buttonPanelLayout.setHorizontalGroup(buttonPanelLayout.createParallelGroup(
				...
				buttonPanelLayout.createSequentialGroup().addContainerGap(36,
						Short.MAX_VALUE).add(changeSiteButton).add(28, 28, 28).add(
						installButton).add(18, 18, 18).add(deleteButton).add(30, 30, 30)
		...
		buttonPanelLayout.setVerticalGroup(buttonPanelLayout.createParallelGroup(
				...
				buttonPanelLayout.createParallelGroup(
						org.jdesktop.layout.GroupLayout.BASELINE).add(closeButton).add(
						deleteButton).add(installButton).add(changeSiteButton)));
						...
						layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
								.add(
										layout.createSequentialGroup().add(splitPane,
												org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 659,
												Short.MAX_VALUE).add(38, 38, 38)).add(
										org.jdesktop.layout.GroupLayout.TRAILING,
										layout.createSequentialGroup().add(buttonPanel,
												org.jdesktop.layout.GroupLayout.PREFERRED_SIZE,
												org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
												org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
												.addContainerGap()).add(
										org.jdesktop.layout.GroupLayout.TRAILING,
										layout.createSequentialGroup().add(labelPane,
												org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
												org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
												Short.MAX_VALUE).add(151, 151, 151)))));
		layout.setVerticalGroup(layout.createParallelGroup(
				org.jdesktop.layout.GroupLayout.LEADING).add(
				layout.createSequentialGroup().add(28, 28, 28).add(labelPane,
						org.jdesktop.layout.GroupLayout.PREFERRED_SIZE,
						org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
						org.jdesktop.layout.GroupLayout.PREFERRED_SIZE).add(9, 9, 9).add(
						splitPane, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 398,
						Short.MAX_VALUE).add(10, 10, 10).add(buttonPanel,
						org.jdesktop.layout.GroupLayout.PREFERRED_SIZE,
						org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
