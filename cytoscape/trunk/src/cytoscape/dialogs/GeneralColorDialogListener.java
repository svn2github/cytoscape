...
public class GeneralColorDialogListener implements ActionListener {
	...
	/**
	 * Creates a new GeneralColorDialogListener object.
	 *
	 * @param component  DOCUMENT ME!
	 * @param writeToThisColor  DOCUMENT ME!
	 * @param title  DOCUMENT ME!
	 */
	public GeneralColorDialogListener(Component component, MutableColor writeToThisColor,
	                                  String title) {
		super();
	 ...
	 */
	public void popup() {
		Color tempColor = JColorChooser.showDialog(component, title, returnColor.getColor());
