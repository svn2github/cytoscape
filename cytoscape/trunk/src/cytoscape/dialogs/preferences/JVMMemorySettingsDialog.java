 ...
 *
 */
public class JVMMemorySettingsDialog extends JDialog implements ActionListener, ListSelectionListener,
                                                       ItemListener {
	...
	/**
	 * Creates new JVMMemorySettingsDialog
	 *
	 * @throws IOException
	 * @throws JAXBException
	 */
	public JVMMemorySettingsDialog(JFrame pParent) throws JAXBException, IOException {
		super(pParent, true);
	...
	/**
	 * Creates new JVMMemorySettingsDialog, set the selection on the given category
	 *
	 * @throws IOException
	 * @throws JAXBException
	 */
	public JVMMemorySettingsDialog(JFrame pParent, String pCategoryName) throws JAXBException, IOException {
		this(pParent);
...
*/
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (_actionObject instanceof JButton) {
			...
			if (_btn == btnOK) {
				...
				EditJVMMemorySettingsDialog theNewDialog = new EditJVMMemorySettingsDialog(this, true, theBookmarks,
				...
				EditJVMMemorySettingsDialog theEditDialog = new EditJVMMemorySettingsDialog(this, true, theBookmarks,
	...
	public class EditJVMMemorySettingsDialog extends JDialog implements ActionListener {
		private String name;
		...
		/** Creates new form NewJVMMemorySettingsDialog */
		public EditJVMMemorySettingsDialog(JDialog parent, boolean modal, Bookmarks pBookmarks,
	...
	public static void main(String[] args) {
		JDialog theDialog = new JVMMemorySettingsDialog();
	...
	// for test only
	/**
	 * Creates a new JVMMemorySettingsDialog object.
	 */
	public JVMMemorySettingsDialog() {
		this.setTitle("Bookmark manager");
