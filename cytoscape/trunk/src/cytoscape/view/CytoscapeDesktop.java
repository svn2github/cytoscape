...
public class CytoscapeDesktop extends JFrame
    ...
    protected void initialize() {
        ...
        this.getSwingPropertyChangeSupport()
            .addPropertyChangeListener(networkViewManager);
        ...
        this.getSwingPropertyChangeSupport()
            .addPropertyChangeListener(networkPanel);
        networkPanel.getSwingPropertyChangeSupport()
                    .addPropertyChangeListener(this);
    ...
    public void setupVizMapper() {
        ...
        // vertical ToolBars.
        JComboBox styleBox = vizMapUI.getStyleSelector()
                                     .getToolbarComboBox();
        Dimension newSize = new Dimension(150,
                (int) styleBox.getPreferredSize().getHeight());
    ...
    protected void updateFocus(String network_id) {
        ...
        if (old_view != null) {
            ...
            old_view.putClientData(
                VIZMAP_ENABLED,
                new Boolean(old_view.getVisualMapperEnabled()));
        }
    ...
    public void setFocus(String network_id) {
        pcs.firePropertyChange(
            new PropertyChangeEvent(this, NETWORK_VIEW_FOCUSED, null, network_id));
        pcs.firePropertyChange(
            new PropertyChangeEvent(this, NETWORK_VIEW_FOCUS, null, network_id));
    }
    ...
    public void propertyChange(PropertyChangeEvent e) {
        if (e.getPropertyName() == NETWORK_VIEW_CREATED) {
            ...
            getGraphViewController()
                .addGraphView((CyNetworkView) e.getNewValue());
            // pass on the event
            pcs.firePropertyChange(e);

            networkPanel.focusNetworkNode(
                ((CyNetworkView) e.getNewValue()).getIdentifier());
            networkPanel.fireFocus(
                ((CyNetworkView) e.getNewValue()).getIdentifier());
            ...
            getGraphViewController()
                .removeGraphView((CyNetworkView) e.getNewValue());
            // pass on the event
            pcs.firePropertyChange(e);
        }
    }
