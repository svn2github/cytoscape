 ...
 * ontology (a controlled vocabulary for some subject domain, expressed 
 * as a directed acyclic graph).  For example:
 * <p>
 * <ul>
 ...
 * </ul>
 *
 * This simple assignment of two classifications to one gene becomes
 * richer when we refer to the ontology:  in the KEGG ontology, these
 * two terms belong to a tree, expressed linearly, and from the top 
 * (most general term) down  as
 * <ul>
 *   <li> metablolism -> amino acid metabolism -> valine, leucine and 
 *        isoleucine degradation
 *   <li> metabolism -> carbohydrate metabolism -> propanoate metabolism
 * <ul>
 *
 * Thus the combination of an annotation (the present class) with an
 * ontology provides a means to richly and flexibly describe an object.
 */
...
//------------------------------------------------------------------------------
/**
 *  create a new annotation for an entity (typically a gene) of the current species
 *  and with respect to the current ontology.  an entity may have more than one
 *  classification.
 *
...
//------------------------------------------------------------------------------
/**
 *  all of the ontology identifiers registered for the specified entity, as 
 ...
 *  since entities are frequently given two or more classifications, reflecting
 *  the multiple roles of many biological entities.
 */
public int size ()
{
