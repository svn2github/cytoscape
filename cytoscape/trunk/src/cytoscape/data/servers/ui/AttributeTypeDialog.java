...
public class AttributeTypeDialog extends javax.swing.JDialog {
	...
	private void initComponents(int index) {
		...
		attributeNameLabel.setText("Attribute name for Column " + (index + 1)
				+ " entry:");
		...
		dataTypePanel.setBorder(javax.swing.BorderFactory.createTitledBorder(
				null, "Attribute Data Type",
		...
		integerRadioButton.setBorder(javax.swing.BorderFactory
				.createEmptyBorder(0, 0, 0, 0));
		...
		floatingPointRadioButton.setBorder(javax.swing.BorderFactory
				.createEmptyBorder(0, 0, 0, 0));
		floatingPointRadioButton.setMargin(new java.awt.Insets(0, 0, 0, 0));
		floatingPointRadioButton
				.addActionListener(new java.awt.event.ActionListener() {
					public void actionPerformed(java.awt.event.ActionEvent evt) {
						dataTypeRadioButtonActionPerformed(evt);
					}
		...
		booleanRadioButton.setBorder(javax.swing.BorderFactory
				.createEmptyBorder(0, 0, 0, 0));
		...
		listTypeComboBox.setModel(new javax.swing.DefaultComboBoxModel(
				LIST_DATA_TYPES));
		...
		listDelimiterRadioButton.setBorder(javax.swing.BorderFactory
				.createEmptyBorder(0, 0, 0, 0));
		listDelimiterRadioButton.setMargin(new java.awt.Insets(0, 0, 0, 0));
		listDelimiterRadioButton
				.addActionListener(new java.awt.event.ActionListener() {
					public void actionPerformed(java.awt.event.ActionEvent evt) {
		...
		org.jdesktop.layout.GroupLayout dataTypePanelLayout = new org.jdesktop.layout.GroupLayout(
				dataTypePanel);
		dataTypePanel.setLayout(dataTypePanelLayout);

		dataTypePanelLayout
				.setHorizontalGroup(dataTypePanelLayout
						.createParallelGroup(
																														...
																														.add(
																																dataTypePanelLayout
																																		...
																																		.addPreferredGap(
																																				org.jdesktop.layout.LayoutStyle.RELATED)
																																		.add(
																																				listDelimiterComboBox,
																																				0,
																																				194,
																																				Short.MAX_VALUE)))))))
										.addContainerGap()));
		dataTypePanelLayout
				.setVerticalGroup(dataTypePanelLayout
						.createParallelGroup(
								org.jdesktop.layout.GroupLayout.LEADING)
						.add(
								dataTypePanelLayout
	...
	private void dataTypeRadioButtonActionPerformed(
	...
	private void setButtonGroup() {
		...
		if (dataType == CyAttributes.TYPE_STRING) {
			delimiterButtonGroup
					.setSelected(stringRadioButton.getModel(), true);
		} else if (dataType == CyAttributes.TYPE_INTEGER) {
			delimiterButtonGroup.setSelected(integerRadioButton.getModel(),
					true);
		} else if (dataType == CyAttributes.TYPE_FLOATING) {
			delimiterButtonGroup.setSelected(floatingPointRadioButton
					.getModel(), true);
		} else if (dataType == CyAttributes.TYPE_BOOLEAN) {
			delimiterButtonGroup.setSelected(booleanRadioButton.getModel(),
					true);
	...
	public byte getType() {
		if (delimiterButtonGroup.getSelection().equals(
				stringRadioButton.getModel())) {
			return CyAttributes.TYPE_STRING;
		} else if (delimiterButtonGroup.getSelection().equals(
				integerRadioButton.getModel())) {
			return CyAttributes.TYPE_INTEGER;
		} else if (delimiterButtonGroup.getSelection().equals(
				floatingPointRadioButton.getModel())) {
			return CyAttributes.TYPE_FLOATING;
		} else if (delimiterButtonGroup.getSelection().equals(
				booleanRadioButton.getModel())) {
			return CyAttributes.TYPE_BOOLEAN;
		} else if (delimiterButtonGroup.getSelection().equals(
				listRadioButton.getModel())) {
