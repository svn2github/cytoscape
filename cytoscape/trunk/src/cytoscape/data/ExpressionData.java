...
public class ExpressionData implements Serializable {
    ...
    /**
     * Constructor.
     * Creates an empty Expression Data object with no data.
     */
    ...
    /**
     * Constructor.
     * Loads the specified filename into memory.
     *
    ...
    /**
     * Constructor.
     * Loads the specified file into memory, and reports its progress to
     * the specified TaskMonitor Object.  This option is useful for displaying
     * a progress bar to the end-user, while expression data is being parsed.
     *
     * @param filename    Name of Expression Data File.
     ...
     *
     * @return File String, as it was originally passed to the constructor,
     *         or null, if no filename is available.
     */
     ...
     * This File object can be queried for a full path to the file, etc.
     *
     * @return File Object.
     */
    ...
    static public double getPvalueFromLambda(double lambda) {
        ...
        if (erfc < 0 || erfc > 1) {
            ...
            throw new IllegalStateException
                    ("The calculated pvalue for lambda = "
                    + lambda + " is " + erfc);
        }
        return erfc;
    }//getPvalueFromLambda
     ...
     * This clobbers the old list of gene names, if it exists.
     *
     ...
     * This clobbers the old list of gene descriptors, if it exists.
     *
     ...
     * Same as getGeneNamesVector(), except this method returns an Array
     * of String Objects.
     *
    ...
    /**
     * Gets a List of All Gene Names.
     * Same as getGeneNames(), except this method returns a Vector of String
     * Objects.
     *
     * @return Vector of String Objects.
     */
     ...
     * This corresponds to the number of condition columns in the original
     ...
     * This corresponds to the number of rows of data in the original expression
     * data file.
     *
     ...
     * The matrix is set to the following:
     * <PRE>
     * maxVals[0][0] = minExp;
     * maxVals[0][1] = maxExp;
     * maxVals[1][0] = minSig;
     ...
     *
     * @param gene      Gene Name.
     * @param condition Condition Name (corresponds to column heading in
     *                  original expression data file.)
