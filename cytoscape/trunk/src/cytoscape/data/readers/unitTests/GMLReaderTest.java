...
{ 
  ...
  assertTrue ("node count, expect 11, got " + network.getNodeCount (), network.getNodeCount () == 11);
  assertTrue ("edge count, expect 10, got " + network.getEdgeCount (), network.getEdgeCount () == 10);
...
{ 
  ...
  assertTrue ("node count, expect 336, got " + network.getNodeCount (), network.getNodeCount () == 336);
  assertTrue ("edge count, expect 365, got " + network.getEdgeCount (), network.getEdgeCount () == 365);
