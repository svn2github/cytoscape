...
public class Semantics {
     ...
     * the bioDataServer.
     *
     * Currently, this method simply delegates to assignCommonNames. At some point
     ...
     */
    public static void applyNamingServices(CyNetwork network, BioDataServer bioDataServer) {
        assignCommonNames(network, bioDataServer);
    }
