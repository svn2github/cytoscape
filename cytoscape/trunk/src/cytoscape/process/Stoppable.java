...
/**
 * Represents a [lengthy] process that can be stopped.
 **/
public interface Stoppable
{

  /**
   * Guarantees that the process is stopped by the time this method returns.
   ...
   * The difference between <code>Task.halt()</code> and
