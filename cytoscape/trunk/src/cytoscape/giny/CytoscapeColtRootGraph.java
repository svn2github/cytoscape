...
public class CytoscapeColtRootGraph  extends ColtRootGraph implements  CytoscapeRootGraph {
   ...
   */
  public CytoscapeColtRootGraph ( int node_capacity, int edge_capacity ) {
