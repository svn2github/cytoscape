//
// WeightedLayouter.java
//
// organic layouter plush weighting
//
// dramage : 2002.1.22
//
...
public class WeightedLayouter implements Layouter {
    ...
    public WeightedLayouter(float width, float height) {
	iTWidth = width;
	iTHeight = height;
    }
