...
public class CyAttributesUtilsTest extends TestCase {
    ...
    protected void setUp() {
        ...
        testEdge    = Cytoscape.getCyEdge(testNode1.getIdentifier(),
                                          "Interaction Value",
                                          testNode2.getIdentifier(),
    ...
    public void testTraverseAttributeValues() {
        ...
        CyAttributesUtils.traverseAttributeValues(testNode1.getIdentifier(),
                                                  "BooleanTest",
    ...
    public void testCopyAttributes() {
        ...
        CyAttributesUtils.copyAttributes(testNode1.getIdentifier(),
                                         copyTestNode1.getIdentifier(),
                                         attrs,
                                         false);
        ...
        CyAttributesUtils.copyAttributes(testNode1.getIdentifier(),
                                         "copyAnotherTestNode1",
                                         attrs,
                                         new AttributeFilter() {
                public boolean includeAttribute(CyAttributes attrs,
                                                String objID, String attrName) {
    ...
    public void testCopyAttribute() {
        ...
        CyEdge       testEdgeCopy = Cytoscape.getCyEdge(testNode1.getIdentifier(),
                                                        "Interaction Value",
                                                        testNode3.getIdentifier(),
                                                        Semantics.INTERACTION);
        CyAttributes attrs        = Cytoscape.getEdgeAttributes();
        // only copy ListTest attribute:
        CyAttributesUtils.copyAttribute(testEdge.getIdentifier(),
                                        testEdgeCopy.getIdentifier(),
                                        "ListTest",
                                        attrs,
                                        false);

        List<String> listVal = attrs.getListAttribute(testEdgeCopy.getIdentifier(),
                                                      "ListTest");
        Assert.assertTrue((listVal.size() == 2) &&
                          listVal.contains("list test value1") &&
                          listVal.contains("list test value2"));

        List<String> attrNames = CyAttributesUtils.getAttributeNamesForObj(testEdgeCopy.getIdentifier(),
                                                                           attrs);
    ...
    private void addComplexAttributes(GraphObject go, CyAttributes attrs) {
        ...
        if (mmapDef.getAttributeValueType("p-valuesTest") < 0) {
            mmapDef.defineAttribute("p-valuesTest",
        ...
        if (mmapDef.getAttributeValueType("TextSourceInfo") < 0) {
            mmapDef.defineAttribute("TextSourceInfo",
                                    // most specific values:
            MultiHashMapDefinition.TYPE_STRING,
                                    new byte[] {
                                        MultiHashMapDefinition.TYPE_STRING,
    ...
    private void testAttributes(GraphObject go) {
        ...
        Assert.assertTrue(Boolean.TRUE.equals(attrs.getBooleanAttribute(goID,
                                                                        "BooleanTest")));

        Assert.assertTrue("string test value".equals(attrs.getStringAttribute(goID,
                                                                              "StringTest")));
        Assert.assertTrue(new Integer(6).equals(attrs.getIntegerAttribute(goID,
                                                                          "IntegerTest")));
        Assert.assertTrue(new Double(5.0).equals(attrs.getDoubleAttribute(goID,
                                                                          "DoubleTest")));
        ...
        Assert.assertTrue((mapVal.size() == 2) &&
    ...
    private void testComplexAttributes(String goID, CyAttributes attrs) {
        ...
        Assert.assertTrue("url1: publication 1".equals(mmap.getAttributeValue(
                                                                              goID,
                                                                              "TextSourceInfo",
                                                                              new Object[] {
                                                                                  "url1",
        ...
        Assert.assertTrue("url2: publication 1".equals(mmap.getAttributeValue(
                                                                              goID,
                                                                              "TextSourceInfo",
                                                                              new Object[] {
                                                                                  "url2",
