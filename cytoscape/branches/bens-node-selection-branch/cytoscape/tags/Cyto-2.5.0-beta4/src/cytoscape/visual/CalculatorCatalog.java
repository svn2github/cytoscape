...
public class CalculatorCatalog {
    ...
    protected List getListenerList(final VisualPropertyType type)
        throws IllegalArgumentException {
    ...
    protected void fireStateChanged(final VisualPropertyType type)
        throws IllegalArgumentException {
    ...
    protected Map<String, Calculator> getCalculatorMap(
    ...
    public String checkCalculatorName(String calcName, byte calcType) {
        return checkCalculatorName(
            calcName,
            VisualPropertyType.getVisualPorpertyType(calcType));
    }
    ...
    public Collection<Calculator> getCalculators() {
        final List<Calculator> l = new ArrayList<Calculator>();

        for (VisualPropertyType type : calculators.keySet())
            for (String s : calculators.get(type)
                                       .keySet())
                l.add(calculators.get(type).get(s));
