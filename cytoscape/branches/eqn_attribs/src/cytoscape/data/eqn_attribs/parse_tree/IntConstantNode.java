 ...
 */
public class IntConstantNode implements Node {
	private final long value;

	public IntConstantNode(final long value) { this.value = value; }

	public String toString() { return "IntConstantNode: " + value; }
