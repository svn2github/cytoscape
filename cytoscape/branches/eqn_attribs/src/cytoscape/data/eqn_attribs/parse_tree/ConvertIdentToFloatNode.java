/*
  File: ConvertIdentToFloatNode.java
 ...
 */
public class ConvertIdentToFloatNode implements Node {
	private final IdentNode convertee;

	public ConvertIdentToFloatNode(final IdentNode convertee) {
		this.convertee = convertee;
	}

	public String toString() { return "ConvertIdentToFloatNode: " + convertee; }
