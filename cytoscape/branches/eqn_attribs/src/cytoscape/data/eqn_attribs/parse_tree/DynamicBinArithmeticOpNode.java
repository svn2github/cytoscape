/*
  File: DynamicBinArithmeticOpNode.java
...
/**
 *  A node in the parse tree representing a binary arithmetic operator w/ both having dynamic type.
 */
public class DynamicBinArithmeticOpNode implements Node {
	private final AttribToken operator;
	private final Node lhs, rhs;

	public DynamicBinArithmeticOpNode(final AttribToken operator, final Node lhs, final Node rhs) {
		if (lhs == null)
	...
	public String toString() { return "DynamicBinArithmeticOpNode: " + operator + " (" + lhs + ", " + rhs + ")"; }
