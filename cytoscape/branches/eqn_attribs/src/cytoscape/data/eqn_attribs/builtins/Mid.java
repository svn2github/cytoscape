...
public class Mid implements AttribFunction {
	/**
	 ...
	 */
	public String getHelpDescription() { return "Attempts to emulate the Excel™ MID function.\nCall this with \"MID(text, start, count)\""; }
