...
public class Right implements AttribFunction {
	/**
	 ...
	 */
	public String getHelpDescription() { return "Attempts to emulate the Excel™ RIGHT function.\nCall this with \"RIGHT(text, count)\""; }

	/**
	 *  @returns String.class or null if the args passed in have the wrong arity or a type mismatch was found
	 */
	public Class validateArgTypes(final Class[] argTypes) {
		if (argTypes.length != 2 || argTypes[1] != Double.class)
			return null;
	...
	public Object evaluateFunction(final Object[] args) throws IllegalArgumentException, ArithmeticException {
		...
		final int count = (int)Math.round((Double)args[1] - 0.5);

		if (count < 0)
			throw new IllegalArgumentException("illegal character count in call to RIGHT()!");
