...
public class StDev implements AttribFunction {
	 ...
	 */
	public String getUsageDescription() { return "Call this with \"STDEV(list)\""; }
		...
		for (final Object listElement : list) {
			try {
				...
				throw new IllegalArgumentException(AttribFunctionUtil.getOrdinal(i) +
				                                   " list element in call to STDEV() is not a number: "
				                                   + e.getMessage());
			}
		}

		return Math.sqrt(AttribFunctionUtil.calcSampleVariance(x));
	}
