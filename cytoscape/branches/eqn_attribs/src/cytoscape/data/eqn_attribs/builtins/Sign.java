...
public class Sign implements AttribFunction {
	...
	/**
	 *  @returns Double.class or null if there is not exactly 1 arg or the arg is not of type Double, Long, Boolean or String
	 */
	 ...
	 *  @returns the result of the function evaluation which is the signum of the first argument
	 */
