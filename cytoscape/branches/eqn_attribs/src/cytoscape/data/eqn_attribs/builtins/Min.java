...
public class Min implements AttribFunction {
	/**
			...
			for (final Object listEntry : list) {
				...
				if (listEntryType == Double.class)
					...
					try {
						...
						throw new IllegalArgumentException("can't convert a list element to a number while evaluating a call to MIN()!");
					}
				}
				else
					throw new IllegalArgumentException("can't convert a list element to a number while evaluating a call to MIN()!");
			...
			for (final Object arg : args) {
				...
				if (arg.getClass() == Double.class)
					...
					try {
						...
						throw new IllegalArgumentException("can't convert an argument of MIN() to a number!");
					}
				}
				else
					throw new IllegalArgumentException("can't convert an argument of MIN() to a number!");
