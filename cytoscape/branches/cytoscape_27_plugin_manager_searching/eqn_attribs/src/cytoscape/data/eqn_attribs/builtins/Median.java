...
public class Median implements AttribFunction {
	/**
	 ...
	 */
	public String getHelpDescription() { return "Call this with \"MEDIAN(list)\" or \"MEDIAN(arg1,arg2,...,argN)\""; }
	 ...
	 *  @returns the result of the function evaluation which is the median of the elements in the single list argument or the median of the one or more double arguments
