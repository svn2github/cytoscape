// EdgeViz.java: data associated with edges controls their visual attributes
//---------------------------------------------------------------------------------------
// $Revision$
// $Date$
// $Author$
 ...
 * </ul>
 */
public class EdgeViz extends VizMapper {
  ...
  public static final Integer DISCRETE = new Integer (6);
  public static final Integer CONTINUOUS = new Integer (7);
...
{
  attributeControllers.put (attribute, 
                            new DomainInfo (controller, dataClass, 
                                            ...
                                            Double max, Object maxObject)
{
  if (attribute.equals (COLOR)) {
    ...
    System.err.println ("EdgeViz.setContinuousAttributeControls error:  no support yet for ");
...
{
  String controllingAttribute = getAttributeController (EdgeViz.COLOR);
  ...
  for (int i=0; i < attributeNames.length; i++) {
    ...
    if (controllingAttribute.equals (attribute))
      return calculateColor (edgeBundle.get (attribute), EdgeViz.COLOR, colorMap, 
                             defaultEdgeColor);
    } // for i
...
public String getSourceDecoration (HashMap edgeBundle)
{
  ...
  if (domainInfo.continuousData) {
    System.err.print   ("EdgeViz.getSourceDecoration error:  no support yet for ");
...
public String getTargetDecoration (HashMap edgeBundle)
{
  ...
  if (domainInfo.continuousData) {
    System.err.print   ("EdgeViz.getTargetDecoration error:  no support yet for ");
