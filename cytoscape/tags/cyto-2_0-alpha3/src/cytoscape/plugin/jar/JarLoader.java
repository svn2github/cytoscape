...
public class JarLoader {
  ...
  private static SimpleClassLoader loader; // the loader instance
...
//     }
    ...
    // Cytoscape Plugin stuff
    int totalEntries=0;
    int totalClasses=0;
    int totalPlugins=0;
    Enumeration entries = classList.elements();
    try {
      while ( entries.hasMoreElements() ) {
        ...
        //System.out.print( "lookign at: "+entry_s );
   ...
   /**
            ...
            throws ClassNotFoundException
    {
      ...
      Class c = Class.forName( name, false, getLoader() );
