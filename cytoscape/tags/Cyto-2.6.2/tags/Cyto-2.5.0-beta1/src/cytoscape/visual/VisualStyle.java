...
public class VisualStyle
    ...
    public Vector checkConflictingCalculator(Calculator c) {
        ...
        for (Calculator nodeCalcs : nodeAC.getCalculators()) {
            if (nodeCalcs == c)
                conflicts.add(
                    nodeCalcs.getVisualPropertyType().getPropertyLabel());
        }

        for (Calculator edgeCalcs : edgeAC.getCalculators()) {
            if (edgeCalcs == c)
                conflicts.add(
                    edgeCalcs.getVisualPropertyType().getPropertyLabel());
        }
    ...
    public VisualStyle(VisualStyle toCopy) {
        ...
        setGlobalAppearanceCalculator(
            new GlobalAppearanceCalculator(
                toCopy.getGlobalAppearanceCalculator()));
    }
     ...
     */
    public NodeAppearanceCalculator setNodeAppearanceCalculator(
     ...
     */
    public EdgeAppearanceCalculator setEdgeAppearanceCalculator(
     ...
     */
    public GlobalAppearanceCalculator setGlobalAppearanceCalculator(
