// loadBiologicalProcesses.java:  load a hash of vectors 
...
//------------------------------------------------------------------------------
public class loadBiologicalProcesses {
//------------------------------------------------------------------------------
public static void main (String [] args) throws Exception
{
  ...
  if (args.length != 1) {
    System.out.println ("usage:  loadBiologicalProcesses <someFile.txt>");
    System.exit (1);
    }
  ...
  server.addBiologicalProcesses (hash);

} // main
//------------------------------------------------------------------------------
} // loadBiologicalProcesses
