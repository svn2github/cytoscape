...
$(function(){
	...
	GRAPH_STYLES["Circles"] = {
			...
			edges: {
				...
				mergeTooltipText: "<b>weight:</b> ${sum:weight}",
	...
	GRAPH_STYLES["Rectangles"] = {
			...
			edges: {
				color: "#374A70",
				mergeColor: "#ffffff",
				mergeOpacity: { defaultValue: 0.2, continuousMapper: { attrName: "sum:weight", minValue: 0.2, maxValue: 1 } },
				width: 3,
				mergeWidth: 4,
	...
	GRAPH_STYLES["Shapes"] = {
			...
			edges: {
				...
				color: "#aaaaff",
				mergeWidth: { defaultValue: 2, continuousMapper: { attrName: "sum:weight", minValue: 2, maxValue: 8 } },
				mergeColor: { defaultValue: "#0000ff", continuousMapper: { attrName: "sum:weight", minValue: "#0000ff", maxValue: "#00ff00" } },
				mergeOpacity: 0.6,
