...
It should have at least the <code>id</code> property.";
                        ...
                        $field->name = "height";
						$field->description = "The absolute node height (in pixels), when the zoom level is 100%.
...
this value by the current network scale, which is provided by {@link org.cytoscapeweb.Visualization#zoom}.";
                        ...
                        $field->name = "nodesCount";
						$field->description = "The number of child nodes.";
                        ...
                        $field->name = "size";
						$field->description = "The absolute node size (in pixels), when the zoom level is 100%. It is the highest value of height and width.
...
If you set the size to <code>\"auto\"</code>, the node will be automatically resized to enclose its label text.";
                        ...
                        $field->name = "width";
						$field->description = "The absolute node width (in pixels), when the zoom level is 100%.
...
If <code>y == 0</code>, the middle point of the node is located exactly at the top border of the network view.";
                        ...
                        $field->name = "zIndex";
						$field->description = "The stacking order of the element.";
