...
vis.addDataField(\"nodes\", field);";
                                     ...
                                     Cytoscape Web will try to add the new field to both nodes and edges data schema.";
								        ...
								        $param->name = "dataField";
								            ...
								            $param->type = "org.cytoscapeweb.DataField";
							        ...
							        */
								    ...
								    /*
							        $see = preg_split("/(\s)+/", "org.cytoscapeweb.Visualization#dataSchema");
							        foreach($see as $tag){
							            $fn->tags[] = $tag;
							            $cls_info->function_tags[] = $tag;
							        }
...
var edge = vis.addEdge(data, true);";
							        ...
							        */
								    ...
								    $fn->see[] = "org.cytoscapeweb.Visualization#addElements";
								    
								    /*
							        $see = preg_split("/(\s)+/", "org.cytoscapeweb.Visualization#addElements");
							        foreach($see as $tag){
							            $fn->tags[] = $tag;
							            $cls_info->function_tags[] = $tag;
							        }
				     ...
				     $fn->description = "<p>Add new nodes and/or edges to the network.</p>
...
The node positions (x, y), if specified, are respected, though.</p>"; 
					     ...
					     $fn->examples[] = "// 1. Add two nodes with no data (IDs will be created automatically):
...
var elements = vis.addElements(array, true);";
								        ...
								        $param->description = "The nodes and edges to be added to the network.
                       The array must contain {@link org.cytoscapeweb.Node} and/or {@link org.cytoscapeweb.Edge} objects.";
							        ...
							        $ret->description = "The new created elements ({@link org.cytoscapeweb.Node} and {@link org.cytoscapeweb.Edge} objects).";
...
add more than one element at once.</p>"; 
					     ...
					     $fn->examples[] = "// 1. Add a new node to the network (here we assume that the data fields for
...
var node2 = vis.addNode(node1.x, node1.y, { parent: \"n4\" }, true);";
				     ...
				     $fn->description = "<p>Get all nodes that belong to a compound node.</p>"; 
								        ...
								        $param->description = "The parent node object or the parent ID (String).";
							        ...
							        $ret->description = "List of {@link org.cytoscapeweb.Node} objects.";
							        ...
							        */
								    ...
								    $fn->see[] = "org.cytoscapeweb.Visualization#parentNodes";
								    
								    /*
							        $see = preg_split("/(\s)+/", "org.cytoscapeweb.Visualization#parentNodes");
							        foreach($see as $tag){
							            $fn->tags[] = $tag;
							            $cls_info->function_tags[] = $tag;
							        }
                        ...
                        $fn = new func();
                        $fn->name = "customCursorsEnabled";
                    

					
						
				     $fn->description = "<p>If the boolean argument is passed in, it enables or disables custom mouse cursors, such as the hand icon used when panning the network.</p>
<p>If no argument is passed in, it returns a boolean value indicating whether or not custom cursors are enabled.</p>"; 
								        ...
								        $param->description = "If <code>true</code>, custom (Flash) cursors can be used in some actions.
                           If <code>false</code>, Cytoscape Web will never replace the operating system's cursors.";
							        ...
							        $ret->description = "<ul><li>A boolean value for <code>customCursorsEnabled()</code>.</li>
            <li>The {@link org.cytoscapeweb.Visualization} object for <code>panEnabled({Boolean})</code>.</li></ul>";
                        ...
                        $fn->name = "dataSchema";
					     ...
					     $fn->type = "org.cytoscapeweb.DataSchema"; 
					
						
				     $fn->description = "<p>Get the network data schema, which contains all the nodes and edges data fields.</p>"; 
						
					
					
					
					     $fn->examples[] = "var schema = vis.dataSchema();
...
var edgeFields = schema.edges;";
							        ...
							        $ret = new param();
							            ...
							            $ret->type = "org.cytoscapeweb.DataSchema";
							        
							        
							        $ret->description = "The data schema object.";
...
?&gt;";
								        ...
								        $param->description = "One of: <code>\"png\"</code>, <code>\"svg\"</code>, <code>\"pdf\"</code>, <code>\"xgmml\"</code>, <code>\"graphml\"</code>, <code>\"sif\"</code>.";
                             ...
                             <ul class=\"options\">
                                 ...
                                 <li><code>window</code>:</strong> The browser window or HTML frame in which to display the exported image or xml.
							        ...
							        */
								    ...
								    $fn->see[] = "org.cytoscapeweb.Visualization#svg";
								    
								    /*
							        $see = preg_split("/(\s)+/", "org.cytoscapeweb.Visualization#svg");
							        foreach($see as $tag){
							            $fn->tags[] = $tag;
							            $cls_info->function_tags[] = $tag;
							        }
				     ...
				     $fn->description = "<p>Filter nodes or edges. The filtered out elements will be hidden.</p>"; 
					     ...
					     $fn->examples[] = "// 1. Hide all edges that have a weight that is lower than 0.4:
...
vis.filter();";
                                      ...
                                      If <code>null</code>, filter both nodes and edges.";
								        ...
								        $param->description = "A filter function or an array of elements to be filtered.
        ...
        <ul class=\"options\"><li><code>rootNodes</code> {Array}: the node objects that were passed as the function parameter.</li>
            ...
            <li><code>mergedEdges</code> {Array}: the merged edge objects that connect the returned nodes.</li></ul>.";
				     ...
				     $fn->description = "<p>Return the network data as <a href=\"http://graphml.graphdrawing.org/primer/graphml-primer.html\" rel=\"external\">GraphML</a>.</p>"; 
							        ...
							        */
								    ...
								    /*
							        $see = preg_split("/(\s)+/", "org.cytoscapeweb.Visualization#networkModel");
							        foreach($see as $tag){
							            $fn->tags[] = $tag;
							            $cls_info->function_tags[] = $tag;
							        }
...
vis.layout({ name: 'ForceDirected', options: options });";
            ...
            <li>The {@link org.cytoscapeweb.Visualization} object for <code>layout({Object})</code>.</li></ul>";
				     ...
				     $fn->description = "<p>Get all merged edges from the network.</p>"; 
                        ...
                        $fn = new func();
                        $fn->name = "networkModel";
                    

					
					     $fn->type = "org.cytoscapeweb.NetworkModel"; 
					
						
				     $fn->description = "<p>Return the network model as an object.</p>"; 
							        ...
							        $ret = new param();
							            ...
							            $ret->type = "org.cytoscapeweb.NetworkModel";
							        
							        
							        $ret->description = "The network model as a JavaScript object.";
...
In order to retrieve the children of a compound node, simply pass the parent node object or its <code>id</code>.</p>"; 
								        ...
								        $param->description = "It is optional and the default value is <code>false</code>, which means that all existing nodes
							        ...
							        */
								    ...
								    $fn->see[] = "org.cytoscapeweb.Visualization#childNodes";
								    
								    /*
							        $see = preg_split("/(\s)+/", "org.cytoscapeweb.Visualization#childNodes");
							        foreach($see as $tag){
							            $fn->tags[] = $tag;
							            $cls_info->function_tags[] = $tag;
							        }
...
<p>If not, it just returns a boolean value indicating whether or not the control is visible.</p>"; 
            ...
            <li>The {@link org.cytoscapeweb.Visualization} object for <code>panZoomControlVisible({Boolean})</code>.</li></ul>";
				     ...
				     $fn->description = "<p>Get only the compound nodes from the network, if there is any.</p>"; 
							        ...
							        $ret->description = "List of {@link org.cytoscapeweb.Node} objects that contain one or more child nodes.";
...
vis.select();";
                ...
                the returned array may contain both nodes and edges.";
				     ...
				     $fn->description = "<p>Return the network data as <a href=\"http://cytoscape.wodaklab.org/wiki/Cytoscape_User_Manual/Network_Formats/\" rel=\"external\">Simple Interaction Format (SIF)</a>.</p>
...
vis.draw({ network: xml });";
								        ...
								        $param->description = "Non-mandatory settings:
                          <ul class=\"options\">
				     ...
				     $fn->description = "<p>Return an SVG image.</p>"; 
...
vis.visualStyleBypass(null);";
            ...
            <li>The {@link org.cytoscapeweb.Visualization} instance for <code>visualStyleBypass({Object})</code>.</li></ul>";
				     ...
				     $fn->description = "<p>Return the network data as <a href=\"http://cgi5.cs.rpi.edu/research/groups/pb/punin/public_html/XGMML/\" rel=\"external\">XGMML</a>.</p>"; 
