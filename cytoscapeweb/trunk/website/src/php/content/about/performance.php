...
<div class="left">
	...
	<table id="performance_table" cellspacing="0" cellpadding="0">
		<tr>
			...
			<th>&nbsp;</th>
			<th>&nbsp;</th>
			<th colspan="5"><h2>Number of Elements</h2></th>
		</tr>
		<tr>
			<th>&nbsp;</th>
			<th>&nbsp;</th>
			<th><h2>Layouts</h2></th>
			<th title="50 nodes and 100 edges"><h3>150</h3></th>
			<th title="100 nodes and 200 edges"><h3>300</h3></th>
			<th title="200 nodes and 400 edges"><h3>600</h3></th>
			<th title="400 nodes and 800 edges"><h3>1200</h3></th>
			<th title="800 nodes and 1600 edges"><h3>2400</h3></th>
		</tr>
		<tr>
			<th rowspan="8"><h3>Mac OS X 10.6.3</h3></th>
			<th rowspan="4"><h3>Firefox 3.6.3</h3></th>
			<td>Circle</td>
			<td>0.84</td>
			<td>1.10</td>
			<td>1.36</td>
		...
		<tr>
	  	...
	  	<tr>
			<th rowspan="4"><h3>Safari 5</h3></th>
			<td>Circle</td>
			<td>0.95</td>
			<td>1.15</td>
			<td>1.41</td>
		...
		<tr>
			<th rowspan="12"><h3>Windows XP SP3</h3></th>
			<th rowspan="4"><h3>Firefox 3.6.3</h3></th>
			<td>Circle</td>
			<td>0.78</td>
			<td>1.11</td>
