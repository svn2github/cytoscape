    ...
    public class ExternalMediator extends BaseMediator {
		...
		private function addNode(x:Number, y:Number, data:Object,
			...
			try {
				...
				var ns:NodeSprite = graphProxy.addNode(data);
				...
				// node sprite
				this.graphMediator.updateCompoundNode(eventTarget, ns);
