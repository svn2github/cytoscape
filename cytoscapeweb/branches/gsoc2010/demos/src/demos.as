package {
	...
	public class demos extends Sprite
	{
		...
		public function demos()
		{
			...
			// create demos
			createDemos();
			onResize(); 	//use to initialise stage according to stage size
		...
		private function createDemos():void
		{
			...
			/* These other displays are removed as they are not essential to my demostrations.
		...
		private function showLayout():void
		{	
