...
public class CytoscapeFingRootGraph extends FingExtensibleRootGraph implements CytoscapeRootGraph {
	...
	public org.cytoscape.model.network.CyNode getNode(String identifier) {
		if (node_name_index_map.containsKey(identifier))
			return (org.cytoscape.model.network.CyNode) getNode(node_name_index_map.get(identifier));
		else
	...
	public org.cytoscape.model.network.CyEdge getEdge(String identifier) {
		if (edge_name_index_map.containsKey(identifier))
			return (org.cytoscape.model.network.CyEdge) getEdge(edge_name_index_map.get(identifier));
		else
