...
import org.cytoscape.io.attribute.reader.ExpressionData;
import org.cytoscape.io.attribute.server.BioDataServer;
import org.cytoscape.io.attribute.server.OntologyServer;
import org.cytoscape.io.network.CyAttributesReader;
...
//	private static boolean squiggleEnabled = false;
	...
	public static CyNetworkView createNetworkView(CyNetwork network, String title, CyLayoutAlgorithm layout) {
		...
		firePropertyChange(org.cytoscape.application.dialog.CytoscapeDesktop.NETWORK_VIEW_CREATED, null, view);
