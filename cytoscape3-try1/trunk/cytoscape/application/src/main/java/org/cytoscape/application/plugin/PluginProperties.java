...
public class PluginProperties extends Properties {
	...
	public PluginInfo fillPluginInfoObject(DownloadableInfo info) throws ManagerException {
		...
		for (String v: AllCytoscapeVersions) {
			...
			if (v.equals(new org.cytoscape.application.util.CytoscapeVersion().getMajorVersion())) {
		...
		if (!versionOk) {
			...
			String DescMsg = "<p><font color='red'><b>Cytoscape Version Warning:</b><br><i>This plugin has not been verified to work with Cytoscape v" + 
				new org.cytoscape.application.util.CytoscapeVersion().getFullVersion() + " .</i></font>";
