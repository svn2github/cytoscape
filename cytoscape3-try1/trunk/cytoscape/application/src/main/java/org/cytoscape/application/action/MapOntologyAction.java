...
import org.cytoscape.application.dialog.OntologyMapperDialog;
...
public class MapOntologyAction extends CytoscapeAction implements PropertyChangeListener {
	/**
	 * Creates a new MapOntologyAction object.
	 */
	...
	public void propertyChange(PropertyChangeEvent e) {
		...
		if ((e.getPropertyName().equals(Cytoscape.NETWORK_LOADED)
		    ...
		    || e.getPropertyName().equals(Cytoscape.DATASERVER_CHANGED))) {
