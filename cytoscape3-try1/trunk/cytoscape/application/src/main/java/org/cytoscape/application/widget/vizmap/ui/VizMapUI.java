...
import org.cytoscape.model.network.event.CyNetworkEvent;
import org.cytoscape.model.network.event.CyNetworkListener;
...
public class VizMapUI extends JDialog
    ...
    public VizMapUI(VisualMappingManager VMM, JFrame mainFrame) {
        ...
        this.tabPaneContainer = new JPanel(
        ...
        addTab(
            tabs,
            nodePane,
            new VizMapFontTab(this, nodePane, 6, VMM, NODE_LABEL_FONT));
        addTab(
            tabs,
            nodePane,
        ...
        addTab(
            tabs,
            edgePane,
            new VizMapFontTab(this, edgePane, 5, VMM, EDGE_LABEL_FONT));
        addTab(
            tabs,
            edgePane,
        ...
        this.attrSelectorPanel = new JPanel(
                new FlowLayout(),
                false);
    ...
    public class StyleSelector extends JDialog
        ...
        protected StyleSelector(VizMapUI styleDef, JFrame mainFrame) {
            ...
            MiscGB.insert(styleGBG, createLegend, 4, 1, 1, 1, 1, 0,
                GridBagConstraints.HORIZONTAL);
            createLegend.setToolTipText(
                "Create a figure legend for the selected visual style");
            ...
            styleGBG.panel.setToolTipText(
                "Visual styles are a collection of attribute mappings.");
            pack();
        }
        ...
        public String getStyleName(VisualStyle s) {
            ...
            while (true) {
                String ret = (String) JOptionPane.showInputDialog(myself,
                        "Name for new visual style", "Visual Style Name Input",
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (ich == JOptionPane.YES_OPTION) {
                    ...
                    if (currentStyle == null)
                        currentStyle = (VisualStyle) styles.iterator()
                                                           .next();
        ...
        public void stateChanged(ChangeEvent ce) {
            if (currentStyle != VMM.getVisualStyle()) {
                ...
                if (styleComboModel.getIndexOf(currentStyle) == -1)
    ...
    private class ApplyAction extends AbstractAction {
        public void actionPerformed(ActionEvent e) {
            VMM.getNetworkView()
               .redrawGraph(false, true);
            // Set the focus to emit a NETWORK_VIEW_FOCUS event for sync the
            // BirdsEyeView
