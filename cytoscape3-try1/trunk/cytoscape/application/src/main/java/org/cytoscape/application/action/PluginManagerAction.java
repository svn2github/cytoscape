...
import org.cytoscape.application.dialog.plugin.PluginManageDialog;
import org.cytoscape.application.dialog.plugin.PluginManageDialog.PluginInstallStatus;
import org.cytoscape.application.init.CytoscapeInit;
import org.cytoscape.application.plugin.DownloadableInfo;
import org.cytoscape.application.plugin.ManagerUtil;
import org.cytoscape.application.plugin.PluginInfo;
import org.cytoscape.application.plugin.PluginInquireAction;
import org.cytoscape.application.plugin.PluginManager;
import org.cytoscape.application.plugin.PluginStatus;
import org.cytoscape.application.util.BookmarksUtil;
...
public class PluginManagerAction extends CytoscapeAction {
	...
	public void actionPerformed(ActionEvent e) {
		...
		String DefaultUrl = org.cytoscape.application.init.CytoscapeInit.getProperties().getProperty("defaultPluginDownloadUrl");
		...
		cytoscape.task.Task task = new org.cytoscape.application.plugin.PluginManagerInquireTask(DefaultUrl, new ManagerAction(dialog, DefaultTitle, DefaultUrl));
