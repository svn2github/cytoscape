...
import org.cytoscape.io.attribute.server.BioDataServerUtil;
...
public class AnotationPanel extends javax.swing.JPanel {
	...
	public AnotationPanel() {
		...
		if (isSpecies) {
			...
			while (it.hasNext()) {
				...
				originalSpecies.put(nodeId,
				                    nodeAttributes.getStringAttribute(nodeId, Semantics.SPECIES));
			}
		}
	...
	private void initComponents() {
		...
		speciesCheckBox.setBorder(javax.swing.BorderFactory.createEmptyBorder(0, 0, 0, 0));
		...
		headerScrollPane.setBorder(javax.swing.BorderFactory.createTitledBorder("Header Preview"));
		headerScrollPane.setViewportView(headerEditorPane);
		headerEditorPane.setContentType("text/html");

		headerEditorPane.setText("<html><body>"
		...
		nodeNameList.setToolTipText("These node names will be used for mapping.");
		...
		flipCheckBox.setBorder(javax.swing.BorderFactory.createEmptyBorder(0, 0, 0, 0));
		...
		upperPanelLayout.setHorizontalGroup(upperPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
		                                                    .add(upperPanelLayout.createSequentialGroup()
		                                                                         ...
		                                                                         .add(upperPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
		                                                                                              .add(gaButton,
		                                                                                                   ...
		                                                                                                   org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
		                                                                                              .add(speciesCheckBox))));
		upperPanelLayout.setVerticalGroup(upperPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
		                                                  .add(upperPanelLayout.createSequentialGroup()
		                                                                       .add(upperPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
		                                                                                            .add(upperPanelLayout.createSequentialGroup()
		                                                                                                                 .addContainerGap()
	...
	private void flipCheckBoxActionPerformed(java.awt.event.ActionEvent evt) {
		if (flipCheckBox.isSelected() == true) {
			previewTable.setDefaultRenderer(Object.class, new PreviewTableCellRenderer(1));
			previewTable.repaint();
		} else {
			previewTable.setDefaultRenderer(Object.class, new PreviewTableCellRenderer(0));
			previewTable.repaint();
		}
	}
	...
	private void syncSpecies(boolean syncFlag) {
		...
		while (it.hasNext()) {
			...
			if (speciesName == null) {
				...
				nodeAttributes.setAttribute(nodeName, Semantics.SPECIES, speciesName);
			} else {
	...
	private void gaFileErrorHandler(boolean taxonFlag, boolean aspectFlag) {
		if (taxonFlag == true) {
			JOptionPane.showMessageDialog(this, "Some Taxonomy IDs are invalid.", "Warning",
			                              JOptionPane.INFORMATION_MESSAGE);
		}

		if (aspectFlag == true) {
			JOptionPane.showMessageDialog(this,
			                              "This file contains invalid GO Aspects.\n Aspects in OBO file will be used instead.",
	...
	private List getNodeList() {
		...
		while (it.hasNext()) {
			...
			if (isSpecies == false) {
				...
				entry = nodeName + " = "
				        + nodeAttributes.getStringAttribute(nodeName, Semantics.SPECIES);
			}
...
class PreviewTableCellRenderer extends JLabel implements TableCellRenderer {
	...
	/**
	 * Creates a new PreviewTableCellRenderer object.
	 *
