...
import org.cytoscape.application.widget.vizmap.ui.ValueDisplayer;
...
public class ValueListener
     ...
     */
    public ValueListener(ContinuousUI ui, ContinuousMapping cm, int index,
        int offset) {
        this.ui = ui;
        this.cm = cm;
        this.index = index;
