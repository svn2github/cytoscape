...
import org.cytoscape.model.attribute.Aliases;
import org.cytoscape.model.attribute.AliasType;

import org.cytoscape.io.attribute.reader.db.DBCrossReferences;
import org.cytoscape.io.attribute.reader.obo.OBOOntology;
import org.cytoscape.io.attribute.reader.ontology.OntologyFactory;
...
public class OntologyServer implements PropertyChangeListener {
	 ...
	 * Map of Ontologies.
	 */
	private HashMap<String, OBOOntology> ontologies;
	...
	public OntologyServer() throws IOException, JAXBException {
		...
		this.ontologies = new HashMap<String, OBOOntology>();
	 ...
	 */
	public HashMap<String, OBOOntology> getOntologies() {
		return ontologies;
	}

	public void addOntology(OBOOntology onto) {
	...
	public void setOntology(OBOOntology onto) {
		ontologies.put(onto.getName(), onto);
	}
