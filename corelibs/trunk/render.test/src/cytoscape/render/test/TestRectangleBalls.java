...
public final class TestRectangleBalls extends Frame implements Runnable
{
  ...
  public static void main(String[] args) throws Exception
  {
    EventQueue.invokeAndWait(new Runnable() {
        public void run() {
          Frame f = new TestRectangleBalls();
          f.show();
  ...
  private final void generateImage(double rotationTheta, double m_scale)
  {
    ...
    if (m_grafx.computeEdgeIntersection
        (GraphGraphics.SHAPE_RECTANGLE, xMin1, yMin1, xMax1, yMax1, offset,
         xCenter2, yCenter2, m_xsect1Coords) &&
        m_grafx.computeEdgeIntersection
        (GraphGraphics.SHAPE_RECTANGLE, xMin2, yMin2, xMax2, yMax2, offset,
