...
public class DNodeView
    ...
    public List getEdgeViewsList(NodeView otherNodeView) {
        synchronized (m_view.m_lock) {
            return m_view.getEdgeViewsList(
                getNode(),
    ...
    private void fixBorder() {
        if ((m_borderDash == 0.0f) && (m_borderDash2 == 0.0f))
            ...
            if ((size == m_view.m_lastSize) &&
                ...
                m_view.m_lastTexturePaint = new TexturePaint(
                        img,
    ...
    public boolean setWidth(double width) {
        synchronized (m_view.m_lock) {
            ...
            final double xCenter = (((double) m_view.m_extentsBuff[0]) +
    ...
    public double getWidth() {
        synchronized (m_view.m_lock) {
            ...
            return ((double) m_view.m_extentsBuff[2]) -
    ...
    public boolean setHeight(double height) {
        synchronized (m_view.m_lock) {
            ...
            final double yCenter = (((double) m_view.m_extentsBuff[1]) +
    ...
    public double getHeight() {
        synchronized (m_view.m_lock) {
            ...
            return ((double) m_view.m_extentsBuff[3]) -
            m_view.m_extentsBuff[1];
        }
    }
    ...
    public void setOffset(double x, double y) {
        synchronized (m_view.m_lock) {
            ...
            final double wDiv2 = (((double) m_view.m_extentsBuff[2]) -
                m_view.m_extentsBuff[0]) / 2.0d;
            final double hDiv2 = (((double) m_view.m_extentsBuff[3]) -
