...
abstract public class Abstract3DLayout  {
  ...
  protected void initializeLocation ( NodeView v, Dimension d ) {
    ...
    graphView.setNodeDoubleProperty( v.getGraphPerspectiveIndex(), GraphView.NODE_Z_POSITION , z );
   ...
   */
  public NodeView getNodeView ( double x, double y, double z ) {
    ...
    for ( Iterator iter = graphView.getNodeViewsIterator();
      ...
      double dz = graphView.getNodeDoubleProperty( v.getGraphPerspectiveIndex(), GraphView.NODE_Z_POSITION ) - y;
  ...
  /**
	 ...
	 */
    public void forceMove ( NodeView picked, double x, double y, double z) {
