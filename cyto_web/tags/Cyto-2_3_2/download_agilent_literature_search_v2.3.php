...
<?php
	...
	$file = $_REQUEST["file"];
	if ($file == "litsearch_v2.3") {
		$title = "Download Agilent Literature Search Version 2.3";
...
<div id="indent">
		<p>
                ...
                with <a href="http://www.cytoscape.org/index.php">Cytoscape</a> v2.3, which provides a 
...
representative of each party. 
			...
			<form action="download_agilent_literature_search_v2.3.php" method="POST">
