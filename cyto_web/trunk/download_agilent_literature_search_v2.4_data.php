...
<?php
	...
	$file = $_REQUEST["file"];
	if ($file == "litsearch_v2.4") {
		$title = "Download Data and Configuration Files for Agilent Literature Search Version 2.4";
...
<div id="indent">
		<p>
                <p>Welcome to the data download page for Agilent Laboratories' Agilent 
            ...
            <p> From this page you can separately load data files associated with the software, such as 
                lexicons and configuration files.
                <p>Agilent Literature Search Software can be used in conjunction 
                with <a href="http://www.cytoscape.org/index.php">Cytoscape</a> v2.4, which provides a 
                ...
                terms of the <b>Agilent License Agreement below</b> . To obtain this ddata for Agilent Literature Search Software plugin, you must: </p>
...
representative of each party. 
			...
			<form action="download_litsearch_v2.4_data.php" method="POST">
