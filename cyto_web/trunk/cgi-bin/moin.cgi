...
sys.path.insert(0, '/usr/local/www/virtual3/66/175/24/126/moin/share/moin/cytoscapewiki')

# Path to MoinMoin package, needed if you installed with --prefix=PREFIX
# or if you did not use setup.py.
sys.path.insert(0, '/usr/local/www/virtual3/66/175/24/126/moin/lib/python2.4/site-packages')
