...
<tr>
	...
	<ul>
  		<li>
			CytoPanel 1 (appears on the left)
		</li>
  		<li>
  			CytoPanel 2 (appears on the bottom)
		</li>
		<li>
			CytoPanel 3 (appears on the right)
		</li>
	</ul>
	</td>
</tr>
...
<tr>
	<td>
		...
		<p>Improved Attribute Browser is available for 2.2.  It is on CytoPanel 2 </p>
	<ul>
  		<li>
  			Large graphs are now supported (&gt;100K
			nodes, edges, depending on system)
		</li>
  		<li>
  			The 2.2 release features significant performance 
  			improvements for graph loading, creation, and miscellaneous
			graph operations (&gt; 2 - 10x improvements for some operations)
		</li>
	</ul>
	</td>
</tr>
...
<tr>
	<td>
		...
		<p>Performance Optimization of Graph Model:</p>
	<ul>
  		<li>
  			Large graphs are now supported (&gt;100K
			nodes, edges, depending on system)
