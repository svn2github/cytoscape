...
<HTML>
	...
	<BODY LANG="en-US" TEXT="#000000" DIR="LTR">
		...
		<div id="indent">
			...
			<ul>
				<li> Loading networks and generating network layouts 
				<li> Selecting and querying specific nodes and edges 
				<li> Setting visual properties 
			</ul>
			...
			courtesy of the CSC.
			<p>
				This tutorial features this dataset<A HREF="getting.started/RUAL.subset.sif">RUAL.subset.sif</A>, a 
			...
			&nbsp;
			<font size=+1><a href="webstart/cyto2.2.060106.jnlp">WEB START</a>
			...
			<p>Load the network <B>RUAL.subset.sif</B> into Cytoscape by selecting <B>File-->Import-->Network(Multiple File Types)...</B> 
			, then click <B>Select</B> button, and then specifying the location of the file you just downloaded.
...
Now, your screen should look like this: 
			...
			<p><IMG SRC="getting.started/Fig2.png"><BR CLEAR="LEFT">
				<EM>Webstart users only:</EM>If you see a network with square white 
nodes on a white background, locate the the <B>Set Visual Style</B> 
pull-down menu, shown below, and change the visual style from 
<B>default</B> to <B>Tutorial</B>.
</p>
			<p><IMG SRC="getting.started/vizmapper.png"></p>
			<P>Click <B>Close</B> on the <B>Loading Network</B> popup window.  Under the
<B>Layout</B> menu, select <B>Cytoscape Layouts-->Spring Embedded</B>, and
<B>All Nodes</B>.  After a brief calculation, your screen should look
like this:</P>
			<p><IMG SRC="getting.started/Fig3.png"><BR CLEAR=LEFT>
			</p>
			<H3>Selection</H3>
...
<B>Node Attribute Browser</B>.  Move this panel into a separate window, as follows:</P>
			<OL>
				<LI>
					<P>Locate the <B>Float Window</B> control in the upper right corner of
	CytoPanel 2, shown: <IMG SRC="getting.started/Fig4.png" WIDTH="5%" BORDER=1><BR CLEAR=LEFT>
					</P>
				<LI>
					<P>Click
	...
	selected nodes. Select a few nodes.</P>
					<IMG SRC="getting.started/Fig5.png"><BR CLEAR=LEFT>
					</P>
				<LI>
					<P>Notice
	...
	<B>Float</B> control to un-dock it. </P>
					<IMG SRC="getting.started/Fig6.png" BORDER=1><BR CLEAR=LEFT BORDER=1>
					</P>
				<LI>
					<P>In your network
	window, locate the <B>maximize</B> control (as shown), and click on
	it to maximize your network window.</P>
					<IMG SRC="getting.started/Fig7.png" BORDER=1><BR CLEAR=LEFT>
					</P>
				<LI>
					<P>To center your network in this window, click on the icon in the top menu bar: </P>
					<IMG SRC="getting.started/Fig8.png" BORDER=1>
			</OL>
			Your Cytoscape Desktop window should now appear as follows:
			<p><IMG SRC="getting.started/Fig9.png"><BR CLEAR=LEFT>
			</p>
...
The node representing TP53 is numbered 7157.  Select this node as follows:</P>
			<OL>
				<LI>
					<P>Under the <B>Select</B>
	menu, select <B>Nodes</B>, and <B>By Name</B>.  
	</P>
				<LI>
					<P>A popup windowshould appear labeled <B>Select Nodes by Name</B>.</P>
				<LI>
					<P>Enter 7157, and click <B>Search</B>.</P>
					<IMG SRC="getting.started/Fig10.png"></P><BR CLEAR=LEFT>
				<LI>
					<P>The node in the center of the screen should turn yellow. Close the popup window.</P>
				<LI>
					<P>Un-select this node by clicking on the background of the Cytoscape canvas.</P>
				<LI>
					<P>Type <B>Ctrl-F</B>.
	...
	side of the pull-down menus.</P>
				<LI>
					<P>Re-select node 7157 (TP53).</P>
				<LI>
					<P> Select the nodes that interact directly with TP53, as follows:</P>
					<OL>
						<LI>
							<P>Under the <B>Select</B> menu, select <B>Nodes</B>,and 
		<B>First neighbors of selected nodes</B>. You should see a network with several 
		yellow nodes in the center, as shown.  </P>
							<IMG SRC="getting.started/Fig11.png"><BR CLEAR=LEFT>
						<LI>
							<P>In <B>CytoPanel 1</B> at the left side of the window, you should see
		...
		none of which are currently selected.</P>
							<IMG SRC="getting.started/Fig12.png" BORDER=1><BR CLEAR=LEFT>
						
					</OL>
				<LI>Copy the selected nodes and their edges into a separate network by selecting <B>File-->New-->Network-->From selectednodes, all edges</B>.
	
				<LI>
					<P>Clean up your canvas:</P>
					<OL>
						<LI>
							<P>Maximize your subnetwork window.</P>
						<LI>
							<P>Select <B>Layout-->Cytoscape Layouts-->Spring Embedded</B>, and 
		<B>All Nodes. </B></P>
						<LI>
							<P>Use the Zoom control to zoom into this network.</P>
						<LI>
							<P>Your display should now appear as shown.</P>
							<IMG SRC="getting.started/Fig13.png"><BR CLEAR=LEFT>
							</P>
					</OL>
...
names. Load this attribute file as follows:</P>
			<OL>
				<LI>
					<P>Under the <B>File</B> menu, select <B>Import</B>, and then <B>Node Attributes</B>.	</P>
				<LI>
					<P>Select the file <A HREF="getting.started/RUAL.na">RUAL.na</A>, and click <B>Open</B>.  </P>
				<LI>
					<P>A popup window labeled <B>Loading Node Attributes</B> will appear.  When this
	window reports <B>Status: Done</B>, click <B>Close</B>.</P>
				<LI>
					<P>Look at the file	<A HREF="getting.started/RUAL.na">RUAL.na</A> with your favorite text 
	editor to examine its format.</P>
			...
			<OL>
				<LI>
					<P>Go to the <B>Node Attribute Browser</B> (CytoPanel 2), and click on
	<B>Select Button</B><IMG SRC="getting.started/select.png">. A pull-down menu should appear, similar to the one shown: </P>
					<IMG SRC="getting.started/Fig15.png"><BR CLEAR=LEFT>
					</P>
				<LI>
					<P>In the pull-down	menu, left-click on <B>Official</B>.  Right-click to exit the menu.</P>
				<LI>
					<P>Now, the Node Attribute Browser will show the IDs and official names of the nodes 
	...
	<B>Node Attribute Browser</B> should appear as shown. </P>
					<IMG SRC="getting.started/Fig16.png"><BR CLEAR=LEFT>
			...
			<OL>
				<LI>
					<P>In the Cytoscape	Desktop, click <B>Set Visual Style</B> icon. The <B>VizMapper</B> popup window should appear, as shown.</P>
					<IMG SRC="getting.started/Fig17.png"><BR CLEAR=LEFT>
				<LI>
					<P>Click on the <B>Duplicate</B> button to define a new style.  Name this style <b>Class 1</b>.</P>
				<LI>
					<P>Click on the <B>Define</B> button.  This will bring up the <B>Set Visual	Properties</B> 
	popup window.</P>
				<LI>
					<P>Click on the <B>Node Label</B> tab.</P>
				<LI>
					<P>Under the <B>Mapping</B>	section, locate the first pull-down menu, and select 
	<B>Common Names</B>.</P>
				<LI>
					<P>Select <B>Official HUGO Symbol</B> from <b>Map Attribute</b> pull-down menu, as shown, and click on it</P>
					<IMG SRC="getting.started/Fig14.png">
				<LI>
					<P>Click the button	labeled <B>Apply to Network</B>, followed by the <B>Close</B>
...
commands, to get a closer look. </P>
			<OL>
				<LI>
					<P>Zoom into the network using the <B>Zoom In</B> button (below)</P>
					<IMG SRC="getting.started/zoomin.png" BORDER=1><BR CLEAR=LEFT>
				<LI>
					<P>You can also zoom out using the <B>Zoom Out</B> button, below:</P>
					<IMG SRC="getting.started/zoomout.png" BORDER=1><BR CLEAR=LEFT>
				<LI>
					<P>Also, you can zoom to a selected region using the <B>Zoom Selected Region</B> button.</P>
					<IMG SRC="getting.started/zoomselected.png" BORDER=1><BR CLEAR=LEFT>
...
will now represent each interaction by its type, as follows:</P>
			<OL>
				<LI>
					<P>Return to the <B>Visual Styles</B> window to further define your Class1 visual style.</P>
				<LI>
					<P>Under the <B>Set	Visual Properties</B> popup window, click on the <B>Edge Attributes</B>
	button.</P>
				<LI>
					<P>Select the Edge Color tab.</P>
				<LI>
					<P>Under the <B>Mapping</B>	section, go to the pull-down labeled <B>None</B>, and scroll down
	to <B>BasicDiscrete</B>.</P>
				<LI>
					<P>A menu should now appear listing <B>Map Attribute</B> as <B>interaction</B>,
	and listing the five types of interactions in this network (<B>Y2H,
	coAP, core, hyper_core, non_core</B>).  
	</P>
				<LI>
					<P>Click the space next to <B>Y2H</B> to select a color for the Y2H edges.</P>
				<LI>
					<P>Repeat for the other edge types.  Select your colors so that the Y2H and coAP
	...
	shown below.</P>
					<p><IMG SRC="getting.started/Fig21.png"><BR CLEAR=LEFT>
					</p>
				<LI>
					<P>Click on <B>Apply to Network</B>, and click the <B>Close</B> button on the <B>Visual</B>
	<B>Styles</B> popup.</P>
				<LI>
					<P>You should see a	network similar to the one below.  Which is the most common types
	of edge?  Least common?  
	<IMG SRC="getting.started/Fig22.png"><BR CLEAR=LEFT>
						<BR>
					</P>
...
changes.</P>
			...
			<OL>
				<LI>
					<P>In <B>CytoPanel 2</B>, click on the <B>Edge Attribute 
         Browser</B> tab at the bottom
	 of the window.</P>
				<LI>
					<P>In the <B>Cytoscape Desktop</B> window, under the <B>Select</B> 
        menu, choose <B>Mouse
	Drag Selects</B>, and <B>Edges</B>.</P>
				<LI>
					<P>Select edges in the network window by clicking the left mouse 
        ...
        the rectangle to intersect the selected edges.</P>
				<LI>
					<P>Observe how the list of edges changes in the 
