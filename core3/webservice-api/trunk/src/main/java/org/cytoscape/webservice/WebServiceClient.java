 ...
 * 
 * @param <S>
 *            Client stub object. This is service dependent. For example, NCBI's
...
public interface WebServiceClient<S> {
	...
	/**
	 * Returns client type. A client can have multiple types.
	 * 
	 * For example, NCBI Client can be used as network import and attribute
	 * import, so this array contains both types.
	 * 
	 * @return Array of client types.
	 */
	Set<ClientType> getClientType();


	/**
	 * Get client stub object. All services available from this client will be
