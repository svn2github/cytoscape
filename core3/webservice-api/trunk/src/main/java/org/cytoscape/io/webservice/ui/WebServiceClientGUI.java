...
*/
package org.cytoscape.io.webservice.ui;
...
public interface WebServiceClientGUI<U extends Container> {
	 ...
	 */
	public U getCustomComponent();


	/**
	 * Returns icon for the client.  May be used for about page.
	 *
	 * @param t
	 * @return Icon for the client (for example, web service provider's logo)
	 */
	public Icon getIcon();
