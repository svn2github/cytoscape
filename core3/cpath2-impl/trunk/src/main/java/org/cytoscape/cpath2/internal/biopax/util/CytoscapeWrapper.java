...
//		desktop.clearStatusBar();
	 ...
	 */
	public static void activateBioPaxPlugInTab(CySwingApplication application, BioPaxContainer bpContainer) {
		// cytoscape 2.2 code
		CytoPanel cytoPanel = application.getCytoPanel(BioPaxContainer.CYTO_PANEL_LOCATION);
