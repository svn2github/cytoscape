 ...
 */
package org.cytoscape.ding.vizmap;
 ...
 *
 */
public class LabelPositionChooser extends JDialog implements PropertyChangeListener {
	 ...
	 * @return  DOCUMENT ME!
	 */
	public static LabelPosition showDialog(Component parentComponent, LabelPosition pos) {
		final LabelPositionChooser placer = new LabelPositionChooser(parentComponent, true, pos);
		return placer.getLabelPosition();
	}

	private LabelPositionChooser(Component parent, boolean modal, LabelPosition pos) {
		super();
		this.setModal(modal);
