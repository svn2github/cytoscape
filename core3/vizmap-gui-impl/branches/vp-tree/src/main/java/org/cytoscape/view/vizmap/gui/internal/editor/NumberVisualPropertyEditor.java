...
public class NumberVisualPropertyEditor extends AbstractVisualPropertyEditor<Number> {
	 ...
	 */
	public NumberVisualPropertyEditor(VisualProperty<Number> vp, VizMapGUI vizMapGUI, CyTable attr) {
		super(vp);
		propertyEditor = new CyDoublePropertyEditor(null);
		tableCellRenderer = new DefaultTableCellRenderer();
		continuousEditor = new C2CMappingEditor<Number>(this.vp, vizMapGUI, attr);
	}
