...
import org.cytoscape.view.model.visualproperties.DefaultVisualizableVisualProperty;
...
public class TwoDVisualLexicon extends BasicVisualLexicon {
	...
	public static final VisualProperty<NullDataType> ENGINE_ROOT = new NullVisualProperty(
	...
	public TwoDVisualLexicon(final VisualProperty<NullDataType> root) {
		...
		insertVisualProperty(NETWORK_CENTER_X_LOCATION, NETWORK_CENTER_LOCATION);
		insertVisualProperty(NETWORK_CENTER_Y_LOCATION, NETWORK_CENTER_LOCATION);
