...
/**
 * Writes vector graphics given a <code>renderingEngine</code> to an output stream.
 * @author Pasteur
 */
public interface CyVectorGraphicsWriter
{
	/**
	 * Initiates writing
	 ...
	 */
	public void write(RenderingEngine renderingEngine, OutputStream output) throws IOException;
