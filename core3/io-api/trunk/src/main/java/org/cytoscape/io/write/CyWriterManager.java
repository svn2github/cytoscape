...
public interface CyWriterManager {
	 ...
	 * @param os The {@link java.io.OutputStream} that will be written to by the {@link CyWriter} 
	 * generated by the {@link CyWriterFactory}.
	 * @return A {@link CyWriterFactory} for the appropriate filter.
	 */
	CyWriterFactory getMatchingFactory(CyFileFilter filter, OutputStream os); 
}
