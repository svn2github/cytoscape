 ...
 * {@link org.cytoscape.view.vizmap.VisualStyle} objects that are read as part of the Task.
...
public interface CyNetworkViewReader extends Task {
	 ...
	 * @return An array of {@link org.cytoscape.view.vizmap.VisualStyle} objects. The list may be
