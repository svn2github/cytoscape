 ...
 */
public class AddedNodeViewEventImpl implements AddedNodeViewEvent {
	 ...
	 */
	public AddedNodeViewEventImpl(final CyNetworkView networkView, final View<CyNode> nv) {
	 ...
	 * @return  DOCUMENT ME!
	 */
	public CyNetworkView getSource() {
		return networkView;
	}
}
