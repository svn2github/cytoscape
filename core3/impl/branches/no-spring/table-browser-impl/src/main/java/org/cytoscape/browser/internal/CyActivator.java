...
public class CyActivator extends AbstractCyActivator {
	...
	public void start(BundleContext bc) {
		...
		TableBrowser tableBrowser = new TableBrowser(cyTableManagerServiceRef,cyServiceRegistrarServiceRef,compilerServiceRef,openBrowserServiceRef,cyNetworkManagerServiceRef,deleteTableTaskFactoryService,guiTaskManagerServiceRef,popupMenuHelper,cyApplicationManagerServiceRef);
