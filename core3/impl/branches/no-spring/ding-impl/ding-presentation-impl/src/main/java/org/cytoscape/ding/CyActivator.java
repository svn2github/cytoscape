...
public class CyActivator extends AbstractCyActivator {
	...
	public void start(BundleContext bc) {
		...
		DingRenderingEngineFactory dingRenderingEngineFactory = new DingRenderingEngineFactory(cyDataTableFactoryServiceRef,cyRootNetworkFactoryServiceRef,undoSupportServiceRef,spacialIndex2DFactoryServiceRef,dVisualLexicon,taskManagerServiceRef,cyServiceRegistrarRef,cyTableManagerServiceRef,cyEventHelperServiceRef,renderingEngineManagerServiceRef);
