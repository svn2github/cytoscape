...
public class CyActivator extends AbstractCyActivator {
	...
	public void start(BundleContext bc) {
		...
		CyTableManagerImpl cyTableManager = new CyTableManagerImpl(cyEventHelperServiceRef);
		...
		CyNetworkFactoryImpl cyNetworkFactory = new CyNetworkFactoryImpl(cyEventHelperServiceRef,cyTableManager,cyTableFactory,cyServiceRegistrarServiceRef);
