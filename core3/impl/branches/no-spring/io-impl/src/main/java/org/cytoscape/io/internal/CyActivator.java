...
public class CyActivator extends AbstractCyActivator {
	...
	public void start(BundleContext bc) {
		...
		SessionReaderFactoryImpl sessionReaderFactory = new SessionReaderFactoryImpl(cysFilter,cyNetworkReaderManager,cyPropertyReaderManager,vizmapReaderManager,sessionTableReaderFactory,cyTableManagerServiceRef);
