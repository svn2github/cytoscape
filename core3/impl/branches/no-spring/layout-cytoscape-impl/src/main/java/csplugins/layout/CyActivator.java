...
public class CyActivator extends AbstractCyActivator {
	...
	public void start(BundleContext bc) {
		...
		DegreeSortedCircleLayout degreeSortedCircleLayout = new DegreeSortedCircleLayout(undoSupportServiceRef,cyTableManagerServiceRef);
		...
		GroupAttributesLayout groupAttributesLayout = new GroupAttributesLayout(undoSupportServiceRef,cyTableManagerServiceRef);
