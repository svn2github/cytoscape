...
public class CyActivator extends AbstractCyActivator {
	...
	public void start(BundleContext bc) {
		...
		CySessionManagerImpl cySessionManager = new CySessionManagerImpl(cyEventHelperServiceRef,cyNetworkManagerServiceRef,cyTableManagerServiceRef,visualMappingManagerServiceRef,cyNetworkViewManagerServiceRef);
