...
public class CyActivator extends AbstractCyActivator {
	...
	public void start(BundleContext bc) {
		...
		BioPaxNetworkViewTaskFactory bioPaxNetworkViewTaskFactory = new BioPaxNetworkViewTaskFactory(bioPaxFilter,cyNetworkFactoryRef,cyNetworkViewFactoryRef,cyNetworkNamingRef,bioPaxContainer,networkListener,visualMappingManagerRef,bioPaxVisualStyleUtil);
