...
public class CyActivator extends AbstractCyActivator {
	...
	public void start(BundleContext bc) {
		...
		NCBITableImportAction ncbiTableImportAction = new NCBITableImportAction(ncbiTableImportClient,taskManagerServiceRef,cyTableManagerServiceRef,cyNetworkManagerServiceRef,cyApplicationManagerRef);
