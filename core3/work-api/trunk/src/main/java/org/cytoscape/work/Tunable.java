 ...
 * If a the user interface autogenerated from this is a GUI, <code>collapsed</code> could indicate that the initial state of the panel that may
...
public @interface Tunable {
	 ...
	 *   </li>
	 *   <li>
	 *     slider: used when the object's values range should be represented by a slider, the value should always be "true".
	 *     This is being used by <code>AbstractBounded</code> and <code>AbstractFlexiblyBounded</code>.
	 *   </li>
	 *   <li>
	 *     alignments: the value should be a comma-seperated list of "horizontal" or "vertical".
	 ...
	 *     correspondance with the strings in the "group" array.  Excess values will be ignored.
	 *   </li>
	 *   <li>
	 *    groupTitles: the value should be a comma-separated list of "hidden" and/or "displayed" indicating whether 
	 *    the name of a <code>Tunable</code>'s group has to be displayed or not in the <code>titleBorder</code> of
	 *    the <code>JPanel</code> representing this group.
	 *   </li>
	 *   <li>
	 *    displayState: if present, the corresponding <code>Tunable</code>'s JPanel will be collapsible.
	 *    The value must be either "collapsed" or "uncollapsed" indicating the initial display state.
	 *   </li>
	 *  </ul>
	 *
