 ...
 */
public class FlexiblyBoundedLong extends AbstractFlexiblyBounded<Long> {

	/**
	 * Creates a new Flexibly Bounded Long object.
	 *
	 ...
	 */
	public FlexiblyBoundedLong(final Long lower, final Long initValue, final Long upper, boolean lowerStrict, boolean upperStrict) {
		super(lower,initValue,upper,lowerStrict,upperStrict);
	}

	
	/**
	 * Set a new value to the Flexibly BoundedLong object
