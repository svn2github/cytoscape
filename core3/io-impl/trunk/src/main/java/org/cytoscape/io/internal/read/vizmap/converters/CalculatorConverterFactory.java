...
/**
 * Simple factory that creates {@link  org.cytoscape.io.internal.read.vizmap.converters.CalculatorConverter}
 * objects.
 * @author Christian
 */
public class CalculatorConverterFactory {
    ...
    public CalculatorConverter[] getConverters(String calcKey) {
        ...
        for (String k : keys) {
            CalculatorConverter c = new CalculatorConverter(k, legacyCalcKey, targetType);
            convs.add(c);
        }
