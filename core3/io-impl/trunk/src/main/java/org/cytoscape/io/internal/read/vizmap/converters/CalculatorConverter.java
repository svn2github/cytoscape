 ...
 */
package org.cytoscape.io.internal.read.vizmap.converters;
...
import org.cytoscape.view.vizmap.model.ContinuousMappingPoint;
...
public class CalculatorConverter {
    ...
    CalculatorConverter(String calcKey, String legacyCalcKey, Class<? extends CyTableEntry> targetType) {
        this.key = calcKey;
     ...
     * @return A {@link org.cytoscape.view.vizmap.model.DiscreteMapping}, 
     *           {@link org.cytoscape.view.vizmap.model.ContinuousMapping} or
     *           {@link org.cytoscape.view.vizmap.model.PassThroughMapping} object
     */
    public Object getMappingFunction(Properties props, String mapperName, VisualProperty vp) {
        ...
        if ("DiscreteMapping".equalsIgnoreCase(functionType)) {
            ...
            cm.setAttributeType(AttributeType.DECIMAL);
