...
public class VisualStyleSerializerTest extends AbstractVisualStyleSerializerTest {
    ...
    public void testGetStyleName() {
        assertEquals("My style", VisualStyleSerializerImpl.getStyleName("globalAppearanceCalculator.My style.defaultBackgroundColor"));
        assertEquals("My style 2", VisualStyleSerializerImpl.getStyleName("nodeAppearanceCalculator.My style 2.defaultNodeBorderColor"));
        assertEquals("default", VisualStyleSerializerImpl.getStyleName("edgeAppearanceCalculator.default.defaultEdgeToolTip"));
        assertEquals("My style", VisualStyleSerializerImpl.getStyleName("nodeAppearanceCalculator.My style.nodeLabelCalculator"));
        assertEquals("default", VisualStyleSerializerImpl.getStyleName("nodeAppearanceCalculator.default.defaultNodeCustomGraphics1"));
        assertEquals("My style", VisualStyleSerializerImpl.getStyleName("nodeAppearanceCalculator.My style.nodeSizeLocked"));
        assertEquals("My style", VisualStyleSerializerImpl.getStyleName("nodeAppearanceCalculator.My style.defaultNodeShowNestedNetworks"));
        assertEquals("My style", VisualStyleSerializerImpl.getStyleName("nodeAppearanceCalculator.My style.nodeLabelColorFromNodeColor"));
        assertEquals("My style", VisualStyleSerializerImpl.getStyleName("nodeAppearanceCalculator.My style.nodeCustomGraphicsSizeSync"));
        assertEquals("My style", VisualStyleSerializerImpl.getStyleName("edgeAppearanceCalculator.My style.arrowColorMatchesEdge"));
        
        assertNull(VisualStyleSerializerImpl.getStyleName("nodeBorderColorCalculator.My style-Node Border Color-Discrete Mapper.mapping.map.A03"));
        assertNull(VisualStyleSerializerImpl.getStyleName("edgeColorCalculator.default-Edge Color-Continuous Mapper.mapping.boundaryvalues=2"));
    }
    
    @Test
    public void testIsDefaultProperty() {
        assertTrue(VisualStyleSerializerImpl.isDefaultProperty("globalAppearanceCalculator.My style.defaultBackgroundColor"));
        assertTrue(VisualStyleSerializerImpl.isDefaultProperty("globalAppearanceCalculator.My style.defaultNodeSelectionColor"));
        assertTrue(VisualStyleSerializerImpl.isDefaultProperty("globalAppearanceCalculator.My style.defaultEdgeReverseSelectionColor"));
        assertTrue(VisualStyleSerializerImpl.isDefaultProperty("nodeAppearanceCalculator.My style.defaultNodeBorderColor"));
        assertTrue(VisualStyleSerializerImpl.isDefaultProperty("nodeAppearanceCalculator.My style.defaultNodeBorderOpacity"));
        ...
        assertTrue(VisualStyleSerializerImpl.isDefaultProperty("nodeAppearanceCalculator.My style.defaultNodeLineStyle"));
        assertTrue(VisualStyleSerializerImpl.isDefaultProperty("nodeAppearanceCalculator.My style.defaultNodeCustomGraphics1"));
        assertTrue(VisualStyleSerializerImpl.isDefaultProperty("nodeAppearanceCalculator.My style.defaultNodeCustomGraphicsPosition8"));
        assertTrue(VisualStyleSerializerImpl.isDefaultProperty("edgeAppearanceCalculator.My style.defaultEdgeToolTip"));
        assertTrue(VisualStyleSerializerImpl.isDefaultProperty("edgeAppearanceCalculator.default.defaultEdgeTargetArrowColor"));
        
        assertFalse(VisualStyleSerializerImpl.isDefaultProperty("nodeAppearanceCalculator.My style.nodeLabelCalculator"));
        assertFalse(VisualStyleSerializerImpl.isDefaultProperty("nodeAppearanceCalculator.My style.nodeSizeLocked"));
        assertFalse(VisualStyleSerializerImpl.isDefaultProperty("nodeAppearanceCalculator.My style.defaultNodeShowNestedNetwork"));
    ...
    public void testIsMappingFunction() {
        ...
        assertTrue(VisualStyleSerializerImpl.isMappingFunction("nodeAppearanceCalculator.My style.nodeBorderColorCalculator"));
        ...
        assertFalse(VisualStyleSerializerImpl.isMappingFunction("nodeAppearanceCalculator.My style.nodeCustomGraphicsSizeSync"));
        assertFalse(VisualStyleSerializerImpl.isMappingFunction("nodeAppearanceCalculator.My style.nodeLabelColorFromNodeColor"));
        assertFalse(VisualStyleSerializerImpl.isMappingFunction("nodeAppearanceCalculator.My style.defaultNodeCustomGraphics1"));
        assertFalse(VisualStyleSerializerImpl.isMappingFunction("nodeAppearanceCalculator.My style.defaultNodeCustomGraphicsPosition2"));
        assertFalse(VisualStyleSerializerImpl.isMappingFunction("globalAppearanceCalculator.My style.defaultBackgroundColor"));
        assertFalse(VisualStyleSerializerImpl.isMappingFunction("edgeAppearanceCalculator.default.defaultEdgeColor"));
        assertFalse(VisualStyleSerializerImpl.isMappingFunction("nodeBorderColorCalculator.My Style-Node Border Color-Discrete Mapper.mapping.controller"));
    }
    ...
    public void testIsDependency() {
        ...
        assertTrue(VisualStyleSerializerImpl.isDependency("nodeAppearanceCalculator.My style.defaultNodeShowNestedNetwork"));
        assertTrue(VisualStyleSerializerImpl.isDependency("nodeAppearanceCalculator.My style.nodeLabelColorFromNodeColor"));
        assertTrue(VisualStyleSerializerImpl.isDependency("nodeAppearanceCalculator.My style.nodeCustomGraphicsSizeSync"));
        assertTrue(VisualStyleSerializerImpl.isDependency("edgeAppearanceCalculator.My style.arrowColorMatchesEdge"));
        
        assertFalse(VisualStyleSerializerImpl.isDependency("globalAppearanceCalculator.My style.defaultBackgroundColor"));
        assertFalse(VisualStyleSerializerImpl.isDependency("nodeAppearanceCalculator.My style.nodeCustomGraphics1"));
        assertFalse(VisualStyleSerializerImpl.isDependency("nodeAppearanceCalculator.My style.nodeCustomGraphicsPosition4"));
        assertFalse(VisualStyleSerializerImpl.isDependency("nodeAppearanceCalculator.nodeCustomGraphicsSizeSync.defaultNodeCustomGraphicsPosition2"));
        assertFalse(VisualStyleSerializerImpl.isMappingFunction("nodeBorderColorCalculator.nodeCustomGraphicsSizeSync-Node Border Color-Discrete Mapper.mapping.controller"));
    }
}
