...
/**
 * A utility class that listens for various events and then updates
 * the enable state for the toolbar icons.  Menus do this check every
 * time that a menu is selected, but since toolbars are always visible,
 * we need to listen for the actual events.  This is less than ideal.
 */
class ToolBarEnableUpdater implements NetworkAddedListener, 
	...
	public ToolBarEnableUpdater(CytoscapeToolBar toolbar) {
