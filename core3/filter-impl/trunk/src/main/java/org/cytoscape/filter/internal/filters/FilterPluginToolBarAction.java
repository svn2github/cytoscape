 ...
 *
 */
public class FilterPluginToolBarAction extends AbstractCyAction {
	 ...
	 */
	public FilterPluginToolBarAction(Map configProps, FilterPlugin pFilter, CySwingApplication application, CyApplicationManager applicationManager) {
