...
public class BioPaxDetailsPanel extends JPanel {
    ...
    public void showDetails(String nodeID) {
        ...
        StringBuffer buf = new StringBuffer
                ("<HTML><BODY BGCOLOR=LIGHTGRAY>");
        buf.append("<TABLE WIDTH=100% CELLPADDING=5 CELLSPACING=5>"
        ...
        // organism
        stringRef = nodeAttributes.getStringAttribute(nodeID,
                MapNodeAttributes.BIOPAX_ORGANISM_NAME);
        ...
        // availability
        stringRef = nodeAttributes.getStringAttribute(nodeID,
                MapNodeAttributes.BIOPAX_AVAILABILITY);
    ...
    private void addPathwayMembership(String nodeID, StringBuffer buf) {
        ...
        String pathwayMembership =
                nodeAttributes.getStringAttribute(nodeID, MapNodeAttributes.BIOPAX_PATHWAY_NAME);
    ...
    private void appendHeader(String header, StringBuffer buf) {
        buf.append("<FONT COLOR=4B4B4B FACE=\""
