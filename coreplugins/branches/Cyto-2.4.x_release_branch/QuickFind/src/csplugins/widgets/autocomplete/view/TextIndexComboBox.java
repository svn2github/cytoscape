...
public class TextIndexComboBox extends JComboBox {
     ...
     */
    protected EventListenerList finalSelectionListenerList =
    ...
    public ActionListener[] getFinalSelectionListeners() {
        return (ActionListener[]) finalSelectionListenerList.getListeners(
    ...
    private void init() {
        ...
        final JTextComponent editor = (JTextComponent)
...
class UserKeyListener extends KeyAdapter {
     ...
     */
    UserKeyListener(AutoCompleteDocument doc, JTextComponent editor,
    ...
    public void keyPressed(KeyEvent e) {
        ...
        switch (e.getKeyCode()) {
            ...
            case KeyEvent.VK_BACK_SPACE :
                ...
                doc.setHitBackspaceOnSelection
