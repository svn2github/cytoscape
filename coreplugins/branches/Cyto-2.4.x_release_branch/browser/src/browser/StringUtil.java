...
public class StringUtil {
  ...
  private static DateFormat moShortWithTimeFormat = DateFormat.getDateTimeInstance(DateFormat.SHORT, DateFormat.SHORT);
  ...
  */
  ...
  public static boolean firstStringSortsBeforeSecond ( String sOne, 
                                                       String sTwo, 
                                                       boolean invert ) {
