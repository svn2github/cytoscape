...
<xsl:template match="testsuites">
    <html>
        <head>
            <title>Cytoscape BioPAX PlugIn:  Unit Test Results</title>
    <style type="text/css">
      body {
...
<xsl:template name="pageHeader">
    <h1>Cytoscape BioPAX PlugIn:  Unit Test Results</h1>
    <table width="100%">
    <tr>
        <td align="left"></td>
...
<xsl:template match="testcase" mode="print.test">
	...
	<td><xsl:value-of select="@name"/>
		<br/>[<xsl:value-of select="@classname"/>]</td>
        <xsl:choose>
