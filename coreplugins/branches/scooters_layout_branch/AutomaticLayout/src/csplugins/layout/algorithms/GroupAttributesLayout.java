...
public class GroupAttributesLayout extends AbstractLayout
{
  ...
  public GroupAttributesLayout()
  {
	...
	public String getName () { return "attributes-layout"; }
	...
	public byte[] supportsNodeAttributes() {
		byte[] attrs = { CyAttributes.TYPE_INTEGER, CyAttributes.TYPE_STRING,
	...
	public List getInitialAttributeList() { return null; }
	...
	protected void initialize_properties() {
		layoutProperties.add(new Tunable("spacingx", "Horizontal spacing between two partitions in a row",
																		Tunable.DOUBLE, new Double(400.0)));
		layoutProperties.add(new Tunable("spacingy", "Vertical spacing between the largest partitions of two rows",
																		Tunable.DOUBLE, new Double(400.0)));
		layoutProperties.add(new Tunable("maxwidth", "Maximum width of a row",
																		Tunable.DOUBLE, new Double(5000.0)));
		layoutProperties.add(new Tunable("minrad", "Minimum width of a partition",
