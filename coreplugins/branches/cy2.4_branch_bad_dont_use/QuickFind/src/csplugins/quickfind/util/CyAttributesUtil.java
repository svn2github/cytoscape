...
public class CyAttributesUtil {
        ...
        if (attributeKey.equals(QuickFind.UNIQUE_IDENTIFIER)) {
            ...
            if (hasAttribute) {
                ...
                if (type == CyAttributes.TYPE_BOOLEAN) {
                    ...
                    terms[0] = attributes.getIntegerAttribute
                            (graphObjectId, attributeKey).toString();
                } else if (type == CyAttributes.TYPE_FLOATING) {
                    terms[0] = attributes.getDoubleAttribute
                            (graphObjectId, attributeKey).toString();
     ...
     */
    public static String [] getDistinctAttributeValues(Iterator
            iterator, CyAttributes attributes, String attributeKey,
