...
public class TestBioPaxEntityParser extends TestCase {
    ...
    public void testBioPaxEntityParser() throws Exception {
        ...
        BioPaxEntityParser entityParser = new BioPaxEntityParser
                (protein, rdfMap);
        ...
        assertTrue(entityParser.getComment().startsWith
                ("FUNCTION: Cytokine that binds"));
        assertEquals("see http://www.amaze.ulb.ac.be/",
                entityParser.getAvailability());
