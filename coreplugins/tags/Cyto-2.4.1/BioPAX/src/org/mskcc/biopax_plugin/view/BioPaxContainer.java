...
public class BioPaxContainer extends JPanel {
    ...
    private BioPaxContainer() {
        ...
        URL url1 = BioPaxDetailsPanel.class.getResource
                ("resources/glasses.gif");
        Icon icon1 = new ImageIcon(url1);
        URL url2 = BioPaxDetailsPanel.class.getResource
                ("resources/legend.gif");
        Icon icon2 = new ImageIcon(url2);
        URL url3 = BioPaxDetailsPanel.class.getResource
                ("resources/info.gif");
        ...
        tabbedPane.addTab("Visual Legend", icon2,
