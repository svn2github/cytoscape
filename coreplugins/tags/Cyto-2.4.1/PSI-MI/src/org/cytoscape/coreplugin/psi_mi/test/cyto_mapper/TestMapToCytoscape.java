...
public class TestMapToCytoscape extends TestCase {
    ...
    public void testMapper1() throws Exception {
        ...
        String fullName = (String) nodeAttributes.getStringAttribute
                (sourceNode.getIdentifier(), InteractorVocab.FULL_NAME);
        ...
        List dbNameList = nodeAttributes.getAttributeList
        ...
        dbNameList = edgeAttributes.getAttributeList(edge1.getIdentifier(),
                CommonVocab.XREF_DB_NAME);
        List dbIdList = edgeAttributes.getAttributeList(edge1.getIdentifier(),
