...
public class AttributeLayoutMenu extends JMenu implements MenuListener
{
  /**
   * Constructor for the class.
   * The menu's title is "Attribute Circle Layout."
   */
  public AttributeLayoutMenu()
  {
    // call the super constructor
    super("Attribute Layout");
  ...
  private JMenuItem getNewAttributesMenuItem(final String _attributeName)
  {
    return new JMenuItem(
      new AbstractAction(_attributeName)
      {
		...
		attributeLayout.doCallback(_attributeName,
