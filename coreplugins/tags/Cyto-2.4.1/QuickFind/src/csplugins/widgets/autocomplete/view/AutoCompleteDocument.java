...
public class AutoCompleteDocument extends PlainDocument {
    ...
    public void replace(int offset, int length, String text, AttributeSet attrs)
        ...
        debug("replace(), text=" + text + ", cursorKeyPressed="
                + cursorKeyPressed);
    ...
    public void populatePullDownMenu(String pattern) {
        ...
        Hit hits[] = comboBox.getTextIndex().getHits(pattern,
    ...
    private void lookUpItem(int offs, String str) throws BadLocationException {
        if (cursorKeyPressed) {
            debug("lookUpItem(), str=" + str + ", cursorKeyPressed:  "
                    + cursorKeyPressed + " --> Exit");
            return;
        }
        debug("lookUpItem(), str=" + str + ", cursorKeyPressed:  "
                + cursorKeyPressed + " --> Process");
