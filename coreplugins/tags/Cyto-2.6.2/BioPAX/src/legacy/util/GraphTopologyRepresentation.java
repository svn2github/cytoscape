...
public class GraphTopologyRepresentation implements GraphTopology {
	 ...
	 *
	 * @param numNodes                      <blockquote>the number of nodes in this graph, as defined by
	 *                                      <code>getNumNodes()</code>; nodes are referenced by their indices, which
	 *                                      lie in the interval <nobr><code>[0, getNumNodes() - 1]</code></nobr>.
	 *                                      </blockquote>
	 * @param directedEdgeSourceNodeIndices <blockquote>an array of length equal to
	 ...
	 *                                      </blockquote>
	 * @param directedEdgeTargetNodeIndices <blockquote>an array of length equal to
	 *                                      the number of directed edges in this graph;
	 ...
	 *                                      the edge index of any undirected edge in this construction).
	 *                                      </blockquote>
	 * @param undirectedEdgeNode0Indices    <blockquote>an array of length equal to
	 ...
	 * @param undirectedEdgeNode1Indices    <blockquote>an array of length equal to
	 *                                      the number of undirected edges in this graph;
	 ...
	 */
	public GraphTopologyRepresentation(int numNodes, int[] directedEdgeSourceNodeIndices,
		...
		if (directedEdgeSourceNodeIndices.length != directedEdgeTargetNodeIndices.length) {
			throw new IllegalArgumentException("directed edge node index arrays are not the same length");
		}

		m_directedEdgeSourceNodeIndices = new int[directedEdgeSourceNodeIndices.length];
		System.arraycopy(directedEdgeSourceNodeIndices, 0, m_directedEdgeSourceNodeIndices, 0,
		                 directedEdgeSourceNodeIndices.length);
		m_directedEdgeTargetNodeIndices = new int[directedEdgeTargetNodeIndices.length];
		System.arraycopy(directedEdgeTargetNodeIndices, 0, m_directedEdgeTargetNodeIndices, 0,
		...
		if (undirectedEdgeNode0Indices.length != undirectedEdgeNode1Indices.length) {
			throw new IllegalArgumentException("undirected edge node index arrays are not the same length");
		}

		m_undirectedEdgeNode0Indices = new int[undirectedEdgeNode0Indices.length];
		System.arraycopy(undirectedEdgeNode0Indices, 0, m_undirectedEdgeNode0Indices, 0,
		                 undirectedEdgeNode0Indices.length);
		m_undirectedEdgeNode1Indices = new int[undirectedEdgeNode1Indices.length];
		System.arraycopy(undirectedEdgeNode1Indices, 0, m_undirectedEdgeNode1Indices, 0,
	...
	public final int getNumEdges() {
		return m_directedEdgeSourceNodeIndices.length + m_undirectedEdgeNode0Indices.length;
	}
	...
	public final boolean isDirectedEdge(int edgeIndex) {
		if ((edgeIndex < 0) || (edgeIndex >= getNumEdges())) {
			throw new IndexOutOfBoundsException("edgeIndex is out of bounds - graph has "
			                                    + getNumEdges()
	...
	public final int getEdgeNodeIndex(int edgeIndex, boolean sourceNode) {
		...
		if (isDirectedEdge(edgeIndex)) {
			return (sourceNode ? m_directedEdgeSourceNodeIndices : m_directedEdgeTargetNodeIndices)[edgeIndex];
		} else {
			return (sourceNode ? m_undirectedEdgeNode0Indices : m_undirectedEdgeNode1Indices)[edgeIndex
	...
	public final boolean areAllEdgesSimilar() {
		return (m_directedEdgeSourceNodeIndices.length == 0)
