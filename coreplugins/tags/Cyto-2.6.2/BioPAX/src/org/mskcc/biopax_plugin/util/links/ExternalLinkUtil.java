...
public class ExternalLinkUtil {
	...
	private static HashMap ihopMap;
	 ...
	 */
	public static String getIHOPUrl(String type, ArrayList synList, ArrayList dbList, int taxonomyId) {
		if (type.equals(BioPaxConstants.PROTEIN) || type.equals(BioPaxConstants.DNA)
	 ...
	 */
	private static String createDbParameter(ArrayList dbList, ArrayList synList) {
		int dbHits = 0;
		int uniProtHits = 0;
	 ...
	 */
	private static String createSynonymParameter(ArrayList synList) {
		StringBuffer temp = new StringBuffer();
