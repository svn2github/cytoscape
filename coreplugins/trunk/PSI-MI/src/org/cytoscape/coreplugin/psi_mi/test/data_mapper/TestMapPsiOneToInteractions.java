...
public class TestMapPsiOneToInteractions extends TestCase {
    ...
    public void testDipData2() throws Exception {
        ...
        Interaction interaction = (Interaction) interactions.get(0);
        this.validateDipInteractions(interaction,
                "11821039", "Genetic", "PSI", "MI:0045");
        interaction = (Interaction) interactions.get(1);
        this.validateDipInteractions(interaction,
                "9174345", "x-ray crystallography", "PSI", "MI:0114");
    ...
    private void validateSample1(Interaction interaction) {
        assertEquals("11283351", interaction.getAttribute
    ...
    private void validateDipInteractions(Interaction interaction,
            String expectedPmid, String expectedSystemName,
            String expectedDbName, String expectedDbId) {
        String pmid = (String) interaction.getAttribute
                (InteractionVocab.PUB_MED_ID);
        String expName = (String) interaction.getAttribute
                (InteractionVocab.EXPERIMENTAL_SYSTEM_NAME);
        String dbName = (String) interaction.getAttribute
                (InteractionVocab.EXPERIMENTAL_SYSTEM_XREF_DB);
        String dbId = (String) interaction.getAttribute
                (InteractionVocab.EXPERIMENTAL_SYSTEM_XREF_ID);
        ...
        interactor = (Interactor) interactors.get(1);
        assertEquals("major prion PrP-Sc protein precursor",
                interactor.getName());
    }
    ...
    private void outputInteraction(Interaction interaction) {
        ...
        String pubMedID = (String) interaction.getAttribute
                (InteractionVocab.PUB_MED_ID);
