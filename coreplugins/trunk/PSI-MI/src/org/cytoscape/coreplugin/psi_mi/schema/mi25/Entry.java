...
public class Entry implements java.io.Serializable {
     ...
     */
    private org.cytoscape.coreplugin.psi_mi.schema.mi25.Source _source;

    /**
     * Data availability statements, for example copyrights
     */
    private org.cytoscape.coreplugin.psi_mi.schema.mi25.AvailabilityList _availabilityList;

    /**
     * All experiments in which the interactions of this entry have
     * been determined
     */
    private org.cytoscape.coreplugin.psi_mi.schema.mi25.ExperimentList1 _experimentList1;

    /**
     * List of all interactors occurring in the entry
     */
    private org.cytoscape.coreplugin.psi_mi.schema.mi25.InteractorList _interactorList;

    /**
     * List of interactions
     */
    private org.cytoscape.coreplugin.psi_mi.schema.mi25.InteractionList _interactionList;
    ...
    public Entry() {
        super();
    } //-- org.cytoscape.coreplugin.psi_mi.schema.mi25.Entry()
     ...
     */
    public org.cytoscape.coreplugin.psi_mi.schema.mi25.AvailabilityList getAvailabilityList()
    {
        return this._availabilityList;
    } //-- org.cytoscape.coreplugin.psi_mi.schema.mi25.AvailabilityList getAvailabilityList()
     ...
     */
    public org.cytoscape.coreplugin.psi_mi.schema.mi25.ExperimentList1 getExperimentList1()
    {
        return this._experimentList1;
    } //-- org.cytoscape.coreplugin.psi_mi.schema.mi25.ExperimentList1 getExperimentList1()
     ...
     */
    public org.cytoscape.coreplugin.psi_mi.schema.mi25.InteractionList getInteractionList()
    {
        return this._interactionList;
    } //-- org.cytoscape.coreplugin.psi_mi.schema.mi25.InteractionList getInteractionList()
     ...
     */
    public org.cytoscape.coreplugin.psi_mi.schema.mi25.InteractorList getInteractorList()
    {
        return this._interactorList;
    } //-- org.cytoscape.coreplugin.psi_mi.schema.mi25.InteractorList getInteractorList()
     ...
     */
    public org.cytoscape.coreplugin.psi_mi.schema.mi25.Source getSource()
    {
        return this._source;
    } //-- org.cytoscape.coreplugin.psi_mi.schema.mi25.Source getSource()
     ...
     */
    public void setAvailabilityList(org.cytoscape.coreplugin.psi_mi.schema.mi25.AvailabilityList availabilityList)
    {
        this._availabilityList = availabilityList;
    } //-- void setAvailabilityList(org.cytoscape.coreplugin.psi_mi.schema.mi25.AvailabilityList)
     ...
     */
    public void setExperimentList1(org.cytoscape.coreplugin.psi_mi.schema.mi25.ExperimentList1 experimentList1)
    {
        this._experimentList1 = experimentList1;
    } //-- void setExperimentList1(org.cytoscape.coreplugin.psi_mi.schema.mi25.ExperimentList1)
     ...
     */
    public void setInteractionList(org.cytoscape.coreplugin.psi_mi.schema.mi25.InteractionList interactionList)
    {
        this._interactionList = interactionList;
    } //-- void setInteractionList(org.cytoscape.coreplugin.psi_mi.schema.mi25.InteractionList)
     ...
     */
    public void setInteractorList(org.cytoscape.coreplugin.psi_mi.schema.mi25.InteractorList interactorList)
    {
        this._interactorList = interactorList;
    } //-- void setInteractorList(org.cytoscape.coreplugin.psi_mi.schema.mi25.InteractorList)
     ...
     */
    public void setSource(org.cytoscape.coreplugin.psi_mi.schema.mi25.Source source)
    {
        this._source = source;
    } //-- void setSource(org.cytoscape.coreplugin.psi_mi.schema.mi25.Source)
     ...
     * @param reader
     */
    public static org.cytoscape.coreplugin.psi_mi.schema.mi25.Entry unmarshalEntry(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (org.cytoscape.coreplugin.psi_mi.schema.mi25.Entry) Unmarshaller.unmarshal(org.cytoscape.coreplugin.psi_mi.schema.mi25.Entry.class, reader);
    } //-- org.cytoscape.coreplugin.psi_mi.schema.mi25.Entry unmarshalEntry(java.io.Reader)
