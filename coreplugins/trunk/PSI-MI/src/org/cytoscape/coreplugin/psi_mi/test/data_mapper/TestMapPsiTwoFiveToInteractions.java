...
public class TestMapPsiTwoFiveToInteractions extends TestCase {
    ...
    private void validateInteractionCase1(Interaction interaction) {
        ...
        assertEquals("yeast two hybrid kaiC kaiA interaction", interaction.getAttribute
                (InteractionVocab.INTERACTION_FULL_NAME));
        assertEquals("kaic-kaia-1", interaction.getAttribute
        ...
        assertEquals("two hybrid", interaction.getAttribute
                (InteractionVocab.EXPERIMENTAL_SYSTEM_NAME));
        assertEquals("psi-mi", interaction.getAttribute
        ...
        assertEquals("synp7", interactor0.getAttribute
                (InteractorVocab.ORGANISM_COMMON_NAME));
        assertEquals("synp7", interactor1.getAttribute
                (InteractorVocab.ORGANISM_COMMON_NAME));
        ...
        assertEquals("1140", interactor0.getAttribute
                (InteractorVocab.ORGANISM_NCBI_TAXONOMY_ID));
        assertEquals("1140", interactor1.getAttribute
                (InteractorVocab.ORGANISM_NCBI_TAXONOMY_ID));

        //  Validate Sequence Data
        String sequence0 = (String) interactor0.getAttribute
                (InteractorVocab.SEQUENCE_DATA);
        assertTrue(sequence0.startsWith("MTSAEMTS"));
        String sequence1 = (String) interactor1.getAttribute
                (InteractorVocab.SEQUENCE_DATA);
