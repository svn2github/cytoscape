...
public class BibrefType implements java.io.Serializable {
    ...
    public BibrefType() {
        super();
    } //-- org.cytoscape.coreplugin.psi_mi.schema.mi1.BibrefType()
     ...
     * @param reader
     */
    public static org.cytoscape.coreplugin.psi_mi.schema.mi1.BibrefType unmarshalBibrefType(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (org.cytoscape.coreplugin.psi_mi.schema.mi1.BibrefType) Unmarshaller.unmarshal(org.cytoscape.coreplugin.psi_mi.schema.mi1.BibrefType.class, reader);
    } //-- org.cytoscape.coreplugin.psi_mi.schema.mi1.BibrefType unmarshalBibrefType(java.io.Reader)
