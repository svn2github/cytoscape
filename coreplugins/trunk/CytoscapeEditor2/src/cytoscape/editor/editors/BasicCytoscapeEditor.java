...
public class BasicCytoscapeEditor implements CytoscapeEditor,
    SelectEventListener, NodeContextMenuListener, EdgeContextMenuListener {
    /**
    ...
    public CyNode addNode(String nodeName, String attribute, String value,
        ...
        if (attribute != null) {
            ...
            Cytoscape.getNodeAttributes()
                     .setAttribute(cn.getIdentifier(), attribute, value);
            ...
            if (attribute != CytoscapeEditorManager.NODE_TYPE) {
                ...
                // MLC 08/06/06:
                Cytoscape.getNodeAttributes()
                         .setAttribute(cn.getIdentifier(),
                    CytoscapeEditorManager.NODE_TYPE, value);
            }
    ...
    /**
     * respond to selection of a Node.  Does nothing right now.
     * Implements SelectionEventListener interface:
     */
    ...
    public void addNodeContextMenuItems(NodeView nodeView, JPopupMenu menu) {
        if (nodeView instanceof NodeView) {
            if (!menuItemExists(menu, "Delete Selected Nodes and Edges")) {
                menu.add(new DeleteAction(null,
                        "Delete " + nodeView.getNode().getIdentifier()));
            }
        }
    }
            ...
            if (uniqueEdge) {
                if (edgeType != null) {
                    ...
                    Cytoscape.getEdgeAttributes()
                             .setAttribute(edge.getIdentifier(),
                        CytoscapeEditorManager.EDGE_TYPE, edgeType);
                }
