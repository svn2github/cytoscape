 ...
 */
public class SimpleScoreModel<NodeType extends WeightedNode<?,Double>> 
	...
	public double scoreGraph(Graph<NodeType,Double> graph){
		double score = 0;

		for ( Edge<NodeType,Double> e : graph.getEdges() ) 
