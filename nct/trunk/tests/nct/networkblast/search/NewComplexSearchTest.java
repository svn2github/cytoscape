...
public class NewComplexSearchTest extends TestCase {
	...
	public void testSearch() {
		...
		WeightedNode<String,Double> h = new BasicWeightedNode<String,Double>("h",0.0);
        	...
        	Graph<WeightedNode<String,Double>,Double> simpleGraph = new BasicGraph<WeightedNode<String,Double>,Double>();
		...
		simpleGraph.addEdge(g,e, 10.0);
        	...
        	Graph<WeightedNode<String,Double>,Double> seedGraph = new BasicGraph<WeightedNode<String,Double>,Double>();
		...
		SimpleScoreModel<WeightedNode<String,Double>> model = new SimpleScoreModel<WeightedNode<String,Double>>();
	       	List<Graph<WeightedNode<String,Double>,Double>> results;

		List<Graph<WeightedNode<String,Double>,Double>> seeds = new ArrayList<Graph<WeightedNode<String,Double>,Double>>();
		seeds.add(seedGraph);

       		NewComplexSearch<WeightedNode<String,Double>> greedyComplexes = new NewComplexSearch<WeightedNode<String,Double>>(3,6,false,seeds);
		...
		// remove f 
		// add g 
        	results = greedyComplexes.searchGraph(simpleGraph,model);
