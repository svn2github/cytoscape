...
print STDERR "./generate_enrichment_insert_SQL.pl cellcircuits_dev > insert_into_enrichment.sql\n";
print        `./generate_enrichment_insert_SQL.pl cellcircuits_dev > insert_into_enrichment.sql\n`;

print STDERR "mv insert_into_enrichment.sql ../sql\n";
print        `mv insert_into_enrichment.sql ../sql\n`;
...
print STDERR "cat insert_into_enrichment.sql | $ccdev\n";
print        `cat insert_into_enrichment.sql | $ccdev\n`;
