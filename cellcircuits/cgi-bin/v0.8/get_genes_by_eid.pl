...
use lib '/var/www/cgi-bin/search/v0.8';
use CCDB::Query;
use CCDB::Enrichment;
use CCDB::Synonyms;
use CCDB::HtmlRoutines qw(highlight gen_go_url $pubCitation $pubName $db_link_by_species $search_url);
