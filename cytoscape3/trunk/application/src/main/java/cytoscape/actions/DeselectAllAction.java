...
public class DeselectAllAction extends CytoscapeAction {
	private final static long serialVersionUID = 1202339869431726L;
	/**
	 * Creates a new DeselectAllAction object.
	 */
	public DeselectAllAction(CyNetworkManager netmgr) {
		super("Deselect All Nodes and Edges",netmgr);
	...
	public void actionPerformed(ActionEvent ea) {
        ...
        SelectUtils.setSelectedEdges( n.getEdgeList(), false, v);
