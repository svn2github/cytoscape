...
public class InteractionsReader extends AbstractGraphReader {
	...
	private List<Integer> node_indices;
	...
	protected void createRootGraphFromInteractionData() {
		...
		node_indices = new ArrayList<Integer>(nodeNameSet.size());
		edges = new HashMap<Integer,Integer>(edgeCount);
	...
	public int[] getNodeIndicesArray() {
		int[] ret = new int[node_indices.size()];
		int i = 0;
