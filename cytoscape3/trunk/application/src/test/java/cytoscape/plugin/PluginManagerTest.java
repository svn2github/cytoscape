...
public class PluginManagerTest extends TestCase
  ...
  protected void setUp() throws Exception
    {
    InputStream is = PluginManagerTest.class.getResourceAsStream("/testData/plugins/test_plugin.xml");
    transformedXML = PluginTestXML.transformXML(is, getFileUrl());
  ...
  /**
   * Test method for {@link cytoscape.plugin.PluginManager#getDownloadables(PluginStatus)} 
   */
  ...
  /**
   * NOT IMPLEMENTED Test method for {@link cytoscape.plugin.PluginManager#register(CytoscapePlugin, java.util.jar.JarFile)}
   */
  ...
  /**
   * Test method for {@link cytoscape.plugin.PluginManager#delete(DownloadableInfo)}
   */
  ...
  /**
   * Test method for {@link cytoscape.plugin.PluginManager#findUpdates(DownloadableInfo)}
   */
  ...
  /**
   * Test method for {@link cytoscape.plugin.PluginManager#update(DownloadableInfo, DownloadableInfo)}
   */
  ...
  /** Test method for {@link cytoscape.plugin.PluginManager#download(DownloadableInfo)}  */
  ...
  /**
   * Test method for {@link PluginManager#download(DownloadableInfo)} files are only bad if
   * they fail to have an attribute Cytoscape-Plugin in the manifest
   */
  ...
  /**
   * This test will test the download of duplicate plugins/themes and the download of plugins that are already loaded in
   * a theme.
   *
   * @throws Exception
   */
  ...
  public void testMinorCorruptedTrackerFile()
    ...
    mgr.resetManager();
    PluginManager.setPluginManageDirectory(System.getProperty("java.io.tmpdir"));
    InputStream is = PluginManagerTest.class.getResourceAsStream("/testData/plugins/track_plugins_c1.xml");
    File file = copyFileToTempDir(is);
  ...
  public void testMajorCorruptedTrackerFile()
    ...
    mgr.resetManager();
    PluginManager.setPluginManageDirectory(System.getProperty("java.io.tmpdir"));
    InputStream is = PluginManagerTest.class.getResourceAsStream("/testData/plugins/track_plugins_c2.xml");
    File file = copyFileToTempDir(is);
    mgr = PluginManager.getPluginManager();
    assertNotNull(mgr);
  ...
  /*--------------------------------------------------------------------*/
  private File copyFileToTempDir(InputStream is)
    {
