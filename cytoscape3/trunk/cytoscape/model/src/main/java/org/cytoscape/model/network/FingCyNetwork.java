...
import org.cytoscape.model.network.event.*;
...
public class FingCyNetwork extends FingExtensibleGraphPerspective implements CyNetwork,
	...
	**/
	...
	/**
	 * Return all available Attributes for the Nodes in this CyNetwork
	 * XXX Can't use the Cytoscape class anymore
	 */
	...
	/**
	 * Return all available Attributes for the Edges in this CyNetwork
	 * XXX Can't use the Cytoscape class anymore
	 */
