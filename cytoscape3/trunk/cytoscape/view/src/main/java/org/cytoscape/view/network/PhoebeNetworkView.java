...
*/
package org.cytoscape.view.network;
...
import org.cytoscape.application.dialog.FlagAndSelectionHandler;
import org.cytoscape.application.util.CyNetworkUtilities;
...
public class PhoebeNetworkView extends PGraphView implements CyNetworkView {
	 ...
	 * @return  DOCUMENT ME!
	 */
	public org.cytoscape.application.widget.vizmap.ui.VizMapUI getVizMapUI() {
	...
	public void updateStatusLabel() {
		...
		statusLabel.setText("  Nodes: " + nodeCount + " (" + selectedNodes + " selected)"
		                    + " Edges: " + edgeCount + " (" + selectedEdges + " selected)");
	}
