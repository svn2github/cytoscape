...
public class VisualStyleBuilderDialog extends javax.swing.JDialog {
	...
	public VisualStyleBuilderDialog(String networkName, GraphReader reader, java.awt.Frame parent,
	                                boolean modal) {
		super(parent, modal);
	...
	private void initComponents() {
		...
		messageEditorPane.setText("This function creates new Visual Style based on GML information.  "
		...
		layout.setVerticalGroup(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
		                              .add(layout.createSequentialGroup().addContainerGap()
		                                         ...
		                                         .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
		                                         .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
		                                                    .add(skipButton).add(generateButton))
		                                         .addContainerGap()));
		pack();
	} // </editor-fold>
	...
	private void generateButtonMouseClicked(java.awt.event.MouseEvent evt) {
		...
		if (checkDuplicateNames() == false) {
			...
			} catch (org.cytoscape.view.DuplicateCalculatorNameException e) {
				JOptionPane.showMessageDialog(this,
				                              "The Calculator Name already exists.\n"
				                              + "Please change the suffix.", "Duplicate Name!",
			...
			JOptionPane.showMessageDialog(this, "Error: The Visual Style Name already exists.",
	...
	private boolean checkDuplicateNames() {
		...
		Set vsNames = Cytoscape.getVisualMappingManager().getCalculatorCatalog()
		                       .getVisualStyleNames();
