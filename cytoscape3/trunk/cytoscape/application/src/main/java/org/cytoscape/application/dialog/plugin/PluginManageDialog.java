 ...
 */
package org.cytoscape.application.dialog.plugin;
...
import org.cytoscape.application.plugin.ThemeInfo;
...
public class PluginManageDialog extends javax.swing.JDialog implements
	...
	private void deleteButtonActionPerformed(ActionEvent evt) {
		...
		if (JOptionPane.YES_OPTION == JOptionPane.showConfirmDialog(this,
			...
			} catch (org.cytoscape.application.plugin.WebstartException we) {
				we.printStackTrace();
			}
		}
	}
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .add(layout.createSequentialGroup()
                ...
                .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.TRAILING)
                    ...
                    .add(org.jdesktop.layout.GroupLayout.LEADING, availablePluginsLabel, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 574, Short.MAX_VALUE)
                    .add(layout.createSequentialGroup()
        ...
        layout.setVerticalGroup(
            ...
            .add(layout.createSequentialGroup()
                .addContainerGap()
                .add(availablePluginsLabel, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 32, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
