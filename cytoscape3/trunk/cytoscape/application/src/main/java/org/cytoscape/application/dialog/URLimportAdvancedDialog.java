...
import org.cytoscape.application.util.ProxyHandler;
...
public class URLimportAdvancedDialog extends JDialog implements ActionListener,
	...
	private void initComponents() {
		...
		cmbProxyType.setModel(new javax.swing.DefaultComboBoxModel(new String[] {
		                                                               "DIRECT", "HTTP", "SOCKS"
		                                                           }));
	...
	// for test only
	/**
	 * Creates a new URLimportAdvancedDialog object.
	 */
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (_actionObject instanceof JButton) {
			...
			if (_btn == btnOK) {
				...
				BookmarkDialog theNewDialog = new BookmarkDialog(this, true, theBookmarks,
				...
				BookmarkDialog theEditDialog = new BookmarkDialog(this, true, theBookmarks,
				...
				java.net.Proxy.Type proxyType = java.net.Proxy.Type.valueOf(cmbProxyType.getSelectedItem()
				                                                                        .toString());
	...
	public class BookmarkDialog extends JDialog implements ActionListener {
		...
		public BookmarkDialog(JDialog parent, boolean modal, Bookmarks pBookmarks,
