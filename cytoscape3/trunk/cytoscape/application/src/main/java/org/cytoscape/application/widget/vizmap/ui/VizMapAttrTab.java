...
import org.cytoscape.application.widget.vizmap.calculator.BasicCalculator;
import org.cytoscape.application.widget.vizmap.calculator.Calculator;
import org.cytoscape.application.widget.vizmap.calculator.CalculatorFactory;
...
import org.cytoscape.view.CalculatorCatalog;
import org.cytoscape.view.mapping.ObjectMapping;


/**
 * <p><strong>Do not use this.  This UI is reolaced by VizMapperMainPanel.</strong></p>
 *
...
public class VizMapAttrTab extends VizMapTab {
	...
	public void visualStyleChanged() {
		...
		Object defaultObj = VisualPropertyType.getVisualPorpertyType(this.type)
		                                      .getDefault(VMM.getVisualStyle());
		setCurrentCalculator(VisualPropertyType.getVisualPorpertyType(this.type)
		                                       .getCurrentCalculator(VMM.getVisualStyle()));
		...
		public void itemStateChanged(ItemEvent e) {
			...
			if ((e.getItemSelectable() == defaultValueDisplayer)
				...
				VisualPropertyType.getVisualPorpertyType(type)
				                  .setDefault(VMM.getVisualStyle(), newDefault);
			}
		}
	}
	...
	void switchCalculator(Calculator calc) {
		...
		VisualPropertyType.getVisualPorpertyType(this.type)
		                  .setCurrentCalculator(VMM.getVisualStyle(), calc);
