...
import org.cytoscape.application.util.OpenBrowser;
import org.cytoscape.io.attribute.reader.Ontology;
import org.cytoscape.io.attribute.reader.OntologyTerm;
...
public class OntologyMapperDialog extends JDialog {
	...
	private void applyButtonActionPerformed(java.awt.event.ActionEvent evt) {
		...
		OBOOntology onto = anno.getOntology();
		...
		while (termIt.hasNext()) {
			...
			OBOOntologyTerm term = (OBOOntologyTerm) terms.get(id);
	...
	protected void buildOntologyTree() {
		...
		while (it.hasNext()) {
			Object key = it.next();
			OBOOntologyTerm goTerm = onto.getTerm(((Integer) key).intValue());
