...
import org.cytoscape.application.action.AlphabeticalSelectionAction;
import org.cytoscape.application.action.CytoscapeAction;
import org.cytoscape.application.action.FitContentAction;
import org.cytoscape.application.action.ListFromFileSelectionAction;
import org.cytoscape.application.action.PreferenceAction;
import org.cytoscape.application.action.ProxyServerAction;
import org.cytoscape.application.action.RedoAction;
import org.cytoscape.application.action.StraightenSelectedEdgesAction;
import org.cytoscape.application.action.UndoAction;
import org.cytoscape.application.dialog.cytopanel.CytoPanelName;
import org.cytoscape.application.dialog.layout.LayoutMenuManager;
import org.cytoscape.application.dialog.layout.SettingsAction;
import org.cytoscape.application.dialog.toolbar.CytoscapeToolBar;
import org.cytoscape.application.util.Cytoscape;
import org.cytoscape.command.BendSelectedEdgesAction;
import org.cytoscape.command.BookmarkAction;
import org.cytoscape.command.CloneGraphInNewWindowAction;
import org.cytoscape.command.CreateNetworkViewAction;
import org.cytoscape.command.CytoPanelAction;
import org.cytoscape.command.DeSelectAllEdgesAction;
import org.cytoscape.command.DeSelectAllNodesAction;
import org.cytoscape.command.DeselectAllAction;
import org.cytoscape.command.DestroyNetworkAction;
import org.cytoscape.command.DestroyNetworkViewAction;
import org.cytoscape.command.ExitAction;
import org.cytoscape.command.ExportAsGMLAction;
import org.cytoscape.command.ExportAsGraphicsAction;
import org.cytoscape.command.ExportAsInteractionsAction;
import org.cytoscape.command.ExportAsXGMMLAction;
import org.cytoscape.command.ExportEdgeAttributesAction;
import org.cytoscape.command.ExportNodeAttributesAction;
import org.cytoscape.command.ExportVizmapAction;
import org.cytoscape.command.HelpAboutAction;
import org.cytoscape.command.HelpContactHelpDeskAction;
import org.cytoscape.command.HelpContentsAction;
import org.cytoscape.command.HideSelectedEdgesAction;
import org.cytoscape.command.HideSelectedNodesAction;
import org.cytoscape.command.ImportEdgeAttributesAction;
import org.cytoscape.command.ImportExpressionMatrixAction;
import org.cytoscape.command.ImportGraphFileAction;
import org.cytoscape.command.ImportNodeAttributesAction;
import org.cytoscape.command.ImportVizmapAction;
import org.cytoscape.command.InvertSelectedEdgesAction;
import org.cytoscape.command.InvertSelectedNodesAction;
import org.cytoscape.command.NewSessionAction;
import org.cytoscape.command.NewWindowSelectedNodesEdgesAction;
import org.cytoscape.command.NewWindowSelectedNodesOnlyAction;
import org.cytoscape.command.OpenSessionAction;
import org.cytoscape.command.PluginManagerAction;
import org.cytoscape.command.PluginUpdateAction;
import org.cytoscape.command.PrintAction;
import org.cytoscape.command.SaveSessionAction;
import org.cytoscape.command.SaveSessionAsAction;
import org.cytoscape.command.SelectAdjacentEdgesAction;
import org.cytoscape.command.SelectAllAction;
import org.cytoscape.command.SelectAllEdgesAction;
import org.cytoscape.command.SelectAllNodesAction;
import org.cytoscape.command.SelectConnectedNodesAction;
import org.cytoscape.command.SelectFirstNeighborsAction;
import org.cytoscape.command.SelectionModeAction;
import org.cytoscape.command.SetVisualPropertiesAction;
import org.cytoscape.command.ShowGraphicsDetailsAction;
import org.cytoscape.command.UnHideSelectedEdgesAction;
import org.cytoscape.command.UnHideSelectedNodesAction;
import org.cytoscape.command.WebServiceManagerAction;
import org.cytoscape.command.WebServiceNetworkImportAction;
import org.cytoscape.command.ZoomAction;
import org.cytoscape.command.ZoomSelectedAction;
...
public class CyMenus implements GraphViewChangeListener {
	...
	private void fillMenuBar() {
		...
		addAction(new WebServiceManagerAction());
		fileMenu.add(new JSeparator());
