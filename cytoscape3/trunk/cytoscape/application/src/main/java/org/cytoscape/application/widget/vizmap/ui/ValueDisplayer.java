...
import org.cytoscape.application.dialog.CyColorChooser;
...
public class ValueDisplayer extends JButton {
    ...
    public static ValueDisplayer getDisplayForLabelPosition(JDialog parent,
        ...
        ValueDisplayer v = new ValueDisplayer(parent,
                c.shortString(), title, LABEL_POSITION);
    ...
    private class FontListener extends AbstractAction {
        ...
        public void actionPerformed(ActionEvent e) {
            Font f = PopupFontChooser.showDialog(parent.parent,
                    (Font) parent.inputObj);
    ...
    private void setInputIconListener(String title, String objectName,
        ...
        this.inputListener = new IconListener(title, objectName, is,
                parentDialog, this);
        addActionListener(this.inputListener);
    }
    ...
    private class IconListener extends AbstractAction {
        ...
        IconListener(String title, String objectName, IconSupport is,
            JDialog parentDialog, ValueDisplayer parent) {
            super("ValueDisplayer IconListener");
            this.chooser = new PopupIconChooser(
                    title,
                    objectName,
                    is.getIcons(),
                    is.getCurrentIcon(),
    ...
    private static ValueDisplayer getDisplayForDouble(JDialog parent,
        ...
        ValueDisplayer v = new ValueDisplayer(parent,
                formatter.format(init), title, DOUBLE);
    ...
    private static ValueDisplayer getDisplayForInt(JDialog parent,
        ...
        ValueDisplayer v = new ValueDisplayer(parent,
                Integer.toString(init), title, INT);
    ...
    private class StringListener extends AbstractAction {
        ...
        public void actionPerformed(ActionEvent e) {
            if (enabled) {
                Object o = PopupStringChooser.showDialog(parent, title, prompt,
                        inputObj, type);
    ...
    public static ValueDisplayer getBlankDisplayFor(JDialog parent,
        ...
        case NODESHAPE:
            return getDisplayForIcons(parent, title, NodeShape.ELLIPSE,
                NODESHAPE);
        ...
        case LABEL_POSITION:
            return getDisplayForLabelPosition(
                parent,
                title,
                new LabelPosition());
    ...
    public static ValueDisplayer getDisplayFor(JDialog parent, String title,
        ...
        if (o instanceof Color)
            ...
            if (o instanceof Float || o instanceof Double)
                return getDisplayForDouble(
                    parent,
                    title,
                    ((Number) o).doubleValue());
            else

                return getDisplayForInt(
                    parent,
                    title,
                    ((Number) o).intValue());
        } else if (o instanceof Font)
