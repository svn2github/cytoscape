 ...
 *
 */
public class OBOOntology extends AbstractChangeable implements org.biojava.ontology.Ontology {
	/*
	 * For metadata
	 */
	 ...
	 */
	public OBOOntology(final String name) {
	...
	public Set getTerms() {
		...
		while (nodeIt.hasNext()) {
			...
			final Term term = new OBOOntologyTerm(node.getIdentifier(), this.name,
	 ...
	 */
	public OBOOntologyTerm getTerm(String id) {
		final OBOOntologyTerm term = new OBOOntologyTerm(id, name,
		                                           termAttr.getStringAttribute(id,
		                                                                       OBOTags.DEF.toString()));
	...
	public Term createTerm(String name, String description)
		...
		Term newTerm = new OBOOntologyTerm(name, this.name, description);
