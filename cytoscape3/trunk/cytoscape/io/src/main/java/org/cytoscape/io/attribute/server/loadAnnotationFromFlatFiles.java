 ...
 *  can be deduced.
 *
 *  @see org.cytoscape.io.attribute.reader.annotation.Annotation
 *  @see org.cytoscape.io.attribute.reader.OBOOntology
 */
public class loadAnnotationFromFlatFiles {
	...
	public static void main(String[] args) throws Exception {
		...
		OBOOntology ontology = ontologyReader.getOntology();
