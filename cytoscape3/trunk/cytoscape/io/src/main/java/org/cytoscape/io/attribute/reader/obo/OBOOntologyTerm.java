 ...
 *
 */
public class OBOOntologyTerm extends AbstractChangeable implements OntologyTerm {
	/*
	 ...
	 * @param description
	 */
	public OBOOntologyTerm(String name, String ontologyName, String description) {
		this.name = name;
