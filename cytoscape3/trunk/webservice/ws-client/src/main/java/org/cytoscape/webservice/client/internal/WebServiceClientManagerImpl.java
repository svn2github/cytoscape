...
/**
 * Web Service Client Manager manages available web service clients in
 * Cytoscape. All clients will be loaded & registered through Plugin Manager
 * architecture.
 * 
...
public class WebServiceClientManagerImpl implements WebServiceClientManager {
	...
	// Key is
	private final Map<String, WebServiceClient<?>> clients;
	private final Map<String, WebServiceClient<?>> clientNameMap;
	...
	public void registerClient(final WebServiceClient<?> client) {
		...
		cwseSupport.addCyWebServiceEventListener((CyWebServiceEventListener)client);
	}
	 ...
	 * @return DOCUMENT ME!
	 */
	public WebServiceClient<?> getClient(String clientID) {
