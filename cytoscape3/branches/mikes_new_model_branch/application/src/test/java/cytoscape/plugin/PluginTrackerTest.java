...
public class PluginTrackerTest extends TestCase {
	...
	/**
	 * Test method for {@link cytoscape.plugin.PluginTracker}.
	 */
	...
	/**
	 * Test method for
	 * {@link PluginTracker#getPluginListByStatus(PluginStatus)} 
	 */
	...
	/**
	 * Test method for
	 * {@link PluginTracker#addPlugin(PluginInfo, PluginStatus)}
	 */
	...
	/**
	 * Test method for
	 * {@link PluginTracker#addTheme(ThemeInfo, PluginStatus)}
	 * 
	 * @throws Exception
	 */
	...
	/**
	 * Test method for
	 * {@link PluginTracker#removeDownloadable(DownloadableInfo, PluginStatus)} 
	 */
    ...
    // partially corrupted file
	  String CorruptedFileName = "track_plugins_c1.xml";
		try {
		  InputStream is = PluginTrackerTest.class.getResourceAsStream("/testData/plugins/" + CorruptedFileName);
      File tempFile = copyFileToTempDir(is, CorruptedFileName);
      PluginTracker tk = new PluginTracker(tempFile);
			assertNotNull(tk);
    ...
    // completely corrupted file
	  String CorruptedFileName = "track_plugins_c2.xml";
		PluginTracker tk = null;
		File tempFile = null;
		try {
		  InputStream is = PluginTrackerTest.class.getResourceAsStream("/testData/plugins/" + CorruptedFileName);
			tempFile = copyFileToTempDir(is, CorruptedFileName);
  ...
  private File copyFileToTempDir(InputStream is, String tempFileName) {
