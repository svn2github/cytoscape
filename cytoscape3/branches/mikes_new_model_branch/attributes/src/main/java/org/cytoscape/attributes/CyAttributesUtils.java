...
public class CyAttributesUtils {
	 ...
	 */
	public static void copyAttributes(String originalID, String copyID, CyAttributes attrs,
	                                  boolean purge) {
		copyAttributes(originalID, copyID, attrs, ALL_ATTRIBUTES_FILTER, purge);
	}
	 ...
	 */
	public static void copyAttribute(String originalID, String copyID, String attrName,
	 ...
	 */
	public static void traverseAttributeValues(String objToTraverseID, String attrName,
