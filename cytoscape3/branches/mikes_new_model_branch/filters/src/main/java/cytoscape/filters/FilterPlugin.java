...
public class FilterPlugin implements BundleActivator {
    ...
    protected ImageIcon icon = new ImageIcon(getClass().getResource("/images/ximian/stock_filter-data-by-criteria.png"));
    protected ImageIcon icon2 = new ImageIcon(getClass().getResource("/images/ximian/stock_filter-data-by-criteria-16.png"));
