...
public class AnnealingLayoutAlgorithm extends JGraphLayoutAlgorithm implements GraphModelListener {
	...
	public static abstract class MathExtensions {
		 ...
		 * return sqrt( v.x^2 + v.y^2 )
		 * </code></blockquote></blockquote>
		 * @param x Length of one Karthese. Between x and y is an Angle of 90 degrees
		 * @param y Length of the other Karthese. Between x and y is an Angle of 90 degrees
		 ...
		 * <p><blockquote><blockquote><code>
		 * return arccos( ( v1.x*v2.x + v1.y*v2.y ) / ( sqrt( v1.x^2 + v1.y^2 ) *
		 * sqrt( v2.x^2 + v2.y^2 ) ) )
		 * </code></blockquote></blockquote>
