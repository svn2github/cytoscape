...
public class CalculatorCatalog {
	...
	private void clear() {
		...
		addMapping( MapperNames.DISCRETE.toString(), DiscreteMapping.class);
		addMapping( MapperNames.CONTINUOUS.toString(), ContinuousMapping.class);
		addMapping( MapperNames.PASSTHROUGH.toString(), PassThroughMapping.class);
	}
	...
	public void appendProps( Properties p ) {
		clear();
		props.putAll(p);
		CalculatorIO.loadCalculators(props, this);
	}
