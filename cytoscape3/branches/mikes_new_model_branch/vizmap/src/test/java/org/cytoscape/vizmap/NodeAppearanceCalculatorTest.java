...
public class NodeAppearanceCalculatorTest extends TestCase {
	...
	public void setUp() {
		...
		nodeAttrs = CyAttributesFactory.getCyAttributes("node");
		nodeAttrs.setAttribute("a","sample",1);
		nodeAttrs.setAttribute("b","sample",2);
		nodeAttrs.setAttribute("c","sample",3);
		nodeAttrs.setAttribute("d","sample",4);
