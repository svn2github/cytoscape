...
public class TestBioPaxImportWrapper extends TestCase {
	...
	public void testBioPaxFilter() {
		...
		boolean acceptFlag = filter.accept(new File("src/test/resources/testData/biopax_sample1.owl"));
		assertEquals(true, acceptFlag);

		//  This should be rejected
		acceptFlag = filter.accept(new File("src/test/resources/testData/psi_sample1.xml"));
