...
public class CyNetworkFactory {
	// TODO
	private static final CyEventHelper help = null;  
	...
	public static CyRootNetwork convertToRootNetwork(CyNetwork net) {
		if ( net instanceof CyRootNetwork )
			return (CyRootNetwork)net;
		else if ( net instanceof CySubNetwork )
			return ((CySubNetwork)net).getRootNetwork();
		else 
			throw new IllegalArgumentException("You're network is strange and different!");	
	}
}
