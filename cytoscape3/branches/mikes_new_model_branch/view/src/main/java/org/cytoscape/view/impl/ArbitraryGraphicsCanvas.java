 ...
 * to live within a org.cytoscape.view.impl.DGraphView class.  It is the canvas
...
public class ArbitraryGraphicsCanvas extends DingCanvas implements ViewportChangeListener {
	...
	public Component add(Component component) {
		if (USE_REPOSITION_CODE) {
			...
			int nodeIndex = m_cyNetwork.getRootGraph().createNode();
			CyNode node = m_cyNetwork.getRootGraph().getNode(nodeIndex);
