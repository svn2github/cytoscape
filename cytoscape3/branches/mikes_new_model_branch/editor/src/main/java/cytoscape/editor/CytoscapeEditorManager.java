...
public abstract class CytoscapeEditorManager {
	...
	private static List<Integer> nodeClipBoard;

	/**
	 * holding area for deleted edges used when undo-ing deletes
	 */
	private static List<Integer> edgeClipBoard;
	 ...
	 */
	public static List<Integer> getNodeClipBoard() {
		if (nodeClipBoard == null) {
			nodeClipBoard = new ArrayList<Integer>();
		}
	 ...
	 */
	public static List<Integer> getEdgeClipBoard() {
		if (edgeClipBoard == null) {
			edgeClipBoard = new ArrayList<Integer>();
		}
